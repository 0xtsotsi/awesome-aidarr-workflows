...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jhillin8/mens-mental-health/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jhillin8/mens-mental-health/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mens-mental-health`)
...
```prompt
You are executing the mens-mental-health workflow. Use the following context:
