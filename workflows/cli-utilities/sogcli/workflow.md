...
> Original: [https://github.com/openclaw/skills/tree/main/skills/visionik/sogcli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/visionik/sogcli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sogcli`)
...
```prompt
You are executing the sogcli workflow. Use the following context:
