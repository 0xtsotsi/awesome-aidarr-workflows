...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xaif/raycast/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xaif/raycast/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run raycast`)
...
```prompt
You are executing the raycast workflow. Use the following context:
