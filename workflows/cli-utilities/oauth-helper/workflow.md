...
> Original: [https://github.com/openclaw/skills/tree/main/skills/helloliuyongsheng-bot/oauth-helper/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/helloliuyongsheng-bot/oauth-helper/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run oauth-helper`)
...
```prompt
You are executing the oauth-helper workflow. Use the following context:
