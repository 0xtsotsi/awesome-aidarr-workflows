...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tristanmanchester/track17/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tristanmanchester/track17/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run track17`)
...
```prompt
You are executing the track17 workflow. Use the following context:
