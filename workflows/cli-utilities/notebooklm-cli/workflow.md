...
> Original: [https://github.com/openclaw/skills/tree/main/skills/oconnell-carl/notebooklm-cli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/oconnell-carl/notebooklm-cli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run notebooklm-cli`)
...
```prompt
You are executing the notebooklm-cli workflow. Use the following context:
