...
> Original: [https://github.com/openclaw/skills/tree/main/skills/maplezzk/mcps-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/maplezzk/mcps-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mcps-skill`)
...
```prompt
You are executing the mcps-skill workflow. Use the following context:
