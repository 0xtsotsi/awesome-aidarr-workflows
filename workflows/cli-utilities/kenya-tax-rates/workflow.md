...
> Original: [https://github.com/openclaw/skills/tree/main/skills/enjuguna/kenya-tax-rates/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/enjuguna/kenya-tax-rates/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kenya-tax-rates`)
...
```prompt
You are executing the kenya-tax-rates workflow. Use the following context:
