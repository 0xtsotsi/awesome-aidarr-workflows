...
> Original: [https://github.com/openclaw/skills/tree/main/skills/virang-nimrobo/nimrobo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/virang-nimrobo/nimrobo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nimrobo`)
...
```prompt
You are executing the nimrobo workflow. Use the following context:
