...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rusynandriy/rescuetime/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rusynandriy/rescuetime/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run rescuetime`)
...
```prompt
You are executing the rescuetime workflow. Use the following context:
