...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/product-strategist/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/product-strategist/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run product-strategist`)
...
```prompt
You are executing the product-strategist workflow. Use the following context:
