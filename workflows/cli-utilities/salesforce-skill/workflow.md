...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lucas-riverbi/salesforce-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lucas-riverbi/salesforce-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run salesforce-skill`)
...
```prompt
You are executing the salesforce-skill workflow. Use the following context:
