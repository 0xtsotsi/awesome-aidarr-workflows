...
> Original: [https://github.com/openclaw/skills/tree/main/skills/codewithnathan97/kilocli-coding-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/codewithnathan97/kilocli-coding-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kilocli-coding-agent`)
...
```prompt
You are executing the kilocli-coding-agent workflow. Use the following context:
