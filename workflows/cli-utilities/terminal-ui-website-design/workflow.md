...
> Original: [https://github.com/openclaw/skills/tree/main/skills/chyinan/terminal-ui-website-design/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/chyinan/terminal-ui-website-design/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run terminal-ui-website-design`)
...
```prompt
You are executing the terminal-ui-website-design workflow. Use the following context:
