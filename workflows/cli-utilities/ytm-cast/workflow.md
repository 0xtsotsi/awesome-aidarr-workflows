...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aidanthebandit/ytm-cast/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aidanthebandit/ytm-cast/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ytm-cast`)
...
```prompt
You are executing the ytm-cast workflow. Use the following context:
