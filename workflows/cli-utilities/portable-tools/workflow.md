...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tunaissacoding/portable-tools/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tunaissacoding/portable-tools/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run portable-tools`)
...
```prompt
You are executing the portable-tools workflow. Use the following context:
