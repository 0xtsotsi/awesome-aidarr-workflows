...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steipete/tmux/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steipete/tmux/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tmux`)
...
```prompt
You are executing the tmux workflow. Use the following context:
