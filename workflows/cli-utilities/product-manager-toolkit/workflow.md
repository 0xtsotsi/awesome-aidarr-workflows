...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/product-manager-toolkit/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/product-manager-toolkit/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run product-manager-toolkit`)
...
```prompt
You are executing the product-manager-toolkit workflow. Use the following context:
