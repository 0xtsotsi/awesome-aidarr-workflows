...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ricardodantas/terminal-screenshots/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ricardodantas/terminal-screenshots/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run terminal-screenshots`)
...
```prompt
You are executing the terminal-screenshots workflow. Use the following context:
