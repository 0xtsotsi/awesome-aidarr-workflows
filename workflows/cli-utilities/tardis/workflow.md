...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rm289/tardis/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rm289/tardis/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tardis`)
...
```prompt
You are executing the tardis workflow. Use the following context:
