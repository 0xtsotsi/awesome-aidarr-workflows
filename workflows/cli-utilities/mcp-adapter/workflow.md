...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lunarpulse/mcp-adapter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lunarpulse/mcp-adapter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mcp-adapter`)
...
```prompt
You are executing the mcp-adapter workflow. Use the following context:
