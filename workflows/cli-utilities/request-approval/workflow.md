...
> Original: [https://github.com/openclaw/skills/tree/main/skills/yconst/request-approval/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/yconst/request-approval/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run request-approval`)
...
```prompt
You are executing the request-approval workflow. Use the following context:
