...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jozh-bit/unzipped-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jozh-bit/unzipped-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run unzipped-skill`)
...
```prompt
You are executing the unzipped-skill workflow. Use the following context:
