...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steipete/peekaboo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steipete/peekaboo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run peekaboo`)
...
```prompt
You are executing the peekaboo workflow. Use the following context:
