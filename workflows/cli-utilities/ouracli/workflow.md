...
> Original: [https://github.com/openclaw/skills/tree/main/skills/visionik/ouracli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/visionik/ouracli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ouracli`)
...
```prompt
You are executing the ouracli workflow. Use the following context:
