...
> Original: [https://github.com/openclaw/skills/tree/main/skills/eypam/pamela-calls/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/eypam/pamela-calls/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pamela-calls`)
...
```prompt
You are executing the pamela-calls workflow. Use the following context:
