...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zjianru/restart-guard/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zjianru/restart-guard/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run restart-guard`)
...
```prompt
You are executing the restart-guard workflow. Use the following context:
