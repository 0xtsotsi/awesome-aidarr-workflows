...
> Original: [https://github.com/openclaw/skills/tree/main/skills/eypam/pamela-call/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/eypam/pamela-call/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pamela-call`)
...
```prompt
You are executing the pamela-call workflow. Use the following context:
