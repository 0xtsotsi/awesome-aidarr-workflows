...
> Original: [https://github.com/openclaw/skills/tree/main/skills/anjor/pltr-cli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/anjor/pltr-cli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pltr-cli`)
...
```prompt
You are executing the pltr-cli workflow. Use the following context:
