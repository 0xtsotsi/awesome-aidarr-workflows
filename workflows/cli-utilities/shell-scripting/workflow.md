...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/shell-scripting/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/shell-scripting/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run shell-scripting`)
...
```prompt
You are executing the shell-scripting workflow. Use the following context:
