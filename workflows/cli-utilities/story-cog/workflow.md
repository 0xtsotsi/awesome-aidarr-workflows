...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/story-cog/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/story-cog/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run story-cog`)
...
```prompt
You are executing the story-cog workflow. Use the following context:
