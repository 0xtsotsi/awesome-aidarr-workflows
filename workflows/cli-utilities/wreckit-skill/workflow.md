...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jmanhype/wreckit-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jmanhype/wreckit-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wreckit-skill`)
...
```prompt
You are executing the wreckit-skill workflow. Use the following context:
