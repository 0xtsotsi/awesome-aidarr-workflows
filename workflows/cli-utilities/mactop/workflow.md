...
> Original: [https://github.com/openclaw/skills/tree/main/skills/metaspartan/mactop/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/metaspartan/mactop/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mactop`)
...
```prompt
You are executing the mactop workflow. Use the following context:
