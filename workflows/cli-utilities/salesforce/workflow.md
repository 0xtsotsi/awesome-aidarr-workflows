...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arvorco/salesforce/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arvorco/salesforce/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run salesforce`)
...
```prompt
You are executing the salesforce workflow. Use the following context:
