...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rose-token/moltarb/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rose-token/moltarb/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltarb`)
...
```prompt
You are executing the moltarb workflow. Use the following context:
