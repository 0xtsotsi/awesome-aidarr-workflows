...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rdsthomas/mission-control/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rdsthomas/mission-control/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mission-control`)
...
```prompt
You are executing the mission-control workflow. Use the following context:
