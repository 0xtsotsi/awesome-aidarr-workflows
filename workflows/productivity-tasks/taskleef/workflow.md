...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xatter/taskleef/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xatter/taskleef/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run taskleef`)
...
```prompt
You are executing the taskleef workflow. Use the following context:
