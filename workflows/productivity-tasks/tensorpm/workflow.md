...
> Original: [https://github.com/openclaw/skills/tree/main/skills/neo552/tensorpm/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/neo552/tensorpm/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tensorpm`)
...
```prompt
You are executing the tensorpm workflow. Use the following context:
