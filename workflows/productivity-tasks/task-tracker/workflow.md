...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kesslerio/task-tracker/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kesslerio/task-tracker/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run task-tracker`)
...
```prompt
You are executing the task-tracker workflow. Use the following context:
