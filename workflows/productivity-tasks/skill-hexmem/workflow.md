...
> Original: [https://github.com/openclaw/skills/tree/main/skills/santyr/skill-hexmem/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/santyr/skill-hexmem/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-hexmem`)
...
```prompt
You are executing the skill-hexmem workflow. Use the following context:
