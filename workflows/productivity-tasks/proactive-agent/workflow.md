...
> Original: [https://github.com/openclaw/skills/tree/main/skills/halthelobster/proactive-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/halthelobster/proactive-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run proactive-agent`)
...
```prompt
You are executing the proactive-agent workflow. Use the following context:
