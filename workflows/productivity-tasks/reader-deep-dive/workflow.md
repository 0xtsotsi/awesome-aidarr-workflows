...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sameerbajaj/reader-deep-dive/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sameerbajaj/reader-deep-dive/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run reader-deep-dive`)
...
```prompt
You are executing the reader-deep-dive workflow. Use the following context:
