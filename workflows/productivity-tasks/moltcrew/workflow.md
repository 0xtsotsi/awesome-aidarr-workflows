...
> Original: [https://github.com/openclaw/skills/tree/main/skills/montecrypto999/moltcrew/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/montecrypto999/moltcrew/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltcrew`)
...
```prompt
You are executing the moltcrew workflow. Use the following context:
