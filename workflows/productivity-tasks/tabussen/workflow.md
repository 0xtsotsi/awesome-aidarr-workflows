...
> Original: [https://github.com/openclaw/skills/tree/main/skills/simskii/tabussen/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/simskii/tabussen/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tabussen`)
...
```prompt
You are executing the tabussen workflow. Use the following context:
