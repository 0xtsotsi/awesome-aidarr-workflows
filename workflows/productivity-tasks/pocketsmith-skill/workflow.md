...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lextoumbourou/pocketsmith-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lextoumbourou/pocketsmith-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pocketsmith-skill`)
...
```prompt
You are executing the pocketsmith-skill workflow. Use the following context:
