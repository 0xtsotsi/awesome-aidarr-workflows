...
> Original: [https://github.com/openclaw/skills/tree/main/skills/manuelhettich/ticktick/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/manuelhettich/ticktick/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ticktick`)
...
```prompt
You are executing the ticktick workflow. Use the following context:
