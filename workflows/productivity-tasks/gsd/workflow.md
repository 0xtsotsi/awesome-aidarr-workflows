...
> Original: [https://github.com/openclaw/skills/tree/main/skills/glittercowboy/gsd/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/glittercowboy/gsd/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gsd`)
...
```prompt
You are executing the gsd workflow. Use the following context:
