...
> Original: [https://github.com/openclaw/skills/tree/main/skills/elithrar/web-perf/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/elithrar/web-perf/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run web-perf`)
...
```prompt
You are executing the web-perf workflow. Use the following context:
