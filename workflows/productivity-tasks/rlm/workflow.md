...
> Original: [https://github.com/openclaw/skills/tree/main/skills/eesb99/rlm/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/eesb99/rlm/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run rlm`)
...
```prompt
You are executing the rlm workflow. Use the following context:
