...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jlwrow/taskmaster/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jlwrow/taskmaster/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run taskmaster`)
...
```prompt
You are executing the taskmaster workflow. Use the following context:
