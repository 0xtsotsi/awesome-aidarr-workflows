...
> Original: [https://github.com/openclaw/skills/tree/main/skills/visionik/mogcli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/visionik/mogcli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mogcli`)
...
```prompt
You are executing the mogcli workflow. Use the following context:
