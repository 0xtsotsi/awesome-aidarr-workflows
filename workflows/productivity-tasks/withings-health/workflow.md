...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hisxo/withings-health/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hisxo/withings-health/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run withings-health`)
...
```prompt
You are executing the withings-health workflow. Use the following context:
