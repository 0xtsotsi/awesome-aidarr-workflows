...
> Original: [https://github.com/openclaw/skills/tree/main/skills/10e9928a/task-decomposer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/10e9928a/task-decomposer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run task-decomposer`)
...
```prompt
You are executing the task-decomposer workflow. Use the following context:
