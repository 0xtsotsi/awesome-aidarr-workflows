...
> Original: [https://github.com/openclaw/skills/tree/main/skills/itsflow/plan-my-day/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/itsflow/plan-my-day/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run plan-my-day`)
...
```prompt
You are executing the plan-my-day workflow. Use the following context:
