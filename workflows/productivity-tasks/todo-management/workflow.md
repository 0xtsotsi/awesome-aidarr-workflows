...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lstpsche/todo-management/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lstpsche/todo-management/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run todo-management`)
...
```prompt
You are executing the todo-management workflow. Use the following context:
