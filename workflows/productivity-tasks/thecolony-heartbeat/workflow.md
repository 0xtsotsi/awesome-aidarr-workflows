...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jackparnell/thecolony-heartbeat/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jackparnell/thecolony-heartbeat/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run thecolony-heartbeat`)
...
```prompt
You are executing the thecolony-heartbeat workflow. Use the following context:
