...
> Original: [https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/personal-analytics/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/personal-analytics/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run personal-analytics`)
...
```prompt
You are executing the personal-analytics workflow. Use the following context:
