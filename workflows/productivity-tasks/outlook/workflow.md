...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jotamed/outlook/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jotamed/outlook/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run outlook`)
...
```prompt
You are executing the outlook workflow. Use the following context:
