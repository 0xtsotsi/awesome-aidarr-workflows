...
> Original: [https://github.com/openclaw/skills/tree/main/skills/patelhiren/mastodon-scout/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/patelhiren/mastodon-scout/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mastodon-scout`)
...
```prompt
You are executing the mastodon-scout workflow. Use the following context:
