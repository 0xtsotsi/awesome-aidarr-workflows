...
> Original: [https://github.com/openclaw/skills/tree/main/skills/shashwatgtm/social-media-management/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/shashwatgtm/social-media-management/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run social-media-management`)
...
```prompt
You are executing the social-media-management workflow. Use the following context:
