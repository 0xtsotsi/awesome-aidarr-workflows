...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mvarrieur/imap-email/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mvarrieur/imap-email/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run imap-email`)
...
```prompt
You are executing the imap-email workflow. Use the following context:
