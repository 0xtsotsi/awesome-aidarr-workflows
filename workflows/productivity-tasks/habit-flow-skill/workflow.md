...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tralves/habit-flow-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tralves/habit-flow-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run habit-flow-skill`)
...
```prompt
You are executing the habit-flow-skill workflow. Use the following context:
