...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bastos/topydo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bastos/topydo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run topydo`)
...
```prompt
You are executing the topydo workflow. Use the following context:
