...
> Original: [https://github.com/openclaw/skills/tree/main/skills/regenrek/samsung-smartthings/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/regenrek/samsung-smartthings/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run samsung-smart-tv`)
...
```prompt
You are executing the samsung-smart-tv workflow. Use the following context:
