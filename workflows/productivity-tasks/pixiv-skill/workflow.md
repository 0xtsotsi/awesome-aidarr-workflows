...
> Original: [https://github.com/openclaw/skills/tree/main/skills/matrix-meta/pixiv-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/matrix-meta/pixiv-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pixiv-skill`)
...
```prompt
You are executing the pixiv-skill workflow. Use the following context:
