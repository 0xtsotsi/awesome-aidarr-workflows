...
> Original: [https://github.com/openclaw/skills/tree/main/skills/luccast/gogcli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/luccast/gogcli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gogcli`)
...
```prompt
You are executing the gogcli workflow. Use the following context:
