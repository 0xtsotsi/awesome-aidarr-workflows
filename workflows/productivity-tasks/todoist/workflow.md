...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mjrussell/todoist/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mjrussell/todoist/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run todoist`)
...
```prompt
You are executing the todoist workflow. Use the following context:
