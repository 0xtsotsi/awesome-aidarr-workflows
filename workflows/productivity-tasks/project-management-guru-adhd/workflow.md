...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mikecourt/project-management-guru-adhd/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mikecourt/project-management-guru-adhd/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run project-management-guru-adhd`)
...
```prompt
You are executing the project-management-guru-adhd workflow. Use the following context:
