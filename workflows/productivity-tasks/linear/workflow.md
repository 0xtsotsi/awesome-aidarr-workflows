...
> Original: [https://github.com/openclaw/skills/tree/main/skills/manuelhettich/linear/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/manuelhettich/linear/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run linear`)
...
```prompt
You are executing the linear workflow. Use the following context:
