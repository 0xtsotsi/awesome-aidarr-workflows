...
> Original: [https://github.com/openclaw/skills/tree/main/skills/coyote-git/omnifocus-automation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/coyote-git/omnifocus-automation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run omnifocus`)
...
```prompt
You are executing the omnifocus workflow. Use the following context:
