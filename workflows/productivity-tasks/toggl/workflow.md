...
> Original: [https://github.com/openclaw/skills/tree/main/skills/clvrobj/toggl/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/clvrobj/toggl/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run toggl`)
...
```prompt
You are executing the toggl workflow. Use the following context:
