...
> Original: [https://github.com/openclaw/skills/tree/main/skills/florianrauscha/timesheet/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/florianrauscha/timesheet/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run timesheet`)
...
```prompt
You are executing the timesheet workflow. Use the following context:
