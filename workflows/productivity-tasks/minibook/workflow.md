...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dioxia/minibook/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dioxia/minibook/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run minibook`)
...
```prompt
You are executing the minibook workflow. Use the following context:
