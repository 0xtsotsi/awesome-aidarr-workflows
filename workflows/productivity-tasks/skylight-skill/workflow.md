...
> Original: [https://github.com/openclaw/skills/tree/main/skills/riyadchowdhury/skylight-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/riyadchowdhury/skylight-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skylight-skill`)
...
```prompt
You are executing the skylight-skill workflow. Use the following context:
