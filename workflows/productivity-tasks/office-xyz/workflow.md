...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sunnyguoyuan/office-xyz/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sunnyguoyuan/office-xyz/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run office-xyz`)
...
```prompt
You are executing the office-xyz workflow. Use the following context:
