...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jmagar/prowlarr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jmagar/prowlarr/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run prowlarr`)
...
```prompt
You are executing the prowlarr workflow. Use the following context:
