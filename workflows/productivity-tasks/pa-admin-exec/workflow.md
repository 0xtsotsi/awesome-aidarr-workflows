...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kowl64/pa-admin-exec/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kowl64/pa-admin-exec/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pa-admin-exec`)
...
```prompt
You are executing the pa-admin-exec workflow. Use the following context:
