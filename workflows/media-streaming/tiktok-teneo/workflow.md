...
> Original: [https://github.com/openclaw/skills/tree/main/skills/firestream792/tiktok-teneo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/firestream792/tiktok-teneo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tiktok-teneo`)
...
```prompt
You are executing the tiktok-teneo workflow. Use the following context:
