...
> Original: [https://github.com/openclaw/skills/tree/main/skills/elestirelbilinc-sketch/vap-media/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/elestirelbilinc-sketch/vap-media/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vap-media`)
...
```prompt
You are executing the vap-media workflow. Use the following context:
