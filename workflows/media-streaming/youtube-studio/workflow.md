...
> Original: [https://github.com/openclaw/skills/tree/main/skills/snail3d/youtube-studio/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/snail3d/youtube-studio/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-studio`)
...
```prompt
You are executing the youtube-studio workflow. Use the following context:
