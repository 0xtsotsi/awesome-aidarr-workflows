...
> Original: [https://github.com/openclaw/skills/tree/main/skills/franciscoandsam/youtube-voice-summarizer-elevenlabs/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/franciscoandsam/youtube-voice-summarizer-elevenlabs/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-voice-summarizer-elevenlabs`)
...
```prompt
You are executing the youtube-voice-summarizer-elevenlabs workflow. Use the following context:
