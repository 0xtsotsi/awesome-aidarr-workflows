...
> Original: [https://github.com/openclaw/skills/tree/main/skills/huchengtw/vehicle-tracker/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/huchengtw/vehicle-tracker/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vehicle-tracker`)
...
```prompt
You are executing the vehicle-tracker workflow. Use the following context:
