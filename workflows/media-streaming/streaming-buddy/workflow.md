...
> Original: [https://github.com/openclaw/skills/tree/main/skills/udiedrichsen/streaming-buddy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/udiedrichsen/streaming-buddy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run streaming-buddy`)
...
```prompt
You are executing the streaming-buddy workflow. Use the following context:
