...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mladjan/tiktok-android/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mladjan/tiktok-android/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tiktok-android`)
...
```prompt
You are executing the tiktok-android workflow. Use the following context:
