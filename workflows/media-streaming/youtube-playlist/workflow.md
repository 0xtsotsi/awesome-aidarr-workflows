...
> Original: [https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-playlist/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-playlist/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-playlist`)
...
```prompt
You are executing the youtube-playlist workflow. Use the following context:
