...
> Original: [https://github.com/openclaw/skills/tree/main/skills/viticci/youtube-instant-article/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/viticci/youtube-instant-article/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-instant-article`)
...
```prompt
You are executing the youtube-instant-article workflow. Use the following context:
