...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jordanprater/youtube-video-downloader/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jordanprater/youtube-video-downloader/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-video-downloader`)
...
```prompt
You are executing the youtube-video-downloader workflow. Use the following context:
