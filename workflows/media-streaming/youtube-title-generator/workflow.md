...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vincentchan/youtube-title-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vincentchan/youtube-title-generator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-title-generator`)
...
```prompt
You are executing the youtube-title-generator workflow. Use the following context:
