...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vovavvk/tl-dw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vovavvk/tl-dw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tl-dw`)
...
```prompt
You are executing the tl-dw workflow. Use the following context:
