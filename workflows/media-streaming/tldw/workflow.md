...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vovavvk/tldw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vovavvk/tldw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tldw`)
...
```prompt
You are executing the tldw workflow. Use the following context:
