...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sandeepyadav1478/youtube-downloader-clipper/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sandeepyadav1478/youtube-downloader-clipper/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-downloader-clipper`)
...
```prompt
You are executing the youtube-downloader-clipper workflow. Use the following context:
