...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-backend/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-backend/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run senior-backend`)
...
```prompt
You are executing the senior-backend workflow. Use the following context:
