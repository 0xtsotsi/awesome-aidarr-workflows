...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aleph8/virustotal-security-scanner/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aleph8/virustotal-security-scanner/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run virustotal-security-scanner`)
...
```prompt
You are executing the virustotal-security-scanner workflow. Use the following context:
