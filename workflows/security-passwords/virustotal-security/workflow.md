...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aleph8/virustotal-security/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aleph8/virustotal-security/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run virustotal-security`)
...
```prompt
You are executing the virustotal-security workflow. Use the following context:
