...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kylehuan/skill-security-audit/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kylehuan/skill-security-audit/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-security-audit`)
...
```prompt
You are executing the skill-security-audit workflow. Use the following context:
