...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lobstergeneralintelligence/x-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lobstergeneralintelligence/x-api/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-api`)
...
```prompt
You are executing the x-api workflow. Use the following context:
