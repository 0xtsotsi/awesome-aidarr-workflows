...
> Original: [https://github.com/openclaw/skills/tree/main/skills/acastellana/vpn-rotate-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/acastellana/vpn-rotate-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vpn-rotate-skill`)
...
```prompt
You are executing the vpn-rotate-skill workflow. Use the following context:
