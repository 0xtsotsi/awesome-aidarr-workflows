...
> Original: [https://github.com/openclaw/skills/tree/main/skills/snail3d/soul-shepherd/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/snail3d/soul-shepherd/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run soul-shepherd`)
...
```prompt
You are executing the soul-shepherd workflow. Use the following context:
