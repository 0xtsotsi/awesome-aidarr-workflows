...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-secops/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-secops/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run senior-secops`)
...
```prompt
You are executing the senior-secops workflow. Use the following context:
