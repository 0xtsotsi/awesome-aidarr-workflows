...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jamesouttake/skill-guard/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jamesouttake/skill-guard/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-guard`)
...
```prompt
You are executing the skill-guard workflow. Use the following context:
