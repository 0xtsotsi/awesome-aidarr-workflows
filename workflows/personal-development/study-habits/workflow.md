...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jhillin8/study-habits/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jhillin8/study-habits/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run study-habits`)
...
```prompt
You are executing the study-habits workflow. Use the following context:
