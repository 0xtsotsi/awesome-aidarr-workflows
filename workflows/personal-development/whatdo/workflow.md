...
> Original: [https://github.com/openclaw/skills/tree/main/skills/scottfo/whatdo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/scottfo/whatdo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run whatdo`)
...
```prompt
You are executing the whatdo workflow. Use the following context:
