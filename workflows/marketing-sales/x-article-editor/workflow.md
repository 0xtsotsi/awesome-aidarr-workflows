...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/x-article-editor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/x-article-editor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-article-editor`)
...
```prompt
You are executing the x-article-editor workflow. Use the following context:
