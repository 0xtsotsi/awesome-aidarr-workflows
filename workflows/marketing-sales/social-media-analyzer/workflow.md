...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/social-media-analyzer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/social-media-analyzer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run social-media-analyzer`)
...
```prompt
You are executing the social-media-analyzer workflow. Use the following context:
