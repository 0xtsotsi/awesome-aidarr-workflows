...
> Original: [https://github.com/openclaw/skills/tree/main/skills/didelco/pvpc-spain/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/didelco/pvpc-spain/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pvpc-spain`)
...
```prompt
You are executing the pvpc-spain workflow. Use the following context:
