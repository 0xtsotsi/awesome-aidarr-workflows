...
> Original: [https://github.com/openclaw/skills/tree/main/skills/limone-eth/molthunt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/limone-eth/molthunt/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run molthunt`)
...
```prompt
You are executing the molthunt workflow. Use the following context:
