...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/schema-markup/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/schema-markup/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run schema-markup`)
...
```prompt
You are executing the schema-markup workflow. Use the following context:
