...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nickhamze/pinch-to-post/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nickhamze/pinch-to-post/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pinch-to-post`)
...
```prompt
You are executing the pinch-to-post workflow. Use the following context:
