...
> Original: [https://github.com/openclaw/skills/tree/main/skills/yogesharc/supalytics/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/yogesharc/supalytics/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run supalytics`)
...
```prompt
You are executing the supalytics workflow. Use the following context:
