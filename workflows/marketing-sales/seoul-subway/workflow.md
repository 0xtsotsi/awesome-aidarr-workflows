...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dukbong/seoul-subway/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dukbong/seoul-subway/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run seoul-subway`)
...
```prompt
You are executing the seoul-subway workflow. Use the following context:
