...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sbaker5/polyedge/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sbaker5/polyedge/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run polyedge`)
...
```prompt
You are executing the polyedge workflow. Use the following context:
