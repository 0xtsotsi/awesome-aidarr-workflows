...
> Original: [https://github.com/openclaw/skills/tree/main/skills/seanphan/notebooklm/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/seanphan/notebooklm/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run notebooklm`)
...
```prompt
You are executing the notebooklm workflow. Use the following context:
