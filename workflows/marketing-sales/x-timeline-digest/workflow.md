...
> Original: [https://github.com/openclaw/skills/tree/main/skills/seandong/x-timeline-digest/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/seandong/x-timeline-digest/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-timeline-digest`)
...
```prompt
You are executing the x-timeline-digest workflow. Use the following context:
