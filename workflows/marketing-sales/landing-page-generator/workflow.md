...
> Original: [https://github.com/openclaw/skills/tree/main/skills/michael-laffin/landing-page-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/michael-laffin/landing-page-generator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run landing-page-generator`)
...
```prompt
You are executing the landing-page-generator workflow. Use the following context:
