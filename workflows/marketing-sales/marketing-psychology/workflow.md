...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/marketing-psychology/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/marketing-psychology/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run marketing-psychology`)
...
```prompt
You are executing the marketing-psychology workflow. Use the following context:
