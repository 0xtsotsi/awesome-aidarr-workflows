...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vedantsingh60/seo-optimizer-pro/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vedantsingh60/seo-optimizer-pro/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run seo-optimizer-pro`)
...
```prompt
You are executing the seo-optimizer-pro workflow. Use the following context:
