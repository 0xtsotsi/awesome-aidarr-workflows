...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lucasgulino/lead-gen-website/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lucasgulino/lead-gen-website/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run lead-gen-website`)
...
```prompt
You are executing the lead-gen-website workflow. Use the following context:
