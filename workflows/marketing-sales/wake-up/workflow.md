...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cgallic/wake-up/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cgallic/wake-up/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wake-up`)
...
```prompt
You are executing the wake-up workflow. Use the following context:
