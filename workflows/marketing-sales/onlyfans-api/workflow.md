...
> Original: [https://github.com/openclaw/skills/tree/main/skills/martingalovic/onlyfans-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/martingalovic/onlyfans-api/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run onlyfans-api`)
...
```prompt
You are executing the onlyfans-api workflow. Use the following context:
