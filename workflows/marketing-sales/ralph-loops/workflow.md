...
> Original: [https://github.com/openclaw/skills/tree/main/skills/qlifebot-coder/ralph-loops/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/qlifebot-coder/ralph-loops/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ralph-loops`)
...
```prompt
You are executing the ralph-loops workflow. Use the following context:
