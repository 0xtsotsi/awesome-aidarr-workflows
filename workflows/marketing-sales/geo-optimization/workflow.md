...
> Original: [https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/geo-optimization/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/geo-optimization/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run geo-optimization`)
...
```prompt
You are executing the geo-optimization workflow. Use the following context:
