...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/programmatic-seo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/programmatic-seo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run programmatic-seo`)
...
```prompt
You are executing the programmatic-seo workflow. Use the following context:
