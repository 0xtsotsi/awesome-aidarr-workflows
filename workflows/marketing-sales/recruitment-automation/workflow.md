...
> Original: [https://github.com/openclaw/skills/tree/main/skills/seyhunak/recruitment-automation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/seyhunak/recruitment-automation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run recruitment-automation`)
...
```prompt
You are executing the recruitment-automation workflow. Use the following context:
