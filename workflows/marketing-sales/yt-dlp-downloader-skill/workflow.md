...
> Original: [https://github.com/openclaw/skills/tree/main/skills/apollo1234/yt-dlp-downloader-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/apollo1234/yt-dlp-downloader-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run yt-dlp-downloader-skill`)
...
```prompt
You are executing the yt-dlp-downloader-skill workflow. Use the following context:
