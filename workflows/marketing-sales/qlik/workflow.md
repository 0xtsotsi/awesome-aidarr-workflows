...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fianabates1/qlik/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fianabates1/qlik/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run qlik`)
...
```prompt
You are executing the qlik workflow. Use the following context:
