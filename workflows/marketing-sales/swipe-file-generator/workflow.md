...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vincentchan/swipe-file-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vincentchan/swipe-file-generator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run swipe-file-generator`)
...
```prompt
You are executing the swipe-file-generator workflow. Use the following context:
