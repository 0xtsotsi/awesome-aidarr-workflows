...
> Original: [https://github.com/openclaw/skills/tree/main/skills/shreefentsar/zoho/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/shreefentsar/zoho/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zoho`)
...
```prompt
You are executing the zoho workflow. Use the following context:
