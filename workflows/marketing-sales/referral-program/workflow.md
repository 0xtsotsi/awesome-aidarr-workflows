...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/referral-program/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/referral-program/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run referral-program`)
...
```prompt
You are executing the referral-program workflow. Use the following context:
