...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hosnik/prediction-markets-roarin/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hosnik/prediction-markets-roarin/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run prediction-markets-roarin`)
...
```prompt
You are executing the prediction-markets-roarin workflow. Use the following context:
