...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jdrhyne/gsc/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jdrhyne/gsc/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gsc`)
...
```prompt
You are executing the gsc workflow. Use the following context:
