...
> Original: [https://github.com/openclaw/skills/tree/main/skills/preston-thiele/tools-marketplace/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/preston-thiele/tools-marketplace/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tools-marketplace`)
...
```prompt
You are executing the tools-marketplace workflow. Use the following context:
