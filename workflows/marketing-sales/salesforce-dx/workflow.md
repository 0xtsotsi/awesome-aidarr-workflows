...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rjmcgirr-pl/salesforce-dx/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rjmcgirr-pl/salesforce-dx/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run salesforce-dx`)
...
```prompt
You are executing the salesforce-dx workflow. Use the following context:
