...
> Original: [https://github.com/openclaw/skills/tree/main/skills/boilerrat/modular-market-brief/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/boilerrat/modular-market-brief/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run modular-market-brief`)
...
```prompt
You are executing the modular-market-brief workflow. Use the following context:
