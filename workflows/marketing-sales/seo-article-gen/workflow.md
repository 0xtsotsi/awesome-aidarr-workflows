...
> Original: [https://github.com/openclaw/skills/tree/main/skills/michael-laffin/seo-article-gen/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/michael-laffin/seo-article-gen/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run seo-article-gen`)
...
```prompt
You are executing the seo-article-gen workflow. Use the following context:
