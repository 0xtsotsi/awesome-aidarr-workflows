...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ya7ya/openbroker/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ya7ya/openbroker/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openbroker`)
...
```prompt
You are executing the openbroker workflow. Use the following context:
