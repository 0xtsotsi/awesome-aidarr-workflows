...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dukbong/seoul-metro/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dukbong/seoul-metro/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run seoul-metro`)
...
```prompt
You are executing the seoul-metro workflow. Use the following context:
