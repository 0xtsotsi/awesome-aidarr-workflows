...
> Original: [https://github.com/openclaw/skills/tree/main/skills/playdadev/polt-user/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/playdadev/polt-user/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run polt-user`)
...
```prompt
You are executing the polt-user workflow. Use the following context:
