...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/package-seo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/package-seo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run package-seo`)
...
```prompt
You are executing the package-seo workflow. Use the following context:
