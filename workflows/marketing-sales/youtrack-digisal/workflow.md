...
> Original: [https://github.com/openclaw/skills/tree/main/skills/digisal/youtrack-digisal/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/digisal/youtrack-digisal/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtrack-digisal`)
...
```prompt
You are executing the youtrack-digisal workflow. Use the following context:
