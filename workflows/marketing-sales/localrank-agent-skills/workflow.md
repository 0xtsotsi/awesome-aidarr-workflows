...
> Original: [https://github.com/openclaw/skills/tree/main/skills/peterw/localrank-agent-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/peterw/localrank-agent-skills/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run localrank-agent-skills`)
...
```prompt
You are executing the localrank-agent-skills workflow. Use the following context:
