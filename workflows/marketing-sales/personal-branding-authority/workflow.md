...
> Original: [https://github.com/openclaw/skills/tree/main/skills/shashwatgtm/personal-branding-authority/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/shashwatgtm/personal-branding-authority/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run personal-branding-authority`)
...
```prompt
You are executing the personal-branding-authority workflow. Use the following context:
