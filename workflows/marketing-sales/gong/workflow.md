...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jdrhyne/gong/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jdrhyne/gong/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gong`)
...
```prompt
You are executing the gong workflow. Use the following context:
