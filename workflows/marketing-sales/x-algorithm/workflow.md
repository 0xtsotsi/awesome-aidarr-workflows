...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/x-algorithm/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/x-algorithm/SKILL.md)
...
X (Twitter) algorithm rules, viral strategies, and article best practices. Boost engagement, avoid reach death, write posts that perform. Works with AI agents, Claude, Cursor.
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-algorithm`)
...
```prompt
You are executing the x-algorithm workflow. Use the following context:
