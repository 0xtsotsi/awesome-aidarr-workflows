...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hadifarnoud/pakat/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hadifarnoud/pakat/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pakat`)
...
```prompt
You are executing the pakat workflow. Use the following context:
