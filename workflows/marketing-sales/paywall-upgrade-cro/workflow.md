...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/paywall-upgrade-cro/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/paywall-upgrade-cro/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run paywall-upgrade-cro`)
...
```prompt
You are executing the paywall-upgrade-cro workflow. Use the following context:
