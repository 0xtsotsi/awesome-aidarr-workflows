...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dbhurley/otter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dbhurley/otter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run otter`)
...
```prompt
You are executing the otter workflow. Use the following context:
