...
> Original: [https://github.com/openclaw/skills/tree/main/skills/z233/weread/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/z233/weread/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run weread`)
...
```prompt
You are executing the weread workflow. Use the following context:
