...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vincentchan/tweet-ideas-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vincentchan/tweet-ideas-generator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tweet-ideas-generator`)
...
```prompt
You are executing the tweet-ideas-generator workflow. Use the following context:
