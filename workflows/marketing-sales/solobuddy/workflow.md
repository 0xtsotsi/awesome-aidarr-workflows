...
> Original: [https://github.com/openclaw/skills/tree/main/skills/humanji7/solobuddy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/humanji7/solobuddy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run solobuddy`)
...
```prompt
You are executing the solobuddy workflow. Use the following context:
