...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thesethrose/typefully/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thesethrose/typefully/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run typefully`)
...
```prompt
You are executing the typefully workflow. Use the following context:
