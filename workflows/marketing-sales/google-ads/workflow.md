...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jdrhyne/google-ads/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jdrhyne/google-ads/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run google-ads`)
...
```prompt
You are executing the google-ads workflow. Use the following context:
