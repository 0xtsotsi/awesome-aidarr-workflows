...
> Original: [https://github.com/openclaw/skills/tree/main/skills/michael-laffin/newsletter-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/michael-laffin/newsletter-generator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run newsletter-generator`)
...
```prompt
You are executing the newsletter-generator workflow. Use the following context:
