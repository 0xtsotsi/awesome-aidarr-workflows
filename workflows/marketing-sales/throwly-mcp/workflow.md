...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kelvis24/throwly-mcp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kelvis24/throwly-mcp/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run throwly-mcp`)
...
```prompt
You are executing the throwly-mcp workflow. Use the following context:
