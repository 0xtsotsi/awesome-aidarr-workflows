...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thesethrose/marketing-mode/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thesethrose/marketing-mode/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run marketing-mode`)
...
```prompt
You are executing the marketing-mode workflow. Use the following context:
