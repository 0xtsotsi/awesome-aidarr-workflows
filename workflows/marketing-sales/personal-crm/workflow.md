...
> Original: [https://github.com/openclaw/skills/tree/main/skills/matthewpoe/personal-crm/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/matthewpoe/personal-crm/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run personal-crm`)
...
```prompt
You are executing the personal-crm workflow. Use the following context:
