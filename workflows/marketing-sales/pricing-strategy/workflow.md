...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/pricing-strategy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/pricing-strategy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pricing-strategy`)
...
```prompt
You are executing the pricing-strategy workflow. Use the following context:
