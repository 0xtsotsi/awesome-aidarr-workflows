...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mrlynn/netpad/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mrlynn/netpad/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run netpad`)
...
```prompt
You are executing the netpad workflow. Use the following context:
