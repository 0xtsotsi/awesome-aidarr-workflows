...
> Original: [https://github.com/openclaw/skills/tree/main/skills/garrrikkotua/octolens/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/garrrikkotua/octolens/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run octolens`)
...
```prompt
You are executing the octolens workflow. Use the following context:
