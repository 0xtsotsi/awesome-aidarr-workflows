...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fortytwode/meta-ad-creatives/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fortytwode/meta-ad-creatives/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run meta-ad-creatives`)
...
```prompt
You are executing the meta-ad-creatives workflow. Use the following context:
