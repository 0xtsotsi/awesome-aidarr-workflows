...
> Original: [https://github.com/openclaw/skills/tree/main/skills/julian-r/vodoo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/julian-r/vodoo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vodoo`)
...
```prompt
You are executing the vodoo workflow. Use the following context:
