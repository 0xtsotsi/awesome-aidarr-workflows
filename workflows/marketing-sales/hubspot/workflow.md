...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kwall1/hubspot/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kwall1/hubspot/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hubspot`)
...
```prompt
You are executing the hubspot workflow. Use the following context:
