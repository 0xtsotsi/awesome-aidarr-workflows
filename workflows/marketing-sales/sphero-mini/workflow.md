...
> Original: [https://github.com/openclaw/skills/tree/main/skills/joneschi/sphero-mini/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/joneschi/sphero-mini/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sphero-mini`)
...
```prompt
You are executing the sphero-mini workflow. Use the following context:
