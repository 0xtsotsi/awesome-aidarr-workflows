...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/marketing-demand-acquisition/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/marketing-demand-acquisition/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run marketing-demand-acquisition`)
...
```prompt
You are executing the marketing-demand-acquisition workflow. Use the following context:
