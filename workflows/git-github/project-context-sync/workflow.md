...
> Original: [https://github.com/openclaw/skills/tree/main/skills/joe3112/project-context-sync/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/joe3112/project-context-sync/SKILL.md)
> Category: Git & GitHub
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run project-context-sync`)
...
```prompt
You are executing the project-context-sync workflow. Use the following context:
