...
> Original: [https://github.com/openclaw/skills/tree/main/skills/brucko/soulstamp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/brucko/soulstamp/SKILL.md)
> Category: Git & GitHub
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run soulstamp`)
...
```prompt
You are executing the soulstamp workflow. Use the following context:
