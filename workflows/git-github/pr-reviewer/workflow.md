...
> Original: [https://github.com/openclaw/skills/tree/main/skills/briancolinger/pr-reviewer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/briancolinger/pr-reviewer/SKILL.md)
> Category: Git & GitHub
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pr-reviewer`)
...
```prompt
You are executing the pr-reviewer workflow. Use the following context:
