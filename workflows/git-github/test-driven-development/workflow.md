...
> Original: [https://github.com/openclaw/skills/tree/main/skills/paulpete/test-driven-development/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/paulpete/test-driven-development/SKILL.md)
> Category: Git & GitHub
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run test-driven-development`)
...
```prompt
You are executing the test-driven-development workflow. Use the following context:
