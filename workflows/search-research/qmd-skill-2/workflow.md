...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lifecoacher/qmd-skill-2/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lifecoacher/qmd-skill-2/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run qmd-skill-2`)
...
```prompt
You are executing the qmd-skill-2 workflow. Use the following context:
