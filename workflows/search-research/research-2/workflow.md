...
> Original: [https://github.com/openclaw/skills/tree/main/skills/barneyjm/research-2/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/barneyjm/research-2/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run research-2`)
...
```prompt
You are executing the research-2 workflow. Use the following context:
