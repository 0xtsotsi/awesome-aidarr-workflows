...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sanky369/tweet-writer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sanky369/tweet-writer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tweet-writer`)
...
```prompt
You are executing the tweet-writer workflow. Use the following context:
