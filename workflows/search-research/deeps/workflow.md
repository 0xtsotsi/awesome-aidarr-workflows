...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ttboy/deeps/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ttboy/deeps/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run deeps`)
...
```prompt
You are executing the deeps workflow. Use the following context:
