...
> Original: [https://github.com/openclaw/skills/tree/main/skills/paul-phan/crisp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/paul-phan/crisp/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run crisp`)
...
```prompt
You are executing the crisp workflow. Use the following context:
