...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nesdeq/openclaw-serper/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nesdeq/openclaw-serper/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaw-serper`)
...
```prompt
You are executing the openclaw-serper workflow. Use the following context:
