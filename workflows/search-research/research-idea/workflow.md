...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rqrqrqrq/research-idea/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rqrqrqrq/research-idea/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run research-idea`)
...
```prompt
You are executing the research-idea workflow. Use the following context:
