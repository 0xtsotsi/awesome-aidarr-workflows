...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mjaskolski/elicitation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mjaskolski/elicitation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run elicitation`)
...
```prompt
You are executing the elicitation workflow. Use the following context:
