...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nathanjzhao/contextoverflow/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nathanjzhao/contextoverflow/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run contextoverflow`)
...
```prompt
You are executing the contextoverflow workflow. Use the following context:
