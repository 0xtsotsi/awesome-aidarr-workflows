...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arnarsson/ripgrep/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arnarsson/ripgrep/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ripgrep`)
...
```prompt
You are executing the ripgrep workflow. Use the following context:
