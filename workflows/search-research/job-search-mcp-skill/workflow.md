...
> Original: [https://github.com/openclaw/skills/tree/main/skills/amoghpurohit/job-search-mcp-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/amoghpurohit/job-search-mcp-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run job-search-mcp-skill`)
...
```prompt
You are executing the job-search-mcp-skill workflow. Use the following context:
