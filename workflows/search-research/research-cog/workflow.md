...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/research-cog/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/research-cog/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run research-cog`)
...
```prompt
You are executing the research-cog workflow. Use the following context:
