...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/think-cog/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/think-cog/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run think-cog`)
...
```prompt
You are executing the think-cog workflow. Use the following context:
