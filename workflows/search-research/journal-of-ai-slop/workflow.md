...
> Original: [https://github.com/openclaw/skills/tree/main/skills/popidge/journal-of-ai-slop/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/popidge/journal-of-ai-slop/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run journal-of-ai-slop`)
...
```prompt
You are executing the journal-of-ai-slop workflow. Use the following context:
