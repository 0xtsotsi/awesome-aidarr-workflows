...
> Original: [https://github.com/openclaw/skills/tree/main/skills/whyhit2005/zhipu-web-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/whyhit2005/zhipu-web-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zhipu-web-search`)
...
```prompt
You are executing the zhipu-web-search workflow. Use the following context:
