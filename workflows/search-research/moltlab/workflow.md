...
> Original: [https://github.com/openclaw/skills/tree/main/skills/iterdimensionaltv1/moltlab/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/iterdimensionaltv1/moltlab/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltlab`)
...
```prompt
You are executing the moltlab workflow. Use the following context:
