...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zxrys/weak-accept/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zxrys/weak-accept/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run weak-accept`)
...
```prompt
You are executing the weak-accept workflow. Use the following context:
