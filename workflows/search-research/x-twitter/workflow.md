...
> Original: [https://github.com/openclaw/skills/tree/main/skills/annettemekuro30/x-twitter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/annettemekuro30/x-twitter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-twitter`)
...
```prompt
You are executing the x-twitter workflow. Use the following context:
