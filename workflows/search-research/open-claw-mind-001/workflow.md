...
> Original: [https://github.com/openclaw/skills/tree/main/skills/teylersf/open-claw-mind-001/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/teylersf/open-claw-mind-001/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run open-claw-mind-001`)
...
```prompt
You are executing the open-claw-mind-001 workflow. Use the following context:
