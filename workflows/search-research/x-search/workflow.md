...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tzannetosgiannis/x-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tzannetosgiannis/x-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-search`)
...
```prompt
You are executing the x-search workflow. Use the following context:
