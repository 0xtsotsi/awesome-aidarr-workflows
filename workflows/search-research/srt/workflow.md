...
> Original: [https://github.com/openclaw/skills/tree/main/skills/khj809/srt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/khj809/srt/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run srt`)
...
```prompt
You are executing the srt workflow. Use the following context:
