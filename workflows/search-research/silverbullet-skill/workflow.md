...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ramonitor/silverbullet-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ramonitor/silverbullet-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run silverbullet-skill`)
...
```prompt
You are executing the silverbullet-skill workflow. Use the following context:
