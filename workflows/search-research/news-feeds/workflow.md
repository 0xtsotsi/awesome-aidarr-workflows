...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lknik/news-feeds/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lknik/news-feeds/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run news-feeds`)
...
```prompt
You are executing the news-feeds workflow. Use the following context:
