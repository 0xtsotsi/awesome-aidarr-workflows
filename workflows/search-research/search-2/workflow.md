...
> Original: [https://github.com/openclaw/skills/tree/main/skills/barneyjm/search-2/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/barneyjm/search-2/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run search-2`)
...
```prompt
You are executing the search-2 workflow. Use the following context:
