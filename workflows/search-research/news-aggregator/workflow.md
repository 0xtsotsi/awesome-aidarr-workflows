...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cclank/news-aggregator-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cclank/news-aggregator-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run news-aggregator`)
...
```prompt
You are executing the news-aggregator workflow. Use the following context:
