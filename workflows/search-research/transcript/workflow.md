...
> Original: [https://github.com/openclaw/skills/tree/main/skills/therohitdas/transcript/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/therohitdas/transcript/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run transcript`)
...
```prompt
You are executing the transcript workflow. Use the following context:
