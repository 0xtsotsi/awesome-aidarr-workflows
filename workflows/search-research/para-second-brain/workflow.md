...
> Original: [https://github.com/openclaw/skills/tree/main/skills/halthelobster/para-second-brain/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/halthelobster/para-second-brain/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run para-second-brain`)
...
```prompt
You are executing the para-second-brain workflow. Use the following context:
