...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zats/last30days/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zats/last30days/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run last30days`)
...
```prompt
You are executing the last30days workflow. Use the following context:
