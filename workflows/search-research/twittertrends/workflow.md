...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jordanprater/twittertrends/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jordanprater/twittertrends/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run twittertrends`)
...
```prompt
You are executing the twittertrends workflow. Use the following context:
