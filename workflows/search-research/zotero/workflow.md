...
> Original: [https://github.com/openclaw/skills/tree/main/skills/terwox/zotero/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/terwox/zotero/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zotero`)
...
```prompt
You are executing the zotero workflow. Use the following context:
