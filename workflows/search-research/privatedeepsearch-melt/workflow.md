...
> Original: [https://github.com/openclaw/skills/tree/main/skills/romancircus/privatedeepsearch-melt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/romancircus/privatedeepsearch-melt/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run privatedeepsearch-melt`)
...
```prompt
You are executing the privatedeepsearch-melt workflow. Use the following context:
