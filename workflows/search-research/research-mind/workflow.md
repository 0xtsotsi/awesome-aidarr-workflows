...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lraivisto/research-mind/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lraivisto/research-mind/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run research-mind`)
...
```prompt
You are executing the research-mind workflow. Use the following context:
