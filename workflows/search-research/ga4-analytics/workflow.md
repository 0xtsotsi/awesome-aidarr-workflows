...
> Original: [https://github.com/openclaw/skills/tree/main/skills/adamkristopher/ga4-analytics/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/adamkristopher/ga4-analytics/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ga4-analytics`)
...
```prompt
You are executing the ga4-analytics workflow. Use the following context:
