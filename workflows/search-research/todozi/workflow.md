...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bgengs/todozi/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bgengs/todozi/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run todozi`)
...
```prompt
You are executing the todozi workflow. Use the following context:
