...
> Original: [https://github.com/openclaw/skills/tree/main/skills/10e9928a/duckduckgo-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/10e9928a/duckduckgo-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run duckduckgo-search`)
...
```prompt
You are executing the duckduckgo-search workflow. Use the following context:
