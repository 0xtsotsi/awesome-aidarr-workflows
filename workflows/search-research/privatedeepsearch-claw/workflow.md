...
> Original: [https://github.com/openclaw/skills/tree/main/skills/romancircus/privatedeepsearch-claw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/romancircus/privatedeepsearch-claw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run privatedeepsearch-claw`)
...
```prompt
You are executing the privatedeepsearch-claw workflow. Use the following context:
