...
> Original: [https://github.com/openclaw/skills/tree/main/skills/faleksic/dhmz-weather/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/faleksic/dhmz-weather/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run dhmz-weather`)
...
```prompt
You are executing the dhmz-weather workflow. Use the following context:
