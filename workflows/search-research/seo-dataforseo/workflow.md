...
> Original: [https://github.com/openclaw/skills/tree/main/skills/adamkristopher/seo-dataforseo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/adamkristopher/seo-dataforseo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run seo-dataforseo`)
...
```prompt
You are executing the seo-dataforseo workflow. Use the following context:
