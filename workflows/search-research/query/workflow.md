...
> Original: [https://github.com/openclaw/skills/tree/main/skills/barneyjm/query/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/barneyjm/query/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run query`)
...
```prompt
You are executing the query workflow. Use the following context:
