...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hegghammer/newsapi-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hegghammer/newsapi-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run newsapi-search`)
...
```prompt
You are executing the newsapi-search workflow. Use the following context:
