...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jneless/volcengine-tos-vectors-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jneless/volcengine-tos-vectors-skills/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run volcengine-tos-vectors-skills`)
...
```prompt
You are executing the volcengine-tos-vectors-skills workflow. Use the following context:
