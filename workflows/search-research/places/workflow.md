...
> Original: [https://github.com/openclaw/skills/tree/main/skills/barneyjm/places/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/barneyjm/places/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run places`)
...
```prompt
You are executing the places workflow. Use the following context:
