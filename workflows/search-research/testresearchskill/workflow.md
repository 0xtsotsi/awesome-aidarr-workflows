...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cyberengage/testresearchskill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cyberengage/testresearchskill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run testresearchskill`)
...
```prompt
You are executing the testresearchskill workflow. Use the following context:
