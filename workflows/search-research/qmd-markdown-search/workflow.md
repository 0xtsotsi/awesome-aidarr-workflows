...
> Original: [https://github.com/openclaw/skills/tree/main/skills/emcmillan80/qmd-markdown-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/emcmillan80/qmd-markdown-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run qmd-markdown-search`)
...
```prompt
You are executing the qmd-markdown-search workflow. Use the following context:
