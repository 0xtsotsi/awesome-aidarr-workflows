...
> Original: [https://github.com/openclaw/skills/tree/main/skills/firestream792/google-teneo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/firestream792/google-teneo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run google-teneo`)
...
```prompt
You are executing the google-teneo workflow. Use the following context:
