...
> Original: [https://github.com/openclaw/skills/tree/main/skills/galizki/evoweb-ai/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/galizki/evoweb-ai/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run evoweb-ai`)
...
```prompt
You are executing the evoweb-ai workflow. Use the following context:
