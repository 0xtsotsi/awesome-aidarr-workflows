...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arein/tg/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arein/tg/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tg`)
...
```prompt
You are executing the tg workflow. Use the following context:
