...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dustinjamest/skill-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dustinjamest/skill-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-search`)
...
```prompt
You are executing the skill-search workflow. Use the following context:
