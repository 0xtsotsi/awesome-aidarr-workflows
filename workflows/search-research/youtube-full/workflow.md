...
> Original: [https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-full/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-full/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-full`)
...
```prompt
You are executing the youtube-full workflow. Use the following context:
