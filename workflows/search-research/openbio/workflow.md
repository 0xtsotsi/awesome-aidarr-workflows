...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ravishar313/openbio/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ravishar313/openbio/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openbio`)
...
```prompt
You are executing the openbio workflow. Use the following context:
