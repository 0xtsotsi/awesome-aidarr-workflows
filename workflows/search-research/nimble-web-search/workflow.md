...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ilchemla/nimble-web-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ilchemla/nimble-web-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nimble-web-search`)
...
```prompt
You are executing the nimble-web-search workflow. Use the following context:
