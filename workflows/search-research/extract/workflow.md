...
> Original: [https://github.com/openclaw/skills/tree/main/skills/barneyjm/extract/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/barneyjm/extract/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run extract`)
...
```prompt
You are executing the extract workflow. Use the following context:
