...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kantorcodes/registry-broker-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kantorcodes/registry-broker-skills/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run registry-broker-skills`)
...
```prompt
You are executing the registry-broker-skills workflow. Use the following context:
