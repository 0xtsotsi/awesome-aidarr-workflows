...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cyberfront-ai/pinterest/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cyberfront-ai/pinterest/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pinterest`)
...
```prompt
You are executing the pinterest workflow. Use the following context:
