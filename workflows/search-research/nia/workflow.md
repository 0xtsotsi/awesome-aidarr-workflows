...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arlanrakh/nia/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arlanrakh/nia/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nia`)
...
```prompt
You are executing the nia workflow. Use the following context:
