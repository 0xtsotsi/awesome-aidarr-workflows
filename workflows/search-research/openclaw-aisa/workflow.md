...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aisa-one/openclaw-aisa/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aisa-one/openclaw-aisa/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaw-aisa`)
...
```prompt
You are executing the openclaw-aisa workflow. Use the following context:
