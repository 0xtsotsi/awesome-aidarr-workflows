...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ryx2/raysurfer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ryx2/raysurfer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run raysurfer`)
...
```prompt
You are executing the raysurfer workflow. Use the following context:
