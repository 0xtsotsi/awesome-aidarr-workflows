...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jiacode/deepresearchwork/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jiacode/deepresearchwork/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run deepresearchwork`)
...
```prompt
You are executing the deepresearchwork workflow. Use the following context:
