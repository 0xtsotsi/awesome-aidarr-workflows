...
> Original: [https://github.com/openclaw/skills/tree/main/skills/madsb/nanobazaar/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/madsb/nanobazaar/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nanobazaar`)
...
```prompt
You are executing the nanobazaar workflow. Use the following context:
