...
> Original: [https://github.com/openclaw/skills/tree/main/skills/phheng/google-news-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/phheng/google-news-api/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run google-news-api`)
...
```prompt
You are executing the google-news-api workflow. Use the following context:
