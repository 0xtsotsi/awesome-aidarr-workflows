...
> Original: [https://github.com/openclaw/skills/tree/main/skills/datadrivenconstruction/semantic-search-cwicr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/datadrivenconstruction/semantic-search-cwicr/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run semantic-search-cwicr`)
...
```prompt
You are executing the semantic-search-cwicr workflow. Use the following context:
