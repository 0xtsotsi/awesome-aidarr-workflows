...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kevinjinko/jinko-flight-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kevinjinko/jinko-flight-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run jinko-flight-search`)
...
```prompt
You are executing the jinko-flight-search workflow. Use the following context:
