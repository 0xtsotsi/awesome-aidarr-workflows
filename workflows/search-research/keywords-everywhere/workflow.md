...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sanky369/keywords-everywhere/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sanky369/keywords-everywhere/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run keywords-everywhere`)
...
```prompt
You are executing the keywords-everywhere workflow. Use the following context:
