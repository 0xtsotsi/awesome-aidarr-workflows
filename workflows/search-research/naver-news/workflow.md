...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steamb23/naver-news/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steamb23/naver-news/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run naver-news`)
...
```prompt
You are executing the naver-news workflow. Use the following context:
