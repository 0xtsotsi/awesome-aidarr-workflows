...
> Original: [https://github.com/openclaw/skills/tree/main/skills/engahmedsalah358-lgtm/whats/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/engahmedsalah358-lgtm/whats/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run whats`)
...
```prompt
You are executing the whats workflow. Use the following context:
