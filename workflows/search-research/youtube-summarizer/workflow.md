...
> Original: [https://github.com/openclaw/skills/tree/main/skills/abe238/youtube-summarizer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/abe238/youtube-summarizer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-summarizer`)
...
```prompt
You are executing the youtube-summarizer workflow. Use the following context:
