...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vaguilera-jinko/plane/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vaguilera-jinko/plane/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run plane`)
...
```prompt
You are executing the plane workflow. Use the following context:
