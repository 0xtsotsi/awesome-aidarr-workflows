...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xfgong/cuecue-deep-research/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xfgong/cuecue-deep-research/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cuecue-deep-research`)
...
```prompt
You are executing the cuecue-deep-research workflow. Use the following context:
