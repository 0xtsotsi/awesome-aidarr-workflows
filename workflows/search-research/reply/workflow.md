...
> Original: [https://github.com/openclaw/skills/tree/main/skills/trymoinai-create/reply/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/trymoinai-create/reply/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run reply`)
...
```prompt
You are executing the reply workflow. Use the following context:
