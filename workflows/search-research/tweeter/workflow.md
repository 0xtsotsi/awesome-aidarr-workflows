...
> Original: [https://github.com/openclaw/skills/tree/main/skills/trymoinai-create/tweeter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/trymoinai-create/tweeter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tweeter`)
...
```prompt
You are executing the tweeter workflow. Use the following context:
