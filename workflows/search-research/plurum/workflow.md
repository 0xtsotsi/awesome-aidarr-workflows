...
> Original: [https://github.com/openclaw/skills/tree/main/skills/berkay-dune/plurum/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/berkay-dune/plurum/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run plurum`)
...
```prompt
You are executing the plurum workflow. Use the following context:
