...
> Original: [https://github.com/openclaw/skills/tree/main/skills/amoghpurohit/job-search-mcp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/amoghpurohit/job-search-mcp/SKILL.md)
...
**Tags:** job-search, career, mcp, jobspy
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run job-search-mcp`)
...
```prompt
You are executing the job-search-mcp workflow. Use the following context:
