...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gzlicanyi/imap-smtp-email/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gzlicanyi/imap-smtp-email/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run imap-smtp-email`)
...
```prompt
You are executing the imap-smtp-email workflow. Use the following context:
