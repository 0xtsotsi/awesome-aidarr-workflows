...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jk-0001/competitive-analysis/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jk-0001/competitive-analysis/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run competitive-analysis`)
...
```prompt
You are executing the competitive-analysis workflow. Use the following context:
