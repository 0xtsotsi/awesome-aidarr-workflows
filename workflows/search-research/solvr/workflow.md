...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fcavalcantirj/solvr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fcavalcantirj/solvr/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run solvr`)
...
```prompt
You are executing the solvr workflow. Use the following context:
