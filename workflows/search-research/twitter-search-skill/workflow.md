...
> Original: [https://github.com/openclaw/skills/tree/main/skills/flyfoxci/twitter-search-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/flyfoxci/twitter-search-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run twitter-search-skill`)
...
```prompt
You are executing the twitter-search-skill workflow. Use the following context:
