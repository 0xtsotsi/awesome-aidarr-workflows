...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ttboy/gorger/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ttboy/gorger/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gorger`)
...
```prompt
You are executing the gorger workflow. Use the following context:
