...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ide-rea/deepresearch-conversation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ide-rea/deepresearch-conversation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run deepresearch-conversation`)
...
```prompt
You are executing the deepresearch-conversation workflow. Use the following context:
