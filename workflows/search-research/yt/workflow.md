...
> Original: [https://github.com/openclaw/skills/tree/main/skills/therohitdas/yt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/therohitdas/yt/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run yt`)
...
```prompt
You are executing the yt workflow. Use the following context:
