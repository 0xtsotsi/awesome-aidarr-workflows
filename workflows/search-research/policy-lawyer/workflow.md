...
> Original: [https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/policy-lawyer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/policy-lawyer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run policy-lawyer`)
...
```prompt
You are executing the policy-lawyer workflow. Use the following context:
