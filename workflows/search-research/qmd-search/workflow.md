...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bheemreddy181/qmd-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bheemreddy181/qmd-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run qmd-search`)
...
```prompt
You are executing the qmd-search workflow. Use the following context:
