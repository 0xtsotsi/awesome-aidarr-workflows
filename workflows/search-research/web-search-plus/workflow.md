...
> Original: [https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/web-search-plus/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/web-search-plus/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run web-search-plus`)
...
```prompt
You are executing the web-search-plus workflow. Use the following context:
