...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rafay0313/tt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rafay0313/tt/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tt`)
...
```prompt
You are executing the tt workflow. Use the following context:
