...
> Original: [https://github.com/openclaw/skills/tree/main/skills/metehan777/growth-marketer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/metehan777/growth-marketer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run growth-marketer`)
...
```prompt
You are executing the growth-marketer workflow. Use the following context:
