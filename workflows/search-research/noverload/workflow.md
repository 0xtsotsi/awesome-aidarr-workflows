...
> Original: [https://github.com/openclaw/skills/tree/main/skills/drewautomates/noverload/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/drewautomates/noverload/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run noverload`)
...
```prompt
You are executing the noverload workflow. Use the following context:
