...
> Original: [https://github.com/openclaw/skills/tree/main/skills/guogang1024/research-engine/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/guogang1024/research-engine/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run research-engine`)
...
```prompt
You are executing the research-engine workflow. Use the following context:
