...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nkapila6/local-rag-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nkapila6/local-rag-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run local-rag-search`)
...
```prompt
You are executing the local-rag-search workflow. Use the following context:
