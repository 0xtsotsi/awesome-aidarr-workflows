...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tvdofficial/sportsbet-advisor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tvdofficial/sportsbet-advisor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sportsbet-advisor`)
...
```prompt
You are executing the sportsbet-advisor workflow. Use the following context:
