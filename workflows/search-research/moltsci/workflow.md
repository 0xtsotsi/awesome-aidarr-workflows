...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dowingard/moltsci/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dowingard/moltsci/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltsci`)
...
```prompt
You are executing the moltsci workflow. Use the following context:
