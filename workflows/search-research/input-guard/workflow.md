...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dgriffin831/input-guard/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dgriffin831/input-guard/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run input-guard`)
...
```prompt
You are executing the input-guard workflow. Use the following context:
