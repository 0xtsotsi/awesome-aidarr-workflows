...
> Original: [https://github.com/openclaw/skills/tree/main/skills/marmikcfc/memory-manager/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/marmikcfc/memory-manager/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run memory-manager`)
...
```prompt
You are executing the memory-manager workflow. Use the following context:
