...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bguidolim/omnisearch/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bguidolim/omnisearch/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run omnisearch`)
...
```prompt
You are executing the omnisearch workflow. Use the following context:
