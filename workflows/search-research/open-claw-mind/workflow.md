...
> Original: [https://github.com/openclaw/skills/tree/main/skills/teylersf/open-claw-mind/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/teylersf/open-claw-mind/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run open-claw-mind`)
...
```prompt
You are executing the open-claw-mind workflow. Use the following context:
