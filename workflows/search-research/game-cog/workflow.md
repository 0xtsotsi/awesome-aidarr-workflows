...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/game-cog/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/game-cog/SKILL.md)
...
Other tools generate sprites. CellCog builds game worlds. #1 on DeepResearch Bench (Feb 2026) for deep game design reasoning — character-consistent art, sprites, tilesets, music, UI, 3D models, GDDs, level design, and game prototypes, all cohesive across every asset.
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run game-cog`)
...
```prompt
You are executing the game-cog workflow. Use the following context:
