...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cyberengage/research-skill-copy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cyberengage/research-skill-copy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run research-skill-copy`)
...
```prompt
You are executing the research-skill-copy workflow. Use the following context:
