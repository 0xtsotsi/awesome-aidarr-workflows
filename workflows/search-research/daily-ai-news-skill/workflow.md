...
> Original: [https://github.com/openclaw/skills/tree/main/skills/laurent-zhu/daily-ai-news-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/laurent-zhu/daily-ai-news-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run daily-ai-news-skill`)
...
```prompt
You are executing the daily-ai-news-skill workflow. Use the following context:
