...
> Original: [https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-data/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-data/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-data`)
...
```prompt
You are executing the youtube-data workflow. Use the following context:
