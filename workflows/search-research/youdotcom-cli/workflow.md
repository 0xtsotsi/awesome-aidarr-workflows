...
> Original: [https://github.com/openclaw/skills/tree/main/skills/edwardirby/youdotcom-cli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/edwardirby/youdotcom-cli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youdotcom-cli`)
...
```prompt
You are executing the youdotcom-cli workflow. Use the following context:
