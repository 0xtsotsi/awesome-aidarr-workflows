...
> Original: [https://github.com/openclaw/skills/tree/main/skills/iahmadzain/youtrack/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/iahmadzain/youtrack/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtrack`)
...
```prompt
You are executing the youtrack workflow. Use the following context:
