...
> Original: [https://github.com/openclaw/skills/tree/main/skills/firestream792/coindeskfeedagent-teneo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/firestream792/coindeskfeedagent-teneo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run coindeskfeedagent-teneo`)
...
```prompt
You are executing the coindeskfeedagent-teneo workflow. Use the following context:
