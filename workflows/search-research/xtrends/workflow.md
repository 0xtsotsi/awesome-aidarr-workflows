...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jordanprater/xtrends/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jordanprater/xtrends/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run xtrends`)
...
```prompt
You are executing the xtrends workflow. Use the following context:
