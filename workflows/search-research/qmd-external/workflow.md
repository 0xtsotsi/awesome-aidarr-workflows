...
> Original: [https://github.com/openclaw/skills/tree/main/skills/levineam/qmd-external/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/levineam/qmd-external/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run qmd-external`)
...
```prompt
You are executing the qmd-external workflow. Use the following context:
