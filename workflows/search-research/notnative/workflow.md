...
> Original: [https://github.com/openclaw/skills/tree/main/skills/k4ditano/notnative/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/k4ditano/notnative/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run notnative`)
...
```prompt
You are executing the notnative workflow. Use the following context:
