...
> Original: [https://github.com/openclaw/skills/tree/main/skills/relayintel/relay-for-telegram/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/relayintel/relay-for-telegram/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run relay-for-telegram`)
...
```prompt
You are executing the relay-for-telegram workflow. Use the following context:
