...
> Original: [https://github.com/openclaw/skills/tree/main/skills/trymoinai-create/x/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/trymoinai-create/x/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x`)
...
```prompt
You are executing the x workflow. Use the following context:
