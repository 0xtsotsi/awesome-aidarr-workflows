...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/skill-search-optimizer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/skill-search-optimizer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-search-optimizer`)
...
```prompt
You are executing the skill-search-optimizer workflow. Use the following context:
