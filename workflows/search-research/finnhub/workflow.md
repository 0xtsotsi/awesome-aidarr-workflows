...
> Original: [https://github.com/openclaw/skills/tree/main/skills/matthewxfz3/finnhub/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/matthewxfz3/finnhub/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run finnhub`)
...
```prompt
You are executing the finnhub workflow. Use the following context:
