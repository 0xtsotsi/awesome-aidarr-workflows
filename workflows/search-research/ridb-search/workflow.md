...
> Original: [https://github.com/openclaw/skills/tree/main/skills/seanrea/ridb-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/seanrea/ridb-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ridb-search`)
...
```prompt
You are executing the ridb-search workflow. Use the following context:
