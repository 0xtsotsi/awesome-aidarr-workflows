...
> Original: [https://github.com/openclaw/skills/tree/main/skills/poi5305/creatordb-youtube-v3/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/poi5305/creatordb-youtube-v3/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run creatordb-youtube-v3`)
...
```prompt
You are executing the creatordb-youtube-v3 workflow. Use the following context:
