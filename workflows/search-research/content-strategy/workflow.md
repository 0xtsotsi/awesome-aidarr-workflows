...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jk-0001/content-strategy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jk-0001/content-strategy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run content-strategy`)
...
```prompt
You are executing the content-strategy workflow. Use the following context:
