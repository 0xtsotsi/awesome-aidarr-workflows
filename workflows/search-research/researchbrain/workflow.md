...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lraivisto/researchbrain/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lraivisto/researchbrain/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run researchbrain`)
...
```prompt
You are executing the researchbrain workflow. Use the following context:
