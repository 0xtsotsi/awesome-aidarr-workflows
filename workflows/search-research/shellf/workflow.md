...
> Original: [https://github.com/openclaw/skills/tree/main/skills/andrewleonardi/shellf/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/andrewleonardi/shellf/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run shellf`)
...
```prompt
You are executing the shellf workflow. Use the following context:
