...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leegitw/patent-validator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leegitw/patent-validator/SKILL.md)
...
**Tags:** patent-validator, search-strategy, prior-art-research, intellectual-property, concept-validation, research-tools
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run patent-validator`)
...
```prompt
You are executing the patent-validator workflow. Use the following context:
