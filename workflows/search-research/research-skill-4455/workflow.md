...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cyberengage/research-skill-4455/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cyberengage/research-skill-4455/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run research-skill-4455`)
...
```prompt
You are executing the research-skill-4455 workflow. Use the following context:
