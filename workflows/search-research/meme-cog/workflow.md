...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/meme-cog/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/meme-cog/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run meme-cog`)
...
```prompt
You are executing the meme-cog workflow. Use the following context:
