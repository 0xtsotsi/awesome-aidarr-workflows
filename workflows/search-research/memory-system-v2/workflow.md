...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kellyclaudeai/memory-system-v2/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kellyclaudeai/memory-system-v2/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run memory-system-v2`)
...
```prompt
You are executing the memory-system-v2 workflow. Use the following context:
