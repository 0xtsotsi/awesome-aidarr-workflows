...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lekt9/foundry/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lekt9/foundry/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run foundry`)
...
```prompt
You are executing the foundry workflow. Use the following context:
