...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kantorcodes/registry-broker-hashnet-openclaw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kantorcodes/registry-broker-hashnet-openclaw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run registry-broker-hashnet-openclaw`)
...
```prompt
You are executing the registry-broker-hashnet-openclaw workflow. Use the following context:
