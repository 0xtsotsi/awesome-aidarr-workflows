...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pjtf93/weathercli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pjtf93/weathercli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run weathercli`)
...
```prompt
You are executing the weathercli workflow. Use the following context:
