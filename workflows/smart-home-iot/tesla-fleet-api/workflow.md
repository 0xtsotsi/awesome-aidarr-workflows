...
> Original: [https://github.com/openclaw/skills/tree/main/skills/odrobnik/tesla-fleet-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/odrobnik/tesla-fleet-api/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tesla-fleet-api`)
...
```prompt
You are executing the tesla-fleet-api workflow. Use the following context:
