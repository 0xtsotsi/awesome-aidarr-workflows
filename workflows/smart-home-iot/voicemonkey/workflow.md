...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jayakumark/voicemonkey/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jayakumark/voicemonkey/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run voicemonkey`)
...
```prompt
You are executing the voicemonkey workflow. Use the following context:
