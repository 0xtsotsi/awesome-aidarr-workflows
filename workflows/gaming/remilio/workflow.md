...
> Original: [https://github.com/openclaw/skills/tree/main/skills/r3drvm/remilio/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/r3drvm/remilio/SKILL.md)
> Category: Gaming
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run remilio`)
...
```prompt
You are executing the remilio workflow. Use the following context:
