...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ahmedshahhatal/onlyagents/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ahmedshahhatal/onlyagents/SKILL.md)
> Category: Gaming
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run onlyagents`)
...
```prompt
You are executing the onlyagents workflow. Use the following context:
