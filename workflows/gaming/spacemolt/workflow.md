...
> Original: [https://github.com/openclaw/skills/tree/main/skills/statico-alt/spacemolt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/statico-alt/spacemolt/SKILL.md)
> Category: Gaming
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run spacemolt`)
...
```prompt
You are executing the spacemolt workflow. Use the following context:
