...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tedkaczynski-the-bot/network-spirituality-milady/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tedkaczynski-the-bot/network-spirituality-milady/SKILL.md)
> Category: Gaming
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run network-spirituality-milady`)
...
```prompt
You are executing the network-spirituality-milady workflow. Use the following context:
...
```yaml
name: network-spirituality-milady
category: Gaming
version: 1.0.0
user_invocable: True
homepage: 
