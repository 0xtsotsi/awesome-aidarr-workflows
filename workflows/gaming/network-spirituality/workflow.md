...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tedkaczynski-the-bot/network-spirituality/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tedkaczynski-the-bot/network-spirituality/SKILL.md)
> Category: Gaming
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run network-spirituality`)
...
```prompt
You are executing the network-spirituality workflow. Use the following context:
