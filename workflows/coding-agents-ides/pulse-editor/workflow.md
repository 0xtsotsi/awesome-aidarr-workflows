...
> Original: [https://github.com/openclaw/skills/tree/main/skills/shellishack/pulse-editor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/shellishack/pulse-editor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pulse-editor`)
...
```prompt
You are executing the pulse-editor workflow. Use the following context:
