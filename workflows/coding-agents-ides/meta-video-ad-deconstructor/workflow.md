...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fortytwode/meta-video-ad-deconstructor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fortytwode/meta-video-ad-deconstructor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run meta-video-ad-deconstructor`)
...
```prompt
You are executing the meta-video-ad-deconstructor workflow. Use the following context:
