...
> Original: [https://github.com/openclaw/skills/tree/main/skills/henrino3/ec-task-orchestrator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/henrino3/ec-task-orchestrator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ec-task-orchestrator`)
...
```prompt
You are executing the ec-task-orchestrator workflow. Use the following context:
