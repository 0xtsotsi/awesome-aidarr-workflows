...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kesslerio/multi-coding-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kesslerio/multi-coding-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run multi-coding-agent`)
...
```prompt
You are executing the multi-coding-agent workflow. Use the following context:
