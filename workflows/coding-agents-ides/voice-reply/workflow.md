...
> Original: [https://github.com/openclaw/skills/tree/main/skills/stolot0mt0m/voice-reply/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/stolot0mt0m/voice-reply/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run voice-reply`)
...
```prompt
You are executing the voice-reply workflow. Use the following context:
