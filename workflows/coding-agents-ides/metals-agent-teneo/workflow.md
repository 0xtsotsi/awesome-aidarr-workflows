...
> Original: [https://github.com/openclaw/skills/tree/main/skills/firestream792/metals-agent-teneo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/firestream792/metals-agent-teneo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run metals-agent-teneo`)
...
```prompt
You are executing the metals-agent-teneo workflow. Use the following context:
