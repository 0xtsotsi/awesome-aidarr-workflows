...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jasonfdg/bidclub-ai/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jasonfdg/bidclub-ai/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run bidclub-ai`)
...
```prompt
You are executing the bidclub-ai workflow. Use the following context:
