...
> Original: [https://github.com/openclaw/skills/tree/main/skills/datadrivenconstruction/budget-variance-analyzer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/datadrivenconstruction/budget-variance-analyzer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run budget-variance-analyzer`)
...
```prompt
You are executing the budget-variance-analyzer workflow. Use the following context:
