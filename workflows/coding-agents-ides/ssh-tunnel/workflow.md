...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/ssh-tunnel/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/ssh-tunnel/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ssh-tunnel`)
...
```prompt
You are executing the ssh-tunnel workflow. Use the following context:
