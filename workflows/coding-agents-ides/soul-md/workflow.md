...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aaronjmars/soul-md/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aaronjmars/soul-md/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run soul-md`)
...
```prompt
You are executing the soul-md workflow. Use the following context:
