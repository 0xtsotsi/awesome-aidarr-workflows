...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mrbeandev/file-links-tool/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mrbeandev/file-links-tool/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run file-links-tool`)
...
```prompt
You are executing the file-links-tool workflow. Use the following context:
