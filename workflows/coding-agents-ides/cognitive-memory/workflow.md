...
> Original: [https://github.com/openclaw/skills/tree/main/skills/icemilo414/cognitive-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/icemilo414/cognitive-memory/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cognitive-memory`)
...
```prompt
You are executing the cognitive-memory workflow. Use the following context:
