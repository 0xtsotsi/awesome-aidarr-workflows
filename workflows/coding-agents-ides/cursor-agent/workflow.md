...
> Original: [https://github.com/openclaw/skills/tree/main/skills/swiftlysingh/cursor-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/swiftlysingh/cursor-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cursor-agent`)
...
```prompt
You are executing the cursor-agent workflow. Use the following context:
