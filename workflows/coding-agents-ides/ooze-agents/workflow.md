...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jschwerberg/ooze-agents/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jschwerberg/ooze-agents/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ooze-agents`)
...
```prompt
You are executing the ooze-agents workflow. Use the following context:
