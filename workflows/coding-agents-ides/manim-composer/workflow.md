...
> Original: [https://github.com/openclaw/skills/tree/main/skills/inclinedadarsh/manim-composer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/inclinedadarsh/manim-composer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run manim-composer`)
...
```prompt
You are executing the manim-composer workflow. Use the following context:
