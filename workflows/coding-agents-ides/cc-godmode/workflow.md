...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cubetribe/cc-godmode/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cubetribe/cc-godmode/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cc-godmode`)
...
```prompt
You are executing the cc-godmode workflow. Use the following context:
