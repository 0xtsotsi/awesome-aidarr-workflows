...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tairov/pasteclaw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tairov/pasteclaw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pasteclaw`)
...
```prompt
You are executing the pasteclaw workflow. Use the following context:
