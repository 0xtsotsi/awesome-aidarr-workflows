...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zsvedic/gembox-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zsvedic/gembox-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gembox-skill`)
...
```prompt
You are executing the gembox-skill workflow. Use the following context:
