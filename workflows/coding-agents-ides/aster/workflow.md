...
> Original: [https://github.com/openclaw/skills/tree/main/skills/satyajiit/aster/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/satyajiit/aster/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run aster`)
...
```prompt
You are executing the aster workflow. Use the following context:
