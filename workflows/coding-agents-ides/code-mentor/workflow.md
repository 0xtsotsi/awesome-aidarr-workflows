...
> Original: [https://github.com/openclaw/skills/tree/main/skills/samuelkahessay/code-mentor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/samuelkahessay/code-mentor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run code-mentor`)
...
```prompt
You are executing the code-mentor workflow. Use the following context:
