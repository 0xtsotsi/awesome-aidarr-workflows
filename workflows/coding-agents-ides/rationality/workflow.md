...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xertrov/rationality/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xertrov/rationality/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run rationality`)
...
```prompt
You are executing the rationality workflow. Use the following context:
