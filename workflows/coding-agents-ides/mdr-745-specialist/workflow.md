...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/mdr-745-specialist/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/mdr-745-specialist/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mdr-745-specialist`)
...
```prompt
You are executing the mdr-745-specialist workflow. Use the following context:
