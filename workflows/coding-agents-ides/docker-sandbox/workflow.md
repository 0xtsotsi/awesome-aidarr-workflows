...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/docker-sandbox/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/docker-sandbox/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run docker-sandbox`)
...
```prompt
You are executing the docker-sandbox workflow. Use the following context:
