...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fsa317/bot-bowl-party/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fsa317/bot-bowl-party/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run bot-bowl-party`)
...
```prompt
You are executing the bot-bowl-party workflow. Use the following context:
