...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leegitw/essence-distiller/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leegitw/essence-distiller/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run essence-distiller`)
...
```prompt
You are executing the essence-distiller workflow. Use the following context:
