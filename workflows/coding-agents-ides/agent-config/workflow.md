...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thatguysizemore/agent-config/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thatguysizemore/agent-config/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run agent-config`)
...
```prompt
You are executing the agent-config workflow. Use the following context:
