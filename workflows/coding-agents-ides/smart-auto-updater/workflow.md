...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ruiwang20010702/smart-auto-updater/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ruiwang20010702/smart-auto-updater/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run smart-auto-updater`)
...
```prompt
You are executing the smart-auto-updater workflow. Use the following context:
