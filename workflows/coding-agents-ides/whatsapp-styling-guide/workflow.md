...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rubenfb23/whatsapp-styling-guide/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rubenfb23/whatsapp-styling-guide/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run whatsapp-styling-guide`)
...
```prompt
You are executing the whatsapp-styling-guide workflow. Use the following context:
