...
> Original: [https://github.com/openclaw/skills/tree/main/skills/otherpowers/skill-content-id-guide/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/otherpowers/skill-content-id-guide/SKILL.md)
...
Procedural clarity and evidence organization for creators managing automated content claims across platforms. A clear view of what’s happening, without telling Creators what to do.
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-content-id-guide`)
...
```prompt
You are executing the skill-content-id-guide workflow. Use the following context:
