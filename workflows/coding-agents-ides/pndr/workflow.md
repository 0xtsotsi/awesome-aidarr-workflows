...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dgershman/pndr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dgershman/pndr/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pndr`)
...
```prompt
You are executing the pndr workflow. Use the following context:
