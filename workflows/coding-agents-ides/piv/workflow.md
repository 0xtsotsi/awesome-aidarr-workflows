...
> Original: [https://github.com/openclaw/skills/tree/main/skills/smokealot420/piv/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/smokealot420/piv/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run piv`)
...
```prompt
You are executing the piv workflow. Use the following context:
