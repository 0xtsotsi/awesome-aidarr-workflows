...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jalehman/claude-team/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jalehman/claude-team/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run claude-team`)
...
```prompt
You are executing the claude-team workflow. Use the following context:
