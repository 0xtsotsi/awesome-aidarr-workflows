...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bramdo/quantumlab/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bramdo/quantumlab/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run quantumlab`)
...
```prompt
You are executing the quantumlab workflow. Use the following context:
