...
> Original: [https://github.com/openclaw/skills/tree/main/skills/henrino3/ec-excalidraw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/henrino3/ec-excalidraw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ec-excalidraw`)
...
```prompt
You are executing the ec-excalidraw workflow. Use the following context:
