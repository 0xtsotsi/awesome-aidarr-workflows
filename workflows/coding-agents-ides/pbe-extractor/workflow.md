...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leegitw/pbe-extractor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leegitw/pbe-extractor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pbe-extractor`)
...
```prompt
You are executing the pbe-extractor workflow. Use the following context:
