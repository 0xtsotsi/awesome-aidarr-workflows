...
> Original: [https://github.com/openclaw/skills/tree/main/skills/seanphan/mcp-builder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/seanphan/mcp-builder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mcp-builder`)
...
```prompt
You are executing the mcp-builder workflow. Use the following context:
