...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aisapay/aisa-twitter-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aisapay/aisa-twitter-api/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run aisa-twitter-api`)
...
```prompt
You are executing the aisa-twitter-api workflow. Use the following context:
