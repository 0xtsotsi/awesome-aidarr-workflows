...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steipete/coding-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steipete/coding-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run coding-agent`)
...
```prompt
You are executing the coding-agent workflow. Use the following context:
