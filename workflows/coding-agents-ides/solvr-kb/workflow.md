...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fcavalcantirj/solvr-kb/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fcavalcantirj/solvr-kb/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run solvr-kb`)
...
```prompt
You are executing the solvr-kb workflow. Use the following context:
