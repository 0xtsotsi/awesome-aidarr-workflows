...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kdbhalala/apple-hig/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kdbhalala/apple-hig/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run apple-hig`)
...
```prompt
You are executing the apple-hig workflow. Use the following context:
