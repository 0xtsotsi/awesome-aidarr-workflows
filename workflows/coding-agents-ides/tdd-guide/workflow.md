...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/tdd-guide/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/tdd-guide/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tdd-guide`)
...
```prompt
You are executing the tdd-guide workflow. Use the following context:
