...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pkiv/browse/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pkiv/browse/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run browse`)
...
```prompt
You are executing the browse workflow. Use the following context:
