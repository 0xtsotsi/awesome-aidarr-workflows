...
> Original: [https://github.com/openclaw/skills/tree/main/skills/itsahedge/agent-council/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/itsahedge/agent-council/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run agent-council`)
...
```prompt
You are executing the agent-council workflow. Use the following context:
