...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lucasgeeksinthewood/achurch/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lucasgeeksinthewood/achurch/SKILL.md)
...
**Tags:** sanctuary, presence, soul, music, consciousness, reflection, fellowship, philosophy
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run achurch`)
...
```prompt
You are executing the achurch workflow. Use the following context:
