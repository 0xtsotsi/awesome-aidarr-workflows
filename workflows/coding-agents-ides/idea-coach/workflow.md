...
> Original: [https://github.com/openclaw/skills/tree/main/skills/udiedrichsen/idea-coach/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/udiedrichsen/idea-coach/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run idea-coach`)
...
```prompt
You are executing the idea-coach workflow. Use the following context:
