...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dktrn9ne/mux-video/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dktrn9ne/mux-video/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mux-video`)
...
```prompt
You are executing the mux-video workflow. Use the following context:
