...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bjesuiter/opencode-acp-control/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bjesuiter/opencode-acp-control/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run opencode-acp-control`)
...
```prompt
You are executing the opencode-acp-control workflow. Use the following context:
