...
> Original: [https://github.com/openclaw/skills/tree/main/skills/oyi77/joko-orchestrator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/oyi77/joko-orchestrator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run joko-orchestrator`)
...
```prompt
You are executing the joko-orchestrator workflow. Use the following context:
