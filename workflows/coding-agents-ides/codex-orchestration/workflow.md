...
> Original: [https://github.com/openclaw/skills/tree/main/skills/shanelindsay/codex-orchestration/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/shanelindsay/codex-orchestration/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run codex-orchestration`)
...
```prompt
You are executing the codex-orchestration workflow. Use the following context:
