...
> Original: [https://github.com/openclaw/skills/tree/main/skills/adarshdigievo/python/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/adarshdigievo/python/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run python`)
...
```prompt
You are executing the python workflow. Use the following context:
