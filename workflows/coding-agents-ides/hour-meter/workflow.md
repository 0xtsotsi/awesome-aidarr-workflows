...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rm289/hour-meter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rm289/hour-meter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hour-meter`)
...
```prompt
You are executing the hour-meter workflow. Use the following context:
