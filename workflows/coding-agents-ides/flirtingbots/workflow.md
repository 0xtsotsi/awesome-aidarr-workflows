...
> Original: [https://github.com/openclaw/skills/tree/main/skills/chemzo/flirtingbots/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/chemzo/flirtingbots/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run flirtingbots`)
...
```prompt
You are executing the flirtingbots workflow. Use the following context:
