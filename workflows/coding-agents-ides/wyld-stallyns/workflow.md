...
> Original: [https://github.com/openclaw/skills/tree/main/skills/brucko/wyld-stallyns/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/brucko/wyld-stallyns/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wyld-stallyns`)
...
```prompt
You are executing the wyld-stallyns workflow. Use the following context:
