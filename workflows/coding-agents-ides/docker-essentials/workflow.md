...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arnarsson/docker-essentials/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arnarsson/docker-essentials/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run docker-essentials`)
...
```prompt
You are executing the docker-essentials workflow. Use the following context:
