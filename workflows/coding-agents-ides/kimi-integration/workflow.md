...
> Original: [https://github.com/openclaw/skills/tree/main/skills/evgyur/kimi-integration/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/evgyur/kimi-integration/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kimi-integration`)
...
```prompt
You are executing the kimi-integration workflow. Use the following context:
