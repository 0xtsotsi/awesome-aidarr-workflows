...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/cto-advisor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/cto-advisor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cto-advisor`)
...
```prompt
You are executing the cto-advisor workflow. Use the following context:
