...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jacklandrin/only-baby-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jacklandrin/only-baby-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run only-baby-skill`)
...
```prompt
You are executing the only-baby-skill workflow. Use the following context:
