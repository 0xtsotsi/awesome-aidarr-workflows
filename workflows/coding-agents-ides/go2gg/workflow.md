...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rakesh1002/go2gg/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rakesh1002/go2gg/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run go2gg`)
...
```prompt
You are executing the go2gg workflow. Use the following context:
