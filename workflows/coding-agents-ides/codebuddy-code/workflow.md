...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pmwalkercao/codebuddy-code/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pmwalkercao/codebuddy-code/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run codebuddy-code`)
...
```prompt
You are executing the codebuddy-code workflow. Use the following context:
