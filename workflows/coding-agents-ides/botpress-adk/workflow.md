...
> Original: [https://github.com/openclaw/skills/tree/main/skills/yueranlu/botpress-adk/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/yueranlu/botpress-adk/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run botpress-adk`)
...
```prompt
You are executing the botpress-adk workflow. Use the following context:
