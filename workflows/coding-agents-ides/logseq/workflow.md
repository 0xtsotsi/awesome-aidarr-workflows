...
> Original: [https://github.com/openclaw/skills/tree/main/skills/juanirm/logseq/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/juanirm/logseq/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run logseq`)
...
```prompt
You are executing the logseq workflow. Use the following context:
