...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jcorrego/openspec/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jcorrego/openspec/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openspec`)
...
```prompt
You are executing the openspec workflow. Use the following context:
