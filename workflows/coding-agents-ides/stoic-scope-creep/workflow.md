...
> Original: [https://github.com/openclaw/skills/tree/main/skills/crtahlin/stoic-scope-creep/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/crtahlin/stoic-scope-creep/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run stoic-scope-creep`)
...
```prompt
You are executing the stoic-scope-creep workflow. Use the following context:
