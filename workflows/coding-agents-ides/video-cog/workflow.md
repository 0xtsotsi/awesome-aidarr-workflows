...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/video-cog/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/video-cog/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run video-cog`)
...
```prompt
You are executing the video-cog workflow. Use the following context:
