...
> Original: [https://github.com/openclaw/skills/tree/main/skills/killerapp/vhs-recorder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/killerapp/vhs-recorder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vhs-recorder`)
...
```prompt
You are executing the vhs-recorder workflow. Use the following context:
