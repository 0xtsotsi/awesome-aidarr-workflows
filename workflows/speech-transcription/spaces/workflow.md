...
> Original: [https://github.com/openclaw/skills/tree/main/skills/logesh2496/spaces/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/logesh2496/spaces/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run spaces`)
...
```prompt
You are executing the spaces workflow. Use the following context:
