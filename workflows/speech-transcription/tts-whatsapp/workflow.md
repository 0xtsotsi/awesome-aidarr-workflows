...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hopyky/tts-whatsapp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hopyky/tts-whatsapp/SKILL.md)
...
**Tags:** whatsapp, tts, voice, messaging, multilingual, audio
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tts-whatsapp`)
...
```prompt
You are executing the tts-whatsapp workflow. Use the following context:
