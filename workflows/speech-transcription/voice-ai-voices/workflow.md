...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gizmogremlin/voice-ai-voices/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gizmogremlin/voice-ai-voices/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run voice-ai-voices`)
...
```prompt
You are executing the voice-ai-voices workflow. Use the following context:
