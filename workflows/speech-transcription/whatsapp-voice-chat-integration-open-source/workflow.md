...
> Original: [https://github.com/openclaw/skills/tree/main/skills/syedateebulislam/whatsapp-voice-chat-integration-open-source/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/syedateebulislam/whatsapp-voice-chat-integration-open-source/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run whatsapp-voice-chat-integration-open-source`)
...
```prompt
You are executing the whatsapp-voice-chat-integration-open-source workflow. Use the following context:
