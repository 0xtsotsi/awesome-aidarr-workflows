...
> Original: [https://github.com/openclaw/skills/tree/main/skills/georgi/nodetool/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/georgi/nodetool/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nodetool`)
...
```prompt
You are executing the nodetool workflow. Use the following context:
