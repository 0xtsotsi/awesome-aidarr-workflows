...
> Original: [https://github.com/openclaw/skills/tree/main/skills/senthazalravi/vibetesting/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/senthazalravi/vibetesting/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vibetesting`)
...
```prompt
You are executing the vibetesting workflow. Use the following context:
