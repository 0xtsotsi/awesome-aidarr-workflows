...
> Original: [https://github.com/openclaw/skills/tree/main/skills/codedao12/wordpress/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/codedao12/wordpress/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wordpress`)
...
```prompt
You are executing the wordpress workflow. Use the following context:
