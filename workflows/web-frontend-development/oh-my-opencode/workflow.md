...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mcoso/oh-my-opencode/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mcoso/oh-my-opencode/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run oh-my-opencode`)
...
```prompt
You are executing the oh-my-opencode workflow. Use the following context:
