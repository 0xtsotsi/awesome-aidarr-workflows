...
> Original: [https://github.com/openclaw/skills/tree/main/skills/amruthpillai/resume-builder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/amruthpillai/resume-builder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run resume-builder`)
...
```prompt
You are executing the resume-builder workflow. Use the following context:
