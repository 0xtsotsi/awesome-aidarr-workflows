...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/ux-researcher-designer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/ux-researcher-designer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ux-researcher-designer`)
...
```prompt
You are executing the ux-researcher-designer workflow. Use the following context:
