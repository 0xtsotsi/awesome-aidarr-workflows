...
> Original: [https://github.com/openclaw/skills/tree/main/skills/g0head/kicad-pcb/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/g0head/kicad-pcb/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kicad-pcb`)
...
```prompt
You are executing the kicad-pcb workflow. Use the following context:
