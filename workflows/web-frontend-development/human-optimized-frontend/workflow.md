...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vishnubedi3/human-optimized-frontend/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vishnubedi3/human-optimized-frontend/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run human-optimized-frontend`)
...
```prompt
You are executing the human-optimized-frontend workflow. Use the following context:
