...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ubyjerome/instantdb/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ubyjerome/instantdb/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run instantdb`)
...
```prompt
You are executing the instantdb workflow. Use the following context:
