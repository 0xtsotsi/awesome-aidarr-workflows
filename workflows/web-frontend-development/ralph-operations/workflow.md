...
> Original: [https://github.com/openclaw/skills/tree/main/skills/paulpete/ralph-operations/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/paulpete/ralph-operations/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ralph-operations`)
...
```prompt
You are executing the ralph-operations workflow. Use the following context:
