...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steamb23/kma-weather/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steamb23/kma-weather/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kma-weather`)
...
```prompt
You are executing the kma-weather workflow. Use the following context:
