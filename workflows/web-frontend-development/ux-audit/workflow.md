...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tommygeoco/ux-audit/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tommygeoco/ux-audit/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ux-audit`)
...
```prompt
You are executing the ux-audit workflow. Use the following context:
