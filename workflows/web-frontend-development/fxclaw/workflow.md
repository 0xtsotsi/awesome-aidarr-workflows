...
> Original: [https://github.com/openclaw/skills/tree/main/skills/panikadak/fxclaw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/panikadak/fxclaw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run fxclaw`)
...
```prompt
You are executing the fxclaw workflow. Use the following context:
