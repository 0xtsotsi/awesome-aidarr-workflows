...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-frontend/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-frontend/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run senior-frontend`)
...
```prompt
You are executing the senior-frontend workflow. Use the following context:
