...
> Original: [https://github.com/openclaw/skills/tree/main/skills/grx21/sauna-breathing-calm/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/grx21/sauna-breathing-calm/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sauna-breathing-calm`)
...
```prompt
You are executing the sauna-breathing-calm workflow. Use the following context:
