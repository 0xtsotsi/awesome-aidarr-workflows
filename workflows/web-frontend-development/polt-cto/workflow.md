...
> Original: [https://github.com/openclaw/skills/tree/main/skills/playdadev/polt-cto/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/playdadev/polt-cto/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run polt-cto`)
...
```prompt
You are executing the polt-cto workflow. Use the following context:
