...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gchapim/phoenix-api-gen/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gchapim/phoenix-api-gen/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run phoenix-api-gen`)
...
```prompt
You are executing the phoenix-api-gen workflow. Use the following context:
