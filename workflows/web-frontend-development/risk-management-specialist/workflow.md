...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/risk-management-specialist/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/risk-management-specialist/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run risk-management-specialist`)
...
```prompt
You are executing the risk-management-specialist workflow. Use the following context:
