...
> Original: [https://github.com/openclaw/skills/tree/main/skills/peetzweg/trmnl/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/peetzweg/trmnl/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run trmnl`)
...
```prompt
You are executing the trmnl workflow. Use the following context:
