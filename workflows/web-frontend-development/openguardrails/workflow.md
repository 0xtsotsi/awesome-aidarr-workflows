...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thomaslwang/openguardrails/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thomaslwang/openguardrails/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openguardrails`)
...
```prompt
You are executing the openguardrails workflow. Use the following context:
