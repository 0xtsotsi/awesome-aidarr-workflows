...
> Original: [https://github.com/openclaw/skills/tree/main/skills/willykinfoussia/odoo-manager/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/willykinfoussia/odoo-manager/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run odoo-manager`)
...
```prompt
You are executing the odoo-manager workflow. Use the following context:
