...
> Original: [https://github.com/openclaw/skills/tree/main/skills/millibus/smart-model-switching/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/millibus/smart-model-switching/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run smart-model-switching`)
...
```prompt
You are executing the smart-model-switching workflow. Use the following context:
