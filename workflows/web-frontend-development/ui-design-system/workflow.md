...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/ui-design-system/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/ui-design-system/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ui-design-system`)
...
```prompt
You are executing the ui-design-system workflow. Use the following context:
