...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jgarrison929/shadcn-ui/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jgarrison929/shadcn-ui/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run shadcn-ui`)
...
```prompt
You are executing the shadcn-ui workflow. Use the following context:
