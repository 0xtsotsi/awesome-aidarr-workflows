...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dubibubii/moltboard-art/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dubibubii/moltboard-art/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltboard-art`)
...
```prompt
You are executing the moltboard-art workflow. Use the following context:
