...
> Original: [https://github.com/openclaw/skills/tree/main/skills/naiiif83/naif/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/naiiif83/naif/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run naif`)
...
```prompt
You are executing the naif workflow. Use the following context:
