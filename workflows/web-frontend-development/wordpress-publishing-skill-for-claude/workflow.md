...
> Original: [https://github.com/openclaw/skills/tree/main/skills/asif2bd/wordpress-publishing-skill-for-claude/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/asif2bd/wordpress-publishing-skill-for-claude/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wordpress-publishing-skill-for-claude`)
...
```prompt
You are executing the wordpress-publishing-skill-for-claude workflow. Use the following context:
...
```yaml
name: wordpress-publishing-skill-for-claude
category: Web & Frontend Development
version: 1.0.0
user_invocable: True
homepage: 
