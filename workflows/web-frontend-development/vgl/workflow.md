...
> Original: [https://github.com/openclaw/skills/tree/main/skills/galbria/vgl/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/galbria/vgl/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vgl`)
...
```prompt
You are executing the vgl workflow. Use the following context:
