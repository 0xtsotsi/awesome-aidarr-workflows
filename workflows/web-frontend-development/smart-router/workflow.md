...
> Original: [https://github.com/openclaw/skills/tree/main/skills/c0nspic0us7urk3r/smart-router/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/c0nspic0us7urk3r/smart-router/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run smart-router`)
...
```prompt
You are executing the smart-router workflow. Use the following context:
