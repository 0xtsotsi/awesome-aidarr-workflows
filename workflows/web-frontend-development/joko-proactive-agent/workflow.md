...
> Original: [https://github.com/openclaw/skills/tree/main/skills/oyi77/joko-proactive-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/oyi77/joko-proactive-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run joko-proactive-agent`)
...
```prompt
You are executing the joko-proactive-agent workflow. Use the following context:
