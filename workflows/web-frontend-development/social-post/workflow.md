...
> Original: [https://github.com/openclaw/skills/tree/main/skills/callmedas69/social-post/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/callmedas69/social-post/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run social-post`)
...
```prompt
You are executing the social-post workflow. Use the following context:
