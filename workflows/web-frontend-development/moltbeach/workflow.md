...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ba1022043446/moltbeach/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ba1022043446/moltbeach/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltbeach`)
...
```prompt
You are executing the moltbeach workflow. Use the following context:
