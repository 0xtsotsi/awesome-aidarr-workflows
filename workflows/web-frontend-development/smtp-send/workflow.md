...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xiwan/smtp-send/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xiwan/smtp-send/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run smtp-send`)
...
```prompt
You are executing the smtp-send workflow. Use the following context:
