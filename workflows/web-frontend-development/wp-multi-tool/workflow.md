...
> Original: [https://github.com/openclaw/skills/tree/main/skills/marcindudekdev/wp-multi-tool/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/marcindudekdev/wp-multi-tool/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wp-multi-tool`)
...
```prompt
You are executing the wp-multi-tool workflow. Use the following context:
