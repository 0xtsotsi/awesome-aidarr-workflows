...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pr1vateer/opensysinfo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pr1vateer/opensysinfo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run opensysinfo`)
...
```prompt
You are executing the opensysinfo workflow. Use the following context:
