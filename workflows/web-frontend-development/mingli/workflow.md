...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hiehoo/mingli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hiehoo/mingli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mingli`)
...
```prompt
You are executing the mingli workflow. Use the following context:
