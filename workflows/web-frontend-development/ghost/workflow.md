...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alphafactor/ghost/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alphafactor/ghost/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ghost`)
...
```prompt
You are executing the ghost workflow. Use the following context:
