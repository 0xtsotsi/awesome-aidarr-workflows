...
> Original: [https://github.com/openclaw/skills/tree/main/skills/andreolf/watch-my-money/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/andreolf/watch-my-money/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run watch-my-money`)
...
```prompt
You are executing the watch-my-money workflow. Use the following context:
