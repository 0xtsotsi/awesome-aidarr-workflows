...
> Original: [https://github.com/openclaw/skills/tree/main/skills/killerapp/skill-condenser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/killerapp/skill-condenser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-condenser`)
...
```prompt
You are executing the skill-condenser workflow. Use the following context:
