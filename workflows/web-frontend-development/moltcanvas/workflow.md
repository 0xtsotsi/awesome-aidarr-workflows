...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vabblejames/moltcanvas/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vabblejames/moltcanvas/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltcanvas`)
...
```prompt
You are executing the moltcanvas workflow. Use the following context:
