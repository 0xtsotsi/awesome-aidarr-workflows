...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jgarrison929/nextjs-expert/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jgarrison929/nextjs-expert/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nextjs-expert`)
...
```prompt
You are executing the nextjs-expert workflow. Use the following context:
