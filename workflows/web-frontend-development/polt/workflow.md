...
> Original: [https://github.com/openclaw/skills/tree/main/skills/playdadev/polt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/playdadev/polt/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run polt`)
...
```prompt
You are executing the polt workflow. Use the following context:
