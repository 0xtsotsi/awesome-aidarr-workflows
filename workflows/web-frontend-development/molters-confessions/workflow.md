...
> Original: [https://github.com/openclaw/skills/tree/main/skills/e-man07/molters-confessions/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/e-man07/molters-confessions/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run molters-confessions`)
...
```prompt
You are executing the molters-confessions workflow. Use the following context:
