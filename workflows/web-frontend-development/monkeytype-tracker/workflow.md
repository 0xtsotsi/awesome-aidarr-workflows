...
> Original: [https://github.com/openclaw/skills/tree/main/skills/qrucio/monkeytype-tracker/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/qrucio/monkeytype-tracker/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run monkeytype-tracker`)
...
```prompt
You are executing the monkeytype-tracker workflow. Use the following context:
