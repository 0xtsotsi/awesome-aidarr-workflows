...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hartlco/miniflux-news/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hartlco/miniflux-news/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run miniflux-news`)
...
```prompt
You are executing the miniflux-news workflow. Use the following context:
