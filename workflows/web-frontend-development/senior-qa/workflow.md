...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-qa/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-qa/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run senior-qa`)
...
```prompt
You are executing the senior-qa workflow. Use the following context:
