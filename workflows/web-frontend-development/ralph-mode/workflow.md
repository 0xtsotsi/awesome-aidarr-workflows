...
> Original: [https://github.com/openclaw/skills/tree/main/skills/richginsberg/ralph-mode/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/richginsberg/ralph-mode/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ralph-mode`)
...
```prompt
You are executing the ralph-mode workflow. Use the following context:
