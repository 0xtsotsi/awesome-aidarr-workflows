...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lakyfx/lovetago-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lakyfx/lovetago-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run lovetago-skill`)
...
```prompt
You are executing the lovetago-skill workflow. Use the following context:
