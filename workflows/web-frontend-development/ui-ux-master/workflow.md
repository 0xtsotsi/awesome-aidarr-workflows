...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kdbhalala/ui-ux-master/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kdbhalala/ui-ux-master/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ui-ux-master`)
...
```prompt
You are executing the ui-ux-master workflow. Use the following context:
