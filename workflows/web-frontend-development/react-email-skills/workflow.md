...
> Original: [https://github.com/openclaw/skills/tree/main/skills/christina-de-martinez/react-email-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/christina-de-martinez/react-email-skills/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run react-email-skills`)
...
```prompt
You are executing the react-email-skills workflow. Use the following context:
