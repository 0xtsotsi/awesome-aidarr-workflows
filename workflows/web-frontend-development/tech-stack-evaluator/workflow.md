...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/tech-stack-evaluator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/tech-stack-evaluator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tech-stack-evaluator`)
...
```prompt
You are executing the tech-stack-evaluator workflow. Use the following context:
