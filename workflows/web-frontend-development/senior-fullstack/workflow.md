...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-fullstack/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-fullstack/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run senior-fullstack`)
...
```prompt
You are executing the senior-fullstack workflow. Use the following context:
