...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/quality-manager-qmr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/quality-manager-qmr/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run quality-manager-qmr`)
...
```prompt
You are executing the quality-manager-qmr workflow. Use the following context:
