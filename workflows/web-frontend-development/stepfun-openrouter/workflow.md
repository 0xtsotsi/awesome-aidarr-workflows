...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mig6671/stepfun-openrouter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mig6671/stepfun-openrouter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run stepfun-openrouter`)
...
```prompt
You are executing the stepfun-openrouter workflow. Use the following context:
