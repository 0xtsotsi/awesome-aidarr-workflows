...
> Original: [https://github.com/openclaw/skills/tree/main/skills/santidev95/mtg-edh-deckbuilder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/santidev95/mtg-edh-deckbuilder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mtg-edh-deckbuilder`)
...
```prompt
You are executing the mtg-edh-deckbuilder workflow. Use the following context:
