...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/perf-profiler/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/perf-profiler/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run perf-profiler`)
...
```prompt
You are executing the perf-profiler workflow. Use the following context:
