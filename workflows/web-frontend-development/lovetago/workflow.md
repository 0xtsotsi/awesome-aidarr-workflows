...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lakyfx/lovetago/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lakyfx/lovetago/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run lovetago`)
...
```prompt
You are executing the lovetago workflow. Use the following context:
