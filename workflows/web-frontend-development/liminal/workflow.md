...
> Original: [https://github.com/openclaw/skills/tree/main/skills/luruibu/liminal/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/luruibu/liminal/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run liminal`)
...
```prompt
You are executing the liminal workflow. Use the following context:
