...
> Original: [https://github.com/openclaw/skills/tree/main/skills/santidev95/scryfall-card/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/santidev95/scryfall-card/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run scryfall-card`)
...
```prompt
You are executing the scryfall-card workflow. Use the following context:
