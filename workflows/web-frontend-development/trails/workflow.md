...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jameslawton/trails/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jameslawton/trails/SKILL.md)
...
**Tags:** trails, cross-chain, swap, bridge, defi, web3, payments
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run trails`)
...
```prompt
You are executing the trails workflow. Use the following context:
