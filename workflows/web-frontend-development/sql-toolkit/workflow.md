...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/sql-toolkit/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/sql-toolkit/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sql-toolkit`)
...
```prompt
You are executing the sql-toolkit workflow. Use the following context:
