...
> Original: [https://github.com/openclaw/skills/tree/main/skills/shreefentsar/remotion-video-toolkit/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/shreefentsar/remotion-video-toolkit/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run remotion-video-toolkit`)
...
```prompt
You are executing the remotion-video-toolkit workflow. Use the following context:
