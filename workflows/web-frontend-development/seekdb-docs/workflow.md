...
> Original: [https://github.com/openclaw/skills/tree/main/skills/davidzhangbj/seekdb-docs/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/davidzhangbj/seekdb-docs/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run seekdb-docs`)
...
```prompt
You are executing the seekdb-docs workflow. Use the following context:
