...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steipete/slack/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steipete/slack/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run slack`)
...
```prompt
You are executing the slack workflow. Use the following context:
