...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xqicxx/thinking-model-enhancer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xqicxx/thinking-model-enhancer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run thinking-model-enhancer`)
...
```prompt
You are executing the thinking-model-enhancer workflow. Use the following context:
