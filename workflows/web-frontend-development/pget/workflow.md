...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kelvincai522/pget/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kelvincai522/pget/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pget`)
...
```prompt
You are executing the pget workflow. Use the following context:
