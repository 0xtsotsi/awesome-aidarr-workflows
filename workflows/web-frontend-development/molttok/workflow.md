...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tristankaiburrell-code/molttok/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tristankaiburrell-code/molttok/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run molttok`)
...
```prompt
You are executing the molttok workflow. Use the following context:
