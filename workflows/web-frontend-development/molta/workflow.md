...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pacelabs/molta/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pacelabs/molta/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run molta`)
...
```prompt
You are executing the molta workflow. Use the following context:
