...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rubenaquispe/sandwrap/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rubenaquispe/sandwrap/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sandwrap`)
...
```prompt
You are executing the sandwrap workflow. Use the following context:
