...
> Original: [https://github.com/openclaw/skills/tree/main/skills/wistec-ai-it-department/wistec-core/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/wistec-ai-it-department/wistec-core/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wistec-core`)
...
```prompt
You are executing the wistec-core workflow. Use the following context:
