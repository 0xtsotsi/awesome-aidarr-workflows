...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leegitw/principle-synthesizer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leegitw/principle-synthesizer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run principle-synthesizer`)
...
```prompt
You are executing the principle-synthesizer workflow. Use the following context:
