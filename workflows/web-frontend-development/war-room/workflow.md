...
> Original: [https://github.com/openclaw/skills/tree/main/skills/maxkle1nz/war-room/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/maxkle1nz/war-room/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run war-room`)
...
```prompt
You are executing the war-room workflow. Use the following context:
