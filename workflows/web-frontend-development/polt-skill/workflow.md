...
> Original: [https://github.com/openclaw/skills/tree/main/skills/playdadev/polt-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/playdadev/polt-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run polt-skill`)
...
```prompt
You are executing the polt-skill workflow. Use the following context:
