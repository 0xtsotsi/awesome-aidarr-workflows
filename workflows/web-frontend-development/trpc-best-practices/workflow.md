...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ifoster01/trpc-best-practices/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ifoster01/trpc-best-practices/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run trpc-best-practices`)
...
```prompt
You are executing the trpc-best-practices workflow. Use the following context:
