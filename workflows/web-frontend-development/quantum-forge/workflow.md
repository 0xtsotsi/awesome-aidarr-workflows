...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kosasih/quantum-forge/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kosasih/quantum-forge/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run quantum-forge`)
...
```prompt
You are executing the quantum-forge workflow. Use the following context:
