...
> Original: [https://github.com/openclaw/skills/tree/main/skills/teneoprotocoldev/teneo-agent-sdk/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/teneoprotocoldev/teneo-agent-sdk/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run teneo-agent-sdk`)
...
```prompt
You are executing the teneo-agent-sdk workflow. Use the following context:
