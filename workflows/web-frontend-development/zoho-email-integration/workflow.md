...
> Original: [https://github.com/openclaw/skills/tree/main/skills/briansmith80/zoho-email-integration/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/briansmith80/zoho-email-integration/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zoho-email-integration`)
...
```prompt
You are executing the zoho-email-integration workflow. Use the following context:
