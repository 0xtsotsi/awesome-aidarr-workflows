...
> Original: [https://github.com/openclaw/skills/tree/main/skills/qidu/get-ip/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/qidu/get-ip/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run get-ip`)
...
```prompt
You are executing the get-ip workflow. Use the following context:
