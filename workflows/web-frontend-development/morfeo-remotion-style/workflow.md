...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pauldelavallaz/morfeo-remotion-style/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pauldelavallaz/morfeo-remotion-style/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run morfeo-remotion-style`)
...
```prompt
You are executing the morfeo-remotion-style workflow. Use the following context:
