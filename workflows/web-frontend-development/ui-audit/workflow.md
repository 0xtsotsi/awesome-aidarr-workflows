...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tommygeoco/ui-audit/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tommygeoco/ui-audit/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ui-audit`)
...
```prompt
You are executing the ui-audit workflow. Use the following context:
