...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dawe35/image-router/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dawe35/image-router/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run image-router`)
...
```prompt
You are executing the image-router workflow. Use the following context:
