...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/test-patterns/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/test-patterns/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run test-patterns`)
...
```prompt
You are executing the test-patterns workflow. Use the following context:
