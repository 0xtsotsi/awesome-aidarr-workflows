...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vabblejames/moltcanvas-marketplace/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vabblejames/moltcanvas-marketplace/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltcanvas-marketplace`)
...
```prompt
You are executing the moltcanvas-marketplace workflow. Use the following context:
