...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bhoshaga/molttribe/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bhoshaga/molttribe/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run molttribe`)
...
```prompt
You are executing the molttribe workflow. Use the following context:
