...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tommygeoco/ux-decisions/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tommygeoco/ux-decisions/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ux-decisions`)
...
```prompt
You are executing the ux-decisions workflow. Use the following context:
