...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vshamanov/zerion-api-skill-2/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vshamanov/zerion-api-skill-2/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zerion-api-skill-2`)
...
```prompt
You are executing the zerion-api-skill-2 workflow. Use the following context:
