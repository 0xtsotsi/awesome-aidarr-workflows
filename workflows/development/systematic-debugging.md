...
**Original:** systematic-debugging/SKILL.md
...
```
You are executing the "systematic-debugging" workflow from the AiDarr GOTCHA framework.

Your goal: Use when encountering any bug, test failure, or unexpected behavior, before proposing fixes
