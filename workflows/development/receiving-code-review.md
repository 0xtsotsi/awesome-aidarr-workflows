...
**Original:** receiving-code-review/SKILL.md
...
```
You are executing the "receiving-code-review" workflow from the AiDarr GOTCHA framework.

Your goal: Use when receiving code review feedback, before implementing suggestions, especially if feedback seems unclear or technically questionable - requires technical rigor and verification, not performative agreement or blind implementation
