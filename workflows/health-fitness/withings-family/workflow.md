...
> Original: [https://github.com/openclaw/skills/tree/main/skills/odrobnik/withings-family/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/odrobnik/withings-family/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run withings-family`)
...
```prompt
You are executing the withings-family workflow. Use the following context:
