...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gricha/workout/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gricha/workout/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run workout`)
...
```prompt
You are executing the workout workflow. Use the following context:
