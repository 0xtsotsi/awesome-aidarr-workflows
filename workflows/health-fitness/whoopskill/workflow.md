...
> Original: [https://github.com/openclaw/skills/tree/main/skills/koala73/whoopskill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/koala73/whoopskill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run whoopskill`)
...
```prompt
You are executing the whoopskill workflow. Use the following context:
