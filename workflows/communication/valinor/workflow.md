...
> Original: [https://github.com/openclaw/skills/tree/main/skills/douglance/valinor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/douglance/valinor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run valinor`)
...
```prompt
You are executing the valinor workflow. Use the following context:
