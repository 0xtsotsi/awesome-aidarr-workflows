...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nalg/telegram-ascii-table/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nalg/telegram-ascii-table/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run telegram-ascii-table`)
...
```prompt
You are executing the telegram-ascii-table workflow. Use the following context:
