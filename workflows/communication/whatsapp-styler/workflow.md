...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rubenfb23/whatsapp-styler/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rubenfb23/whatsapp-styler/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run whatsapp-styler`)
...
```prompt
You are executing the whatsapp-styler workflow. Use the following context:
