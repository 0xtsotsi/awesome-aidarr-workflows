...
> Original: [https://github.com/openclaw/skills/tree/main/skills/millymilton/twitter-operations/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/millymilton/twitter-operations/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run twitter-operations`)
...
```prompt
You are executing the twitter-operations workflow. Use the following context:
