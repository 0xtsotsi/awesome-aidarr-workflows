...
> Original: [https://github.com/openclaw/skills/tree/main/skills/durchblick-nl/protonmail/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/durchblick-nl/protonmail/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run protonmail`)
...
```prompt
You are executing the protonmail workflow. Use the following context:
