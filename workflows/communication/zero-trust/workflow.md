...
> Original: [https://github.com/openclaw/skills/tree/main/skills/doonot/zero-trust/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/doonot/zero-trust/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zero-trust`)
...
```prompt
You are executing the zero-trust workflow. Use the following context:
