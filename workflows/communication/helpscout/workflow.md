...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fabiensebban/helpscout/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fabiensebban/helpscout/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run helpscout`)
...
```prompt
You are executing the helpscout workflow. Use the following context:
