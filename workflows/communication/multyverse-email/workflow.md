...
> Original: [https://github.com/openclaw/skills/tree/main/skills/webdevtodayjason/multyverse-email/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/webdevtodayjason/multyverse-email/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run multyverse-email`)
...
```prompt
You are executing the multyverse-email workflow. Use the following context:
