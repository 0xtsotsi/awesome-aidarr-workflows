...
> Original: [https://github.com/openclaw/skills/tree/main/skills/regalstreak/luma/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/regalstreak/luma/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run luma`)
...
```prompt
You are executing the luma workflow. Use the following context:
