...
> Original: [https://github.com/openclaw/skills/tree/main/skills/crazypeace/telegram-pairing-customization/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/crazypeace/telegram-pairing-customization/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run telegram-pairing-customization`)
...
```prompt
You are executing the telegram-pairing-customization workflow. Use the following context:
