...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alphafactor/wechat/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alphafactor/wechat/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wechat`)
...
```prompt
You are executing the wechat workflow. Use the following context:
