...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jordanprater/telegram-create-bot/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jordanprater/telegram-create-bot/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run telegram-create-bot`)
...
```prompt
You are executing the telegram-create-bot workflow. Use the following context:
