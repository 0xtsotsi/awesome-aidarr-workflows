...
> Original: [https://github.com/openclaw/skills/tree/main/skills/itstauq/telegram-auto-topic/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/itstauq/telegram-auto-topic/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run telegram-auto-topic`)
...
```prompt
You are executing the telegram-auto-topic workflow. Use the following context:
