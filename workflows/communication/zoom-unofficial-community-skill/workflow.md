...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tanchunsiong/zoom-unofficial-community-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tanchunsiong/zoom-unofficial-community-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zoom-unofficial-community-skill`)
...
```prompt
You are executing the zoom-unofficial-community-skill workflow. Use the following context:
