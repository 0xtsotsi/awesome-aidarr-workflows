...
> Original: [https://github.com/openclaw/skills/tree/main/skills/victorcavero14/upload-post/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/victorcavero14/upload-post/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run upload-post`)
...
```prompt
You are executing the upload-post workflow. Use the following context:
