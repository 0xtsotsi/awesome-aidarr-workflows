...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zack-schrag/treeline-money/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zack-schrag/treeline-money/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run treeline-money`)
...
```prompt
You are executing the treeline-money workflow. Use the following context:
