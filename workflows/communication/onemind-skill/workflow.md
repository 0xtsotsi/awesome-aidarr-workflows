...
> Original: [https://github.com/openclaw/skills/tree/main/skills/onemindlife/onemind-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/onemindlife/onemind-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run onemind-skill`)
...
```prompt
You are executing the onemind-skill workflow. Use the following context:
