...
> Original: [https://github.com/openclaw/skills/tree/main/skills/danbaranov/postproxy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/danbaranov/postproxy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run postproxy`)
...
```prompt
You are executing the postproxy workflow. Use the following context:
