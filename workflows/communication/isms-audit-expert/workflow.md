...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/isms-audit-expert/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/isms-audit-expert/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run isms-audit-expert`)
...
```prompt
You are executing the isms-audit-expert workflow. Use the following context:
