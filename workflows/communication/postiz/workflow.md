...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nevo-david/postiz/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nevo-david/postiz/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run postiz`)
...
```prompt
You are executing the postiz workflow. Use the following context:
