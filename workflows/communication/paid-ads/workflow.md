...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/paid-ads/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/paid-ads/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run paid-ads`)
...
```prompt
You are executing the paid-ads workflow. Use the following context:
