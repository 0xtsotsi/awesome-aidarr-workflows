...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sebastian-buitrag0/telegram-bot/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sebastian-buitrag0/telegram-bot/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run telegram-bot`)
...
```prompt
You are executing the telegram-bot workflow. Use the following context:
