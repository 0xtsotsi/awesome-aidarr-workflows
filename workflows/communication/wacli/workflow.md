...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steipete/wacli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steipete/wacli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wacli`)
...
```prompt
You are executing the wacli workflow. Use the following context:
