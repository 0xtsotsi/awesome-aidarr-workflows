...
> Original: [https://github.com/openclaw/skills/tree/main/skills/co1onnese/quietmail/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/co1onnese/quietmail/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run quietmail`)
...
```prompt
You are executing the quietmail workflow. Use the following context:
