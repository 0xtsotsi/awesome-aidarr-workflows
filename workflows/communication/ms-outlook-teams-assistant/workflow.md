...
> Original: [https://github.com/openclaw/skills/tree/main/skills/abhinavjp/ms-outlook-teams-assistant/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/abhinavjp/ms-outlook-teams-assistant/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ms-outlook-teams-assistant`)
...
```prompt
You are executing the ms-outlook-teams-assistant workflow. Use the following context:
