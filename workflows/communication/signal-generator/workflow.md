...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nititepfirm/signal-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nititepfirm/signal-generator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run signal-generator`)
...
```prompt
You are executing the signal-generator workflow. Use the following context:
