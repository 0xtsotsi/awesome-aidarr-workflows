...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dru-ca/phone-calls-bland/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dru-ca/phone-calls-bland/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run phone-calls-bland`)
...
```prompt
You are executing the phone-calls-bland workflow. Use the following context:
