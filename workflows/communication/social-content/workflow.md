...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/social-content/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jchopard69/marketing-skills/references/social-content/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run social-content`)
...
```prompt
You are executing the social-content workflow. Use the following context:
