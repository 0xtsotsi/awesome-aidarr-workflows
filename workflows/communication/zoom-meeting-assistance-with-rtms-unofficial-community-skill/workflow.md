...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tanchunsiong/zoom-meeting-assistance-with-rtms-unofficial-community-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tanchunsiong/zoom-meeting-assistance-with-rtms-unofficial-community-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zoom-meeting-assistance-with-rtms-unofficial-community-skill`)
...
```prompt
You are executing the zoom-meeting-assistance-with-rtms-unofficial-community-skill workflow. Use the following context:
...
```yaml
name: zoom-meeting-assistance-with-rtms-unofficial-community-skill
category: Communication
version: 1.0.0
user_invocable: True
homepage: 
