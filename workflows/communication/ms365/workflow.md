...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cvsloane/ms365/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cvsloane/ms365/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ms365`)
...
```prompt
You are executing the ms365 workflow. Use the following context:
