...
> Original: [https://github.com/openclaw/skills/tree/main/skills/danbaranov/postproxy-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/danbaranov/postproxy-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run postproxy-skill`)
...
```prompt
You are executing the postproxy-skill workflow. Use the following context:
