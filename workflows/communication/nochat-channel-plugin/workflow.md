...
> Original: [https://github.com/openclaw/skills/tree/main/skills/catsmeow492/nochat-channel-plugin/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/catsmeow492/nochat-channel-plugin/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nochat-channel-plugin`)
...
```prompt
You are executing the nochat-channel-plugin workflow. Use the following context:
