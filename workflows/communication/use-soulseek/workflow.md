...
> Original: [https://github.com/openclaw/skills/tree/main/skills/svidovich/use-soulseek/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/svidovich/use-soulseek/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run use-soulseek`)
...
```prompt
You are executing the use-soulseek workflow. Use the following context:
