...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ms-youssef/signalhire-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ms-youssef/signalhire-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run signalhire-skill`)
...
```prompt
You are executing the signalhire-skill workflow. Use the following context:
