...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fianabates1/test-wa/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fianabates1/test-wa/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run test-wa`)
...
```prompt
You are executing the test-wa workflow. Use the following context:
