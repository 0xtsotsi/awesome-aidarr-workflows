...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rosconl/intodns/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rosconl/intodns/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run intodns`)
...
```prompt
You are executing the intodns workflow. Use the following context:
