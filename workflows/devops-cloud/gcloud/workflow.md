...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jortega0033/gcloud/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jortega0033/gcloud/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gcloud`)
...
```prompt
You are executing the gcloud workflow. Use the following context:
