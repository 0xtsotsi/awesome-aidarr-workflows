...
> Original: [https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/topic-monitor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/topic-monitor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run topic-monitor`)
...
```prompt
You are executing the topic-monitor workflow. Use the following context:
