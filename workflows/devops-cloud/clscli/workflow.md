...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dbwang0130/clscli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dbwang0130/clscli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clscli`)
...
```prompt
You are executing the clscli workflow. Use the following context:
