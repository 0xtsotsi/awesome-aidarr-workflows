...
> Original: [https://github.com/openclaw/skills/tree/main/skills/davida-ps/clawsec-suite/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/davida-ps/clawsec-suite/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawsec-suite`)
...
```prompt
You are executing the clawsec-suite workflow. Use the following context:
