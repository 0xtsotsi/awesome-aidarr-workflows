...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dlewis7444/esxi/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dlewis7444/esxi/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run esxi`)
...
```prompt
You are executing the esxi workflow. Use the following context:
