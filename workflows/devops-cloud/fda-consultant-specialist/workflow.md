...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/fda-consultant-specialist/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/fda-consultant-specialist/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run fda-consultant-specialist`)
...
```prompt
You are executing the fda-consultant-specialist workflow. Use the following context:
