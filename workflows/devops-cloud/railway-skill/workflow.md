...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leicao-me/railway-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leicao-me/railway-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run railway-skill`)
...
```prompt
You are executing the railway-skill workflow. Use the following context:
