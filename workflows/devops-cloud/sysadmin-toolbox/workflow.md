...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jdrhyne/sysadmin-toolbox/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jdrhyne/sysadmin-toolbox/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sysadmin-toolbox`)
...
```prompt
You are executing the sysadmin-toolbox workflow. Use the following context:
