...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/log-analyzer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/log-analyzer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run log-analyzer`)
...
```prompt
You are executing the log-analyzer workflow. Use the following context:
