...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sanjacob99/jules-and-lobster/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sanjacob99/jules-and-lobster/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run jules-and-lobster`)
...
```prompt
You are executing the jules-and-lobster workflow. Use the following context:
