...
> Original: [https://github.com/openclaw/skills/tree/main/skills/koba42corp/i-responder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/koba42corp/i-responder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run i-responder`)
...
```prompt
You are executing the i-responder workflow. Use the following context:
