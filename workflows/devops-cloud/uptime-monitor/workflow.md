...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kunoiiv/uptime-monitor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kunoiiv/uptime-monitor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run uptime-monitor`)
...
```prompt
You are executing the uptime-monitor workflow. Use the following context:
