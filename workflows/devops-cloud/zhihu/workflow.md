...
> Original: [https://github.com/openclaw/skills/tree/main/skills/keepwonder/zhihu/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/keepwonder/zhihu/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zhihu`)
...
```prompt
You are executing the zhihu workflow. Use the following context:
