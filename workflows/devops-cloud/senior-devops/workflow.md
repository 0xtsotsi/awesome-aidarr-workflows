...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-devops/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-devops/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run senior-devops`)
...
```prompt
You are executing the senior-devops workflow. Use the following context:
