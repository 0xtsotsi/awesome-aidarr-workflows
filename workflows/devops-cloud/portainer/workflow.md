...
> Original: [https://github.com/openclaw/skills/tree/main/skills/asteinberger/portainer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/asteinberger/portainer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run portainer`)
...
```prompt
You are executing the portainer workflow. Use the following context:
