...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thesethrose/vercel/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thesethrose/vercel/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vercel`)
...
```prompt
You are executing the vercel workflow. Use the following context:
