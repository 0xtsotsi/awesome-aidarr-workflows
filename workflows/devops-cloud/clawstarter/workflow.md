...
> Original: [https://github.com/openclaw/skills/tree/main/skills/harrytou/clawstarter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/harrytou/clawstarter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawstarter`)
...
```prompt
You are executing the clawstarter workflow. Use the following context:
