...
> Original: [https://github.com/openclaw/skills/tree/main/skills/franky0617/minimax-coding-plan-usage/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/franky0617/minimax-coding-plan-usage/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run minimax-coding-plan-usage`)
...
```prompt
You are executing the minimax-coding-plan-usage workflow. Use the following context:
...
```yaml
name: minimax-coding-plan-usage
category: DevOps & Cloud
version: 1.0.0
user_invocable: True
homepage: 
