...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dbhurley/meshguard/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dbhurley/meshguard/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run meshguard`)
...
```prompt
You are executing the meshguard workflow. Use the following context:
