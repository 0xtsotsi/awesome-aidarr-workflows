...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nickian/supernote-cloud/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nickian/supernote-cloud/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run supernote-cloud`)
...
```prompt
You are executing the supernote-cloud workflow. Use the following context:
