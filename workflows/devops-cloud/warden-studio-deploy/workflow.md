...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kryptopaid/warden-studio-deploy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kryptopaid/warden-studio-deploy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run warden-studio-deploy`)
...
```prompt
You are executing the warden-studio-deploy workflow. Use the following context:
