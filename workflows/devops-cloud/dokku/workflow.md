...
> Original: [https://github.com/openclaw/skills/tree/main/skills/akhil-naidu/dokku/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/akhil-naidu/dokku/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run dokku`)
...
```prompt
You are executing the dokku workflow. Use the following context:
