...
> Original: [https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/solar-weather/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/solar-weather/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run solar-weather`)
...
```prompt
You are executing the solar-weather workflow. Use the following context:
