...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rohitg00/k8s-capi/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rohitg00/k8s-capi/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run k8s-capi`)
...
```prompt
You are executing the k8s-capi workflow. Use the following context:
