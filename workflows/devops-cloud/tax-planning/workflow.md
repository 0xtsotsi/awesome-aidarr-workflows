...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jk-0001/tax-planning/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jk-0001/tax-planning/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tax-planning`)
...
```prompt
You are executing the tax-planning workflow. Use the following context:
