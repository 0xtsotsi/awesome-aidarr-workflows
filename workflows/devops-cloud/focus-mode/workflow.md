...
> Original: [https://github.com/openclaw/skills/tree/main/skills/savorgbot-exe/focus-mode/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/savorgbot-exe/focus-mode/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run focus-mode`)
...
```prompt
You are executing the focus-mode workflow. Use the following context:
