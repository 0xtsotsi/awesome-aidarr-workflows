...
> Original: [https://github.com/openclaw/skills/tree/main/skills/msarheed/proxmox-full/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/msarheed/proxmox-full/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run proxmox-full`)
...
```prompt
You are executing the proxmox-full workflow. Use the following context:
