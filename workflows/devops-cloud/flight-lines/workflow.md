...
> Original: [https://github.com/openclaw/skills/tree/main/skills/liet-codes/flight-lines/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/liet-codes/flight-lines/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run flight-lines`)
...
```prompt
You are executing the flight-lines workflow. Use the following context:
