...
> Original: [https://github.com/openclaw/skills/tree/main/skills/derekross/clawstr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/derekross/clawstr/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawstr`)
...
```prompt
You are executing the clawstr workflow. Use the following context:
