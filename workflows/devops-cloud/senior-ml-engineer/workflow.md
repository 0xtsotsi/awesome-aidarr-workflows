...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-ml-engineer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/senior-ml-engineer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run senior-ml-engineer`)
...
```prompt
You are executing the senior-ml-engineer workflow. Use the following context:
