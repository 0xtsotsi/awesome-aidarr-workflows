...
> Original: [https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/therohitdas/youtube-api/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run youtube-api`)
...
```prompt
You are executing the youtube-api workflow. Use the following context:
