...
> Original: [https://github.com/openclaw/skills/tree/main/skills/undsoul/qlik-cloud-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/undsoul/qlik-cloud-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run qlik-cloud-skill`)
...
```prompt
You are executing the qlik-cloud-skill workflow. Use the following context:
