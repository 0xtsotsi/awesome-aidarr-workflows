...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kesslerio/kesslerio-stealth-browser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kesslerio/kesslerio-stealth-browser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kesslerio-stealth-browser`)
...
```prompt
You are executing the kesslerio-stealth-browser workflow. Use the following context:
