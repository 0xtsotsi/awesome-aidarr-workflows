...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ajstafford/jules-cli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ajstafford/jules-cli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run jules-cli`)
...
```prompt
You are executing the jules-cli workflow. Use the following context:
