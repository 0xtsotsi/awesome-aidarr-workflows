...
> Original: [https://github.com/openclaw/skills/tree/main/skills/edwardirby/ydc-ai-sdk-integration/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/edwardirby/ydc-ai-sdk-integration/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ydc-ai-sdk-integration`)
...
```prompt
You are executing the ydc-ai-sdk-integration workflow. Use the following context:
