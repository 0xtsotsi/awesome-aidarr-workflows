...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cgnl/tado/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cgnl/tado/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tado`)
...
```prompt
You are executing the tado workflow. Use the following context:
