...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thesethrose/servicenow-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thesethrose/servicenow-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run servicenow-agent`)
...
```prompt
You are executing the servicenow-agent workflow. Use the following context:
