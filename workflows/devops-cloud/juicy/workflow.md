...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mejango/juicy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mejango/juicy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run juicy`)
...
```prompt
You are executing the juicy workflow. Use the following context:
