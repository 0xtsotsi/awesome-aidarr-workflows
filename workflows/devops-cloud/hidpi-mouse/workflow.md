...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zeyuyuyu/hidpi-mouse/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zeyuyuyu/hidpi-mouse/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hidpi-mouse`)
...
```prompt
You are executing the hidpi-mouse workflow. Use the following context:
