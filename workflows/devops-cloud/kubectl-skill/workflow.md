...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ddevaal/kubectl/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ddevaal/kubectl/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kubectl-skill`)
...
```prompt
You are executing the kubectl-skill workflow. Use the following context:
