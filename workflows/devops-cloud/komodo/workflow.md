...
> Original: [https://github.com/openclaw/skills/tree/main/skills/weird-aftertaste/komodo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/weird-aftertaste/komodo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run komodo`)
...
```prompt
You are executing the komodo workflow. Use the following context:
