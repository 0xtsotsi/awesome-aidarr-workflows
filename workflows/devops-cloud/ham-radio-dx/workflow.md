...
> Original: [https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/ham-radio-dx/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/ham-radio-dx/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ham-radio-dx`)
...
```prompt
You are executing the ham-radio-dx workflow. Use the following context:
