...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dannyshmueli/jits-builder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dannyshmueli/jits-builder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run jits-builder`)
...
```prompt
You are executing the jits-builder workflow. Use the following context:
