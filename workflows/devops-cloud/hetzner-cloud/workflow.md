...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pasogott/hetzner-cloud/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pasogott/hetzner-cloud/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hetzner-cloud`)
...
```prompt
You are executing the hetzner-cloud workflow. Use the following context:
