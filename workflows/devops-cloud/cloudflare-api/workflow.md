...
> Original: [https://github.com/openclaw/skills/tree/main/skills/stopmoclay/cloudflare-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/stopmoclay/cloudflare-api/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cloudflare-api`)
...
```prompt
You are executing the cloudflare-api workflow. Use the following context:
