...
> Original: [https://github.com/openclaw/skills/tree/main/skills/acfranzen/glance/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/acfranzen/glance/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run glance`)
...
```prompt
You are executing the glance workflow. Use the following context:
