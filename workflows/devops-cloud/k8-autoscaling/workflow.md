...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rohitg00/k8-autoscaling/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rohitg00/k8-autoscaling/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run k8-autoscaling`)
...
```prompt
You are executing the k8-autoscaling workflow. Use the following context:
