...
> Original: [https://github.com/openclaw/skills/tree/main/skills/danfedick/nomad/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/danfedick/nomad/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nomad`)
...
```prompt
You are executing the nomad workflow. Use the following context:
