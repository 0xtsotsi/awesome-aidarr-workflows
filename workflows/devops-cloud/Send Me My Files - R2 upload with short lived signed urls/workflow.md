...
> Original: [https://github.com/openclaw/skills/tree/main/skills/julianengel/r2-upload/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/julianengel/r2-upload/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run Send Me My Files - R2 upload with short lived signed urls`)
...
```prompt
You are executing the Send Me My Files - R2 upload with short lived signed urls workflow. Use the following context:
