...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ojusave/deploy-on-render/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ojusave/deploy-on-render/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run deploy-on-render`)
...
```prompt
You are executing the deploy-on-render workflow. Use the following context:
