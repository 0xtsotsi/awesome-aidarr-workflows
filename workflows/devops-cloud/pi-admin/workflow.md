...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thesethrose/pi-admin/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thesethrose/pi-admin/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pi-admin`)
...
```prompt
You are executing the pi-admin workflow. Use the following context:
