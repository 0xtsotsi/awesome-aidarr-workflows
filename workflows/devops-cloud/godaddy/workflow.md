...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rdewolff/godaddy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rdewolff/godaddy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run godaddy`)
...
```prompt
You are executing the godaddy workflow. Use the following context:
