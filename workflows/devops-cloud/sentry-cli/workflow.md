...
> Original: [https://github.com/openclaw/skills/tree/main/skills/iahmadzain/sentry-cli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/iahmadzain/sentry-cli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sentry-cli`)
...
```prompt
You are executing the sentry-cli workflow. Use the following context:
