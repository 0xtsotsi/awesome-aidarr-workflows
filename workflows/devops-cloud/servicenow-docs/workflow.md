...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thesethrose/servicenow-docs/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thesethrose/servicenow-docs/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run servicenow-docs`)
...
```prompt
You are executing the servicenow-docs workflow. Use the following context:
