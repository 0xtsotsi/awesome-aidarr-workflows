...
> Original: [https://github.com/openclaw/skills/tree/main/skills/juanpin/yutori-web-research/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/juanpin/yutori-web-research/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run yutori-web-research`)
...
```prompt
You are executing the yutori-web-research workflow. Use the following context:
