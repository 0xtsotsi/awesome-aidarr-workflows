...
> Original: [https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/proactive-research/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/proactive-research/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run proactive-research`)
...
```prompt
You are executing the proactive-research workflow. Use the following context:
