...
> Original: [https://github.com/openclaw/skills/tree/main/skills/j540/openclaw-setup/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/j540/openclaw-setup/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaw-setup`)
...
```prompt
You are executing the openclaw-setup workflow. Use the following context:
