...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arnarsson/ssh-essentials/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arnarsson/ssh-essentials/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ssh-essentials`)
...
```prompt
You are executing the ssh-essentials workflow. Use the following context:
