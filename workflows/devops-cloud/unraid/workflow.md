...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jmagar/unraid/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jmagar/unraid/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run unraid`)
...
```prompt
You are executing the unraid workflow. Use the following context:
