...
> Original: [https://github.com/openclaw/skills/tree/main/skills/divide-by-0/create-new-openclaw-in-gcp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/divide-by-0/create-new-openclaw-in-gcp/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run create-new-openclaw-in-gcp`)
...
```prompt
You are executing the create-new-openclaw-in-gcp workflow. Use the following context:
