...
> Original: [https://github.com/openclaw/skills/tree/main/skills/visiongeist/coolify/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/visiongeist/coolify/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run coolify`)
...
```prompt
You are executing the coolify workflow. Use the following context:
