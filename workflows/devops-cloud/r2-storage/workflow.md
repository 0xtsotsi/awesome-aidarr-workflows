...
> Original: [https://github.com/openclaw/skills/tree/main/skills/junwatu/r2-storage/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/junwatu/r2-storage/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run r2-storage`)
...
```prompt
You are executing the r2-storage workflow. Use the following context:
