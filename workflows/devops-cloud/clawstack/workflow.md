...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jdiazofficial/clawstack/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jdiazofficial/clawstack/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawstack`)
...
```prompt
You are executing the clawstack workflow. Use the following context:
