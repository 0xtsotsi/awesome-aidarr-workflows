...
> Original: [https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/devlog-agent-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/devlog-agent-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run devlog-agent-skill`)
...
```prompt
You are executing the devlog-agent-skill workflow. Use the following context:
