...
> Original: [https://github.com/openclaw/skills/tree/main/skills/asleep123/wrangler/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/asleep123/wrangler/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cloudflare`)
...
```prompt
You are executing the cloudflare workflow. Use the following context:
