...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tianshizhimao-sudo/rba-rate-intelligence/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tianshizhimao-sudo/rba-rate-intelligence/SKILL.md)
...
RBA cash rate monitor, meeting schedule, CPI tracker, and mortgage impact calculator for Australia.
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run rba-rate-intelligence`)
...
```prompt
You are executing the rba-rate-intelligence workflow. Use the following context:
