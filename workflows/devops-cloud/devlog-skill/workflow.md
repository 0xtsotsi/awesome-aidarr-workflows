...
> Original: [https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/devlog-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/devlog-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run devlog-skill`)
...
```prompt
You are executing the devlog-skill workflow. Use the following context:
