...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leegitw/principle-comparator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leegitw/principle-comparator/SKILL.md)
...
**Tags:** principle-comparison, pattern-validation, n-count-tracking, knowledge-synthesis, documentation-tools, semantic-alignment
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run principle-comparator`)
...
```prompt
You are executing the principle-comparator workflow. Use the following context:
