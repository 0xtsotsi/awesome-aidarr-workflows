...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sidu/location-safety-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sidu/location-safety-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run location-safety-skill`)
...
```prompt
You are executing the location-safety-skill workflow. Use the following context:
