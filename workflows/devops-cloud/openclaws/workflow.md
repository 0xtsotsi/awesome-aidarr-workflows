...
> Original: [https://github.com/openclaw/skills/tree/main/skills/amoghacloud/openclaws/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/amoghacloud/openclaws/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaws`)
...
```prompt
You are executing the openclaws workflow. Use the following context:
