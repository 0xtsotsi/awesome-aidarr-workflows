...
> Original: [https://github.com/openclaw/skills/tree/main/skills/uncmatteth/uncle-matt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/uncmatteth/uncle-matt/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run uncle-matt`)
...
```prompt
You are executing the uncle-matt workflow. Use the following context:
