...
> Original: [https://github.com/openclaw/skills/tree/main/skills/evgyur/decision-trees/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/evgyur/decision-trees/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run decision-trees`)
...
```prompt
You are executing the decision-trees workflow. Use the following context:
