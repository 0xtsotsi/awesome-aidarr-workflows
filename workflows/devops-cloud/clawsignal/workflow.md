...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bmcalister/clawsignal/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bmcalister/clawsignal/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawsignal`)
...
```prompt
You are executing the clawsignal workflow. Use the following context:
