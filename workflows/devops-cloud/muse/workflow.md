...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alexander-morris/muse/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alexander-morris/muse/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run muse`)
...
```prompt
You are executing the muse workflow. Use the following context:
