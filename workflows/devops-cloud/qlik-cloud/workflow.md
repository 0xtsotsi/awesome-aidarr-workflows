...
> Original: [https://github.com/openclaw/skills/tree/main/skills/undsoul/qlik-cloud/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/undsoul/qlik-cloud/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run qlik-cloud`)
...
```prompt
You are executing the qlik-cloud workflow. Use the following context:
