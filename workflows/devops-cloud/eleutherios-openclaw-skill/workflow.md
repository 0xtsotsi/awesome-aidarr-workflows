...
> Original: [https://github.com/openclaw/skills/tree/main/skills/eleutherios-project/eleutherios-openclaw-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/eleutherios-project/eleutherios-openclaw-skill/SKILL.md)
...
**Tags:** research, knowledge-graph, analysis, mcp, epistemic, osint, document-analysis
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run eleutherios-openclaw-skill`)
...
```prompt
You are executing the eleutherios-openclaw-skill workflow. Use the following context:
