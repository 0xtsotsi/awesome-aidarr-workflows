...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xieyuanqing/nginx-config-creator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xieyuanqing/nginx-config-creator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nginx-config-creator`)
...
```prompt
You are executing the nginx-config-creator workflow. Use the following context:
