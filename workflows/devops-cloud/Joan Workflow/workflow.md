...
> Original: [https://github.com/openclaw/skills/tree/main/skills/donny-son/joan-workflow/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/donny-son/joan-workflow/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run Joan Workflow`)
...
```prompt
You are executing the Joan Workflow workflow. Use the following context:
