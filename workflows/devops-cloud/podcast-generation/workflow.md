...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thegovind/podcast-generation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thegovind/podcast-generation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run podcast-generation`)
...
```prompt
You are executing the podcast-generation workflow. Use the following context:
