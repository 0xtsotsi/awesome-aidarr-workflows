...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aerialcombat/cloud-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aerialcombat/cloud-memory/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run cloud-memory`)
...
```prompt
You are executing the cloud-memory workflow. Use the following context:
