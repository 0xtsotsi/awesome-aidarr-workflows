...
> Original: [https://github.com/openclaw/skills/tree/main/skills/eleutherios-project/eleutherios/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/eleutherios-project/eleutherios/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run eleutherios`)
...
```prompt
You are executing the eleutherios workflow. Use the following context:
