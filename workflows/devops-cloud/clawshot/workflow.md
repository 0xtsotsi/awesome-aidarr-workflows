...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bardusco/clawshot/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bardusco/clawshot/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawshot`)
...
```prompt
You are executing the clawshot workflow. Use the following context:
