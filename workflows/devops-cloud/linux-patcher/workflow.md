...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jgm2025/linux-patcher/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jgm2025/linux-patcher/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run linux-patcher`)
...
```prompt
You are executing the linux-patcher workflow. Use the following context:
