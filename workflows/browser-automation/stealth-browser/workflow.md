...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mayuqi-crypto/stealth-browser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mayuqi-crypto/stealth-browser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run stealth-browser`)
...
```prompt
You are executing the stealth-browser workflow. Use the following context:
