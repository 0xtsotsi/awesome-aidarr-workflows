...
> Original: [https://github.com/openclaw/skills/tree/main/skills/adolago/hooks-automation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/adolago/hooks-automation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hooks-automation`)
...
```prompt
You are executing the hooks-automation workflow. Use the following context:
