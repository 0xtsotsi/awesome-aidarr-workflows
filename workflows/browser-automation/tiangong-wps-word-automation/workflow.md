...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fadeloo/tiangong-wps-word-automation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fadeloo/tiangong-wps-word-automation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tiangong-wps-word-automation`)
...
```prompt
You are executing the tiangong-wps-word-automation workflow. Use the following context:
