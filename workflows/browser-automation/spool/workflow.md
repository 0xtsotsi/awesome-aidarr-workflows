...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zizi-cat/spool/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zizi-cat/spool/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run spool`)
...
```prompt
You are executing the spool workflow. Use the following context:
