...
> Original: [https://github.com/openclaw/skills/tree/main/skills/shashwatgtm/newsletter-creation-curation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/shashwatgtm/newsletter-creation-curation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run newsletter-creation-curation`)
...
```prompt
You are executing the newsletter-creation-curation workflow. Use the following context:
