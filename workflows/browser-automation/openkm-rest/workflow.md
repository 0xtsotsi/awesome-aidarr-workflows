...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pes0/openkm-rest/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pes0/openkm-rest/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openkm-rest`)
...
```prompt
You are executing the openkm-rest workflow. Use the following context:
