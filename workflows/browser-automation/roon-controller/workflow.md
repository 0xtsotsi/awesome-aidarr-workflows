...
> Original: [https://github.com/openclaw/skills/tree/main/skills/puterjam/roon-controller/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/puterjam/roon-controller/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run roon-controller`)
...
```prompt
You are executing the roon-controller workflow. Use the following context:
