...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ottttto/safe-exec/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ottttto/safe-exec/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run safe-exec`)
...
```prompt
You are executing the safe-exec workflow. Use the following context:
