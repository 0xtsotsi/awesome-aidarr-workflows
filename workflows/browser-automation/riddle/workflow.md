...
> Original: [https://github.com/openclaw/skills/tree/main/skills/davisdiehl/riddle/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/davisdiehl/riddle/SKILL.md)
...
**Tags:** browser, screenshots, playwright, automation, api, scraping
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run riddle`)
...
```prompt
You are executing the riddle workflow. Use the following context:
