...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lakyfx/lovetago-bot-tinder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lakyfx/lovetago-bot-tinder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run lovetago-bot-tinder`)
...
```prompt
You are executing the lovetago-bot-tinder workflow. Use the following context:
