...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/web-qa-bot/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/web-qa-bot/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run web-qa-bot`)
...
```prompt
You are executing the web-qa-bot workflow. Use the following context:
