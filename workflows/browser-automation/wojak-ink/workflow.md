...
> Original: [https://github.com/openclaw/skills/tree/main/skills/koba42corp/wojak-ink/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/koba42corp/wojak-ink/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wojak-ink`)
...
```prompt
You are executing the wojak-ink workflow. Use the following context:
