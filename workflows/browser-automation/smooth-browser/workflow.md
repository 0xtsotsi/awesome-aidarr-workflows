...
> Original: [https://github.com/openclaw/skills/tree/main/skills/antoniocirclemind/smooth-browser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/antoniocirclemind/smooth-browser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run smooth-browser`)
...
```prompt
You are executing the smooth-browser workflow. Use the following context:
