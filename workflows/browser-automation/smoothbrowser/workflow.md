...
> Original: [https://github.com/openclaw/skills/tree/main/skills/antoniocirclemind/smoothbrowser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/antoniocirclemind/smoothbrowser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run smoothbrowser`)
...
```prompt
You are executing the smoothbrowser workflow. Use the following context:
