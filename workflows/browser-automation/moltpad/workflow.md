...
> Original: [https://github.com/openclaw/skills/tree/main/skills/webeferen/moltpad/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/webeferen/moltpad/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltpad`)
...
```prompt
You are executing the moltpad workflow. Use the following context:
