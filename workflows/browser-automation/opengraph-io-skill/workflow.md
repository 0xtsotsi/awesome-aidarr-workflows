...
> Original: [https://github.com/openclaw/skills/tree/main/skills/primeobsession/opengraph-io-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/primeobsession/opengraph-io-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run opengraph-io-skill`)
...
```prompt
You are executing the opengraph-io-skill workflow. Use the following context:
