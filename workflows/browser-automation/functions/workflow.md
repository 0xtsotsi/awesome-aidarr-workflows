...
> Original: [https://github.com/openclaw/skills/tree/main/skills/peytoncasper/functions/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/peytoncasper/functions/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run functions`)
...
```prompt
You are executing the functions workflow. Use the following context:
