...
> Original: [https://github.com/openclaw/skills/tree/main/skills/matagul/desktop-control/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/matagul/desktop-control/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run desktop-control`)
...
```prompt
You are executing the desktop-control workflow. Use the following context:
