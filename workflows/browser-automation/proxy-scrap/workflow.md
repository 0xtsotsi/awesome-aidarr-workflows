...
> Original: [https://github.com/openclaw/skills/tree/main/skills/danman60/proxy-scrap/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/danman60/proxy-scrap/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run proxy-scrap`)
...
```prompt
You are executing the proxy-scrap workflow. Use the following context:
