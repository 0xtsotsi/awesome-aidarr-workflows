...
> Original: [https://github.com/openclaw/skills/tree/main/skills/whtoo/self-evolving-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/whtoo/self-evolving-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run self-evolving-skill`)
...
```prompt
You are executing the self-evolving-skill workflow. Use the following context:
