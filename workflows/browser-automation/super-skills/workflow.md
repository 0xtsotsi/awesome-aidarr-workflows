...
> Original: [https://github.com/openclaw/skills/tree/main/skills/10e9928a/super-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/10e9928a/super-skills/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run super-skills`)
...
```prompt
You are executing the super-skills workflow. Use the following context:
