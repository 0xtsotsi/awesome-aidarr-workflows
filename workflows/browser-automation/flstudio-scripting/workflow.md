...
> Original: [https://github.com/openclaw/skills/tree/main/skills/delorenj/flstudio-scripting/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/delorenj/flstudio-scripting/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run flstudio-scripting`)
...
```prompt
You are executing the flstudio-scripting workflow. Use the following context:
