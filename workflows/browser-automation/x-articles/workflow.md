...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/x-articles/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nextfrontierbuilds/x-articles/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-articles`)
...
```prompt
You are executing the x-articles workflow. Use the following context:
