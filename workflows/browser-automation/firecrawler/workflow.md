...
> Original: [https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/firecrawler/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/andrewdmwalker/firecrawler/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run firecrawler`)
...
```prompt
You are executing the firecrawler workflow. Use the following context:
