...
> Original: [https://github.com/openclaw/skills/tree/main/skills/peytoncasper/stagehand-browser-cli/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/peytoncasper/stagehand-browser-cli/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run stagehand-browser-cli`)
...
```prompt
You are executing the stagehand-browser-cli workflow. Use the following context:
