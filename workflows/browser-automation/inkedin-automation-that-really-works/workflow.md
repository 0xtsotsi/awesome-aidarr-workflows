...
> Original: [https://github.com/openclaw/skills/tree/main/skills/red777777/inkedin-automation-that-really-works/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/red777777/inkedin-automation-that-really-works/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run inkedin-automation-that-really-works`)
...
```prompt
You are executing the inkedin-automation-that-really-works workflow. Use the following context:
