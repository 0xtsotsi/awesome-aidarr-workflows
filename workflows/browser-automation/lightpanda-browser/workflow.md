...
> Original: [https://github.com/openclaw/skills/tree/main/skills/krichprollsch/lightpanda-browser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/krichprollsch/lightpanda-browser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run lightpanda-browser`)
...
```prompt
You are executing the lightpanda-browser workflow. Use the following context:
