...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nesdeq/serper/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nesdeq/serper/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run serper`)
...
```prompt
You are executing the serper workflow. Use the following context:
