...
> Original: [https://github.com/openclaw/skills/tree/main/skills/wpegley/desktop-control-1-0-0/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/wpegley/desktop-control-1-0-0/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run desktop-control-1-0-0`)
...
```prompt
You are executing the desktop-control-1-0-0 workflow. Use the following context:
