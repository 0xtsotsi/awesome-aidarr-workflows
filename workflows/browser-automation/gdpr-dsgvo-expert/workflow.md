...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/gdpr-dsgvo-expert/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alirezarezvani/gdpr-dsgvo-expert/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gdpr-dsgvo-expert`)
...
```prompt
You are executing the gdpr-dsgvo-expert workflow. Use the following context:
