...
> Original: [https://github.com/openclaw/skills/tree/main/skills/myestery/verify-on-browser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/myestery/verify-on-browser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run verify-on-browser`)
...
```prompt
You are executing the verify-on-browser workflow. Use the following context:
