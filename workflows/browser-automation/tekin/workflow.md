...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gwqwghksvq-sketch/tekin/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gwqwghksvq-sketch/tekin/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tekin`)
...
```prompt
You are executing the tekin workflow. Use the following context:
