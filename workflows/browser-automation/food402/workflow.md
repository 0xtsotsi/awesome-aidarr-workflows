...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rersozlu/food402/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rersozlu/food402/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run food402`)
...
```prompt
You are executing the food402 workflow. Use the following context:
