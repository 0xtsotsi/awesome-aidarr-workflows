...
> Original: [https://github.com/openclaw/skills/tree/main/skills/fadeloo/tiangong-wps-ppt-automation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/fadeloo/tiangong-wps-ppt-automation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tiangong-wps-ppt-automation`)
...
```prompt
You are executing the tiangong-wps-ppt-automation workflow. Use the following context:
