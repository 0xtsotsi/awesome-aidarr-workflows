...
> Original: [https://github.com/openclaw/skills/tree/main/skills/smokealot420/mini-piv/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/smokealot420/mini-piv/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mini-piv`)
...
```prompt
You are executing the mini-piv workflow. Use the following context:
