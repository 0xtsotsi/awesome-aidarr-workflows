...
> Original: [https://github.com/openclaw/skills/tree/main/skills/davida-ps/soul-guardian/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/davida-ps/soul-guardian/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run soul-guardian`)
...
```prompt
You are executing the soul-guardian workflow. Use the following context:
