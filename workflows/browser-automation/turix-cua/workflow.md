...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tongyu-yan/turix-cua/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tongyu-yan/turix-cua/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run turix-cua`)
...
```prompt
You are executing the turix-cua workflow. Use the following context:
