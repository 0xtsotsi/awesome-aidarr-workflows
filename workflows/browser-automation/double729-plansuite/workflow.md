...
> Original: [https://github.com/openclaw/skills/tree/main/skills/double729/double729-plansuite/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/double729/double729-plansuite/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run double729-plansuite`)
...
```prompt
You are executing the double729-plansuite workflow. Use the following context:
