...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rhesketh/monzo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rhesketh/monzo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run monzo`)
...
```prompt
You are executing the monzo workflow. Use the following context:
