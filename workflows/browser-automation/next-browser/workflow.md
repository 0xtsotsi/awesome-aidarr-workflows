...
> Original: [https://github.com/openclaw/skills/tree/main/skills/highxshell/next-browser/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/highxshell/next-browser/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run next-browser`)
...
```prompt
You are executing the next-browser workflow. Use the following context:
