...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rubenfb23/vocal-chat/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rubenfb23/vocal-chat/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vocal-chat`)
...
```prompt
You are executing the vocal-chat workflow. Use the following context:
