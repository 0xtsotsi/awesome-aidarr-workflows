...
> Original: [https://github.com/openclaw/skills/tree/main/skills/spliff7777/windows-control/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/spliff7777/windows-control/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run windows-control`)
...
```prompt
You are executing the windows-control workflow. Use the following context:
