...
> Original: [https://github.com/openclaw/skills/tree/main/skills/consort-tech/organize-tg/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/consort-tech/organize-tg/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run organize-tg`)
...
```prompt
You are executing the organize-tg workflow. Use the following context:
