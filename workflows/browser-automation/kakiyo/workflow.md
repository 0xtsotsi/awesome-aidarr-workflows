...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cyberboyayush/kakiyo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cyberboyayush/kakiyo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run kakiyo`)
...
```prompt
You are executing the kakiyo workflow. Use the following context:
