...
> Original: [https://github.com/openclaw/skills/tree/main/skills/webeferen/moltpad-app/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/webeferen/moltpad-app/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltpad-app`)
...
```prompt
You are executing the moltpad-app workflow. Use the following context:
