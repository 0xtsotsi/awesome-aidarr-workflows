...
> Original: [https://github.com/openclaw/skills/tree/main/skills/paulpete/playwriter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/paulpete/playwriter/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run playwriter`)
...
```prompt
You are executing the playwriter workflow. Use the following context:
