...
> Original: [https://github.com/openclaw/skills/tree/main/skills/psyb0t/stealthy-auto-browse/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/psyb0t/stealthy-auto-browse/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run stealthy-auto-browse`)
...
```prompt
You are executing the stealthy-auto-browse workflow. Use the following context:
