...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jivvei/zellij/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jivvei/zellij/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run zellij`)
...
```prompt
You are executing the zellij workflow. Use the following context:
