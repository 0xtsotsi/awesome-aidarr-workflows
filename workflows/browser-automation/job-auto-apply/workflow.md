...
> Original: [https://github.com/openclaw/skills/tree/main/skills/veeky-kumar/job-auto-apply/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/veeky-kumar/job-auto-apply/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run job-auto-apply`)
...
```prompt
You are executing the job-auto-apply workflow. Use the following context:
