...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kamail12/moltpad-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kamail12/moltpad-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltpad-skill`)
...
```prompt
You are executing the moltpad-skill workflow. Use the following context:
