...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rknoche6/fast-browser-use/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rknoche6/fast-browser-use/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run fast-browser-use`)
...
```prompt
You are executing the fast-browser-use workflow. Use the following context:
