...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leonardogrig/firecrawl-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leonardogrig/firecrawl-skills/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run firecrawl-skills`)
...
```prompt
You are executing the firecrawl-skills workflow. Use the following context:
