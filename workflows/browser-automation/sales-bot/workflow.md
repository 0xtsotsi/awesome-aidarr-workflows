...
> Original: [https://github.com/openclaw/skills/tree/main/skills/big-roman123/sales-bot/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/big-roman123/sales-bot/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sales-bot`)
...
```prompt
You are executing the sales-bot workflow. Use the following context:
