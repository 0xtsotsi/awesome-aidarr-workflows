...
> Original: [https://github.com/openclaw/skills/tree/main/skills/myakove/ccsinfo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/myakove/ccsinfo/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ccsinfo`)
...
```prompt
You are executing the ccsinfo workflow. Use the following context:
