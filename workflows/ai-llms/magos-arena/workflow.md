...
> Original: [https://github.com/openclaw/skills/tree/main/skills/enstest1/magos-arena/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/enstest1/magos-arena/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run magos-arena`)
...
```prompt
You are executing the magos-arena workflow. Use the following context:
