...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rita5fr/crewai-workflows/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rita5fr/crewai-workflows/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run crewai-workflows`)
...
```prompt
You are executing the crewai-workflows workflow. Use the following context:
