...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steipete/oracle/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steipete/oracle/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run oracle`)
...
```prompt
You are executing the oracle workflow. Use the following context:
