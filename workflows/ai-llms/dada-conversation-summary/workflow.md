...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dadaliu0121/dada-conversation-summary/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dadaliu0121/dada-conversation-summary/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run dada-conversation-summary`)
...
```prompt
You are executing the dada-conversation-summary workflow. Use the following context:
...
```yaml
name: dada-conversation-summary
category: AI & LLMs
version: 1.0.0
user_invocable: True
homepage: 
