...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alslrl/moltpixel/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alslrl/moltpixel/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltpixel`)
...
```prompt
You are executing the moltpixel workflow. Use the following context:
