...
> Original: [https://github.com/openclaw/skills/tree/main/skills/samidh/ironclaw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/samidh/ironclaw/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ironclaw`)
...
```prompt
You are executing the ironclaw workflow. Use the following context:
