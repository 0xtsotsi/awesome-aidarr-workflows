...
> Original: [https://github.com/openclaw/skills/tree/main/skills/msoica/praesidia-a2a/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/msoica/praesidia-a2a/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run praesidia-a2a`)
...
```prompt
You are executing the praesidia-a2a workflow. Use the following context:
