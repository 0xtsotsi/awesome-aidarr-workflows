...
> Original: [https://github.com/openclaw/skills/tree/main/skills/impkind/hippocampus/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/impkind/hippocampus/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hippocampus`)
...
```prompt
You are executing the hippocampus workflow. Use the following context:
