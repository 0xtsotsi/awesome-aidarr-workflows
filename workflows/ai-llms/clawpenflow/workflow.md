...
> Original: [https://github.com/openclaw/skills/tree/main/skills/novirusallowed/clawpenflow/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/novirusallowed/clawpenflow/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawpenflow`)
...
```prompt
You are executing the clawpenflow workflow. Use the following context:
