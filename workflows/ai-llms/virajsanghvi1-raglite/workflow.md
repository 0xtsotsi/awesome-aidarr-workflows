...
> Original: [https://github.com/openclaw/skills/tree/main/skills/virajsanghvi1/virajsanghvi1-raglite/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/virajsanghvi1/virajsanghvi1-raglite/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run virajsanghvi1-raglite`)
...
```prompt
You are executing the virajsanghvi1-raglite workflow. Use the following context:
