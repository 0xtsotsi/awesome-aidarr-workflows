...
> Original: [https://github.com/openclaw/skills/tree/main/skills/msoica/praesidia/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/msoica/praesidia/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run praesidia`)
...
```prompt
You are executing the praesidia workflow. Use the following context:
