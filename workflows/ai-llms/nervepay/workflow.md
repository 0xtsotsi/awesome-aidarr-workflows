...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zadahmed/nervepay/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zadahmed/nervepay/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nervepay`)
...
```prompt
You are executing the nervepay workflow. Use the following context:
