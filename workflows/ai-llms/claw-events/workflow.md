...
> Original: [https://github.com/openclaw/skills/tree/main/skills/capevace/claw-events/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/capevace/claw-events/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run claw-events`)
...
```prompt
You are executing the claw-events workflow. Use the following context:
