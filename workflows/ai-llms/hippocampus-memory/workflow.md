...
> Original: [https://github.com/openclaw/skills/tree/main/skills/impkind/hippocampus-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/impkind/hippocampus-memory/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hippocampus-memory`)
...
```prompt
You are executing the hippocampus-memory workflow. Use the following context:
