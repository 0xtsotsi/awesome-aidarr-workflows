...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rspapani/moltychan/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rspapani/moltychan/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltychan`)
...
```prompt
You are executing the moltychan workflow. Use the following context:
