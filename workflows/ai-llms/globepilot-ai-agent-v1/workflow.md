...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sarqovik/globepilot-ai-agent-v1/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sarqovik/globepilot-ai-agent-v1/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run globepilot-ai-agent-v1`)
...
```prompt
You are executing the globepilot-ai-agent-v1 workflow. Use the following context:
