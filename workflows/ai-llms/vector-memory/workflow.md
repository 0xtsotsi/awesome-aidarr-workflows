...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bluepointdigital/vector-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bluepointdigital/vector-memory/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vector-memory`)
...
```prompt
You are executing the vector-memory workflow. Use the following context:
