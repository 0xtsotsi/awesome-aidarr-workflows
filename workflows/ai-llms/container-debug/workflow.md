...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/container-debug/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gitgoodordietrying/container-debug/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run container-debug`)
...
```prompt
You are executing the container-debug workflow. Use the following context:
