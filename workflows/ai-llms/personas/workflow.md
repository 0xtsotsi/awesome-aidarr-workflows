...
> Original: [https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/personas/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/personas/SKILL.md)
> Category: AI & LLMs
...
Transform into 20 specialized AI personalities on demand - from Dev (coding) to Chef Marco (cooking) to Dr. Med (medical). Switch mid-conversation. Token-efficient, loads only active persona.
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run personas`)
...
```prompt
You are executing the personas workflow. Use the following context:
