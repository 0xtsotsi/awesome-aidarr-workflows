...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jbbottoms/chaos-lab/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jbbottoms/chaos-lab/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run chaos-lab`)
...
```prompt
You are executing the chaos-lab workflow. Use the following context:
