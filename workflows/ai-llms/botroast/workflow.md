...
> Original: [https://github.com/openclaw/skills/tree/main/skills/auliollc/botroast/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/auliollc/botroast/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run botroast`)
...
```prompt
You are executing the botroast workflow. Use the following context:
