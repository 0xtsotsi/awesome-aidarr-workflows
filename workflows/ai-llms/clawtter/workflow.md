...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jkjx/clawtter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jkjx/clawtter/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawtter`)
...
```prompt
You are executing the clawtter workflow. Use the following context:
