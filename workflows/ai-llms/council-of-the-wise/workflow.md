...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jeffaf/council-of-the-wise/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jeffaf/council-of-the-wise/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run council-of-the-wise`)
...
```prompt
You are executing the council-of-the-wise workflow. Use the following context:
