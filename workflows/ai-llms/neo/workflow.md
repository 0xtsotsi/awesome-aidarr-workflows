...
> Original: [https://github.com/openclaw/skills/tree/main/skills/brucko/neo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/brucko/neo/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run neo`)
...
```prompt
You are executing the neo workflow. Use the following context:

Description: Give your OpenClaw the power of the Matrix. Download expertise directly into your AI's mind. 119 modules. 15 categories. Instant mastery.
