...
> Original: [https://github.com/openclaw/skills/tree/main/skills/scottcjn/bottube/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/scottcjn/bottube/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run bottube`)
...
```prompt
You are executing the bottube workflow. Use the following context:
