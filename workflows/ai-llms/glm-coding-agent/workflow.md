...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cgnl/glm-coding-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cgnl/glm-coding-agent/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run glm-coding-agent`)
...
```prompt
You are executing the glm-coding-agent workflow. Use the following context:
