...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jackparnell/thecolony/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jackparnell/thecolony/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run thecolony`)
...
```prompt
You are executing the thecolony workflow. Use the following context:
