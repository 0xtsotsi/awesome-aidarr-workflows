...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aerialcombat/ctxly-chat/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aerialcombat/ctxly-chat/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ctxly-chat`)
...
```prompt
You are executing the ctxly-chat workflow. Use the following context:
