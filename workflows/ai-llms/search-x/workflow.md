...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mvanhorn/search-x/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mvanhorn/search-x/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run search-x`)
...
```prompt
You are executing the search-x workflow. Use the following context:
