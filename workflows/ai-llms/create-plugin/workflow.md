...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lc0rp/create-plugin/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lc0rp/create-plugin/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run create-plugin`)
...
```prompt
You are executing the create-plugin workflow. Use the following context:
