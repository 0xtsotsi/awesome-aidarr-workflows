...
> Original: [https://github.com/openclaw/skills/tree/main/skills/afalk42/reachy-mini/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/afalk42/reachy-mini/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run reachy-mini`)
...
```prompt
You are executing the reachy-mini workflow. Use the following context:
