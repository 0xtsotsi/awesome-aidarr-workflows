...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hlouognem/prawmpt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hlouognem/prawmpt/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run prawmpt`)
...
```prompt
You are executing the prawmpt workflow. Use the following context:
