...
> Original: [https://github.com/openclaw/skills/tree/main/skills/chipagosfinest/language-learning/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/chipagosfinest/language-learning/SKILL.md)
> Category: AI & LLMs
...
**Tags:** language, learning, education, tutor, vocabulary, grammar, flashcards, conversation, translation, polyglot, spanish, french, german, japanese, chinese, korean, arabic, hindi, bangla, portuguese, russian, italian, duolingo-alternative, spaced-repetition, immersion, travel, culture, pronunciation, idioms, slang
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run language-learning`)
...
```prompt
You are executing the language-learning workflow. Use the following context:
