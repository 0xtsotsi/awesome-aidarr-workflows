...
> Original: [https://github.com/openclaw/skills/tree/main/skills/emberdesire/jasper-recall/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/emberdesire/jasper-recall/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run jasper-recall`)
...
```prompt
You are executing the jasper-recall workflow. Use the following context:
