...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leegitw/patent-scanner/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leegitw/patent-scanner/SKILL.md)
> Category: AI & LLMs
...
**Tags:** concept-scanner, patent-analysis, innovation-discovery, intellectual-property, idea-validation, distinctive-patterns
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run patent-scanner`)
...
```prompt
You are executing the patent-scanner workflow. Use the following context:
