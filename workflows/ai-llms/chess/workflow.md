...
> Original: [https://github.com/openclaw/skills/tree/main/skills/l-mendez/chess/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/l-mendez/chess/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run chess`)
...
```prompt
You are executing the chess workflow. Use the following context:
