...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ad2546/context-optimizer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ad2546/context-optimizer/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run context-optimizer`)
...
```prompt
You are executing the context-optimizer workflow. Use the following context:
