...
> Original: [https://github.com/openclaw/skills/tree/main/skills/am-will/llm-council/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/am-will/llm-council/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run llm-council`)
...
```prompt
You are executing the llm-council workflow. Use the following context:
