...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gonzih/molt-city/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gonzih/molt-city/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run molt-city`)
...
```prompt
You are executing the molt-city workflow. Use the following context:
