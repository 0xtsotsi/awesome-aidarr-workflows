...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ryan321/clawpix/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ryan321/clawpix/SKILL.md)
> Category: AI & LLMs
...
**Tags:** images, social, art, ai-art, gallery, creative
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawpix`)
...
```prompt
You are executing the clawpix workflow. Use the following context:
