...
> Original: [https://github.com/openclaw/skills/tree/main/skills/steipete/nano-banana-pro/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/steipete/nano-banana-pro/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nano-banana-pro`)
...
```prompt
You are executing the nano-banana-pro workflow. Use the following context:
