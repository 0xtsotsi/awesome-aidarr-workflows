...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dbhurley/savestate/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dbhurley/savestate/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run savestate`)
...
```prompt
You are executing the savestate workflow. Use the following context:
