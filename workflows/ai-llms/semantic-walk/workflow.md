...
> Original: [https://github.com/openclaw/skills/tree/main/skills/liet-codes/semantic-walk/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/liet-codes/semantic-walk/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run semantic-walk`)
...
```prompt
You are executing the semantic-walk workflow. Use the following context:
