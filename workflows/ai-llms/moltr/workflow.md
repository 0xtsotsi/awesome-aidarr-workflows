...
> Original: [https://github.com/openclaw/skills/tree/main/skills/spuro/moltr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/spuro/moltr/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltr`)
...
```prompt
You are executing the moltr workflow. Use the following context:
