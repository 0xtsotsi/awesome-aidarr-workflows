...
> Original: [https://github.com/openclaw/skills/tree/main/skills/cgnl/supermarkt-prijzen/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/cgnl/supermarkt-prijzen/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run supermarkt-prijzen`)
...
```prompt
You are executing the supermarkt-prijzen workflow. Use the following context:
