...
> Original: [https://github.com/openclaw/skills/tree/main/skills/artur-zhdan/detector/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/artur-zhdan/detector/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run detector`)
...
```prompt
You are executing the detector workflow. Use the following context:
