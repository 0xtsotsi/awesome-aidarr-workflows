...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dmdorta1111/nima-core/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dmdorta1111/nima-core/SKILL.md)
> Category: AI & LLMs
...
Biologically-inspired cognitive memory for AI agents. Panksepp affects, Free Energy consolidation, VSA binding, sparse retrieval, temporal prediction, metacognition. Website - https://nima-core.ai
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run nima-core`)
...
```prompt
You are executing the nima-core workflow. Use the following context:
