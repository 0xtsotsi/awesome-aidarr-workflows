...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pjb157/doubleword/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pjb157/doubleword/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run doubleword`)
...
```prompt
You are executing the doubleword workflow. Use the following context:
