...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rakesh1002/mailmolt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rakesh1002/mailmolt/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run mailmolt`)
...
```prompt
You are executing the mailmolt workflow. Use the following context:
