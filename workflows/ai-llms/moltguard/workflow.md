...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thomaslwang/moltguard/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thomaslwang/moltguard/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltguard`)
...
```prompt
You are executing the moltguard workflow. Use the following context:
