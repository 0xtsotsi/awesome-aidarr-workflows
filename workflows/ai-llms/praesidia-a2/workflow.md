...
> Original: [https://github.com/openclaw/skills/tree/main/skills/msoica/praesidia-a2/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/msoica/praesidia-a2/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run praesidia-a2`)
...
```prompt
You are executing the praesidia-a2 workflow. Use the following context:
