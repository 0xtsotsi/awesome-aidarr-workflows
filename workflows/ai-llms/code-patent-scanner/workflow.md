...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leegitw/code-patent-scanner/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leegitw/code-patent-scanner/SKILL.md)
> Category: AI & LLMs
...
**Tags:** code-scanner, patent-analysis, innovation-discovery, intellectual-property, code-analysis, distinctive-patterns
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run code-patent-scanner`)
...
```prompt
You are executing the code-patent-scanner workflow. Use the following context:
