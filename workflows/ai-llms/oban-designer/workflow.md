...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gchapim/oban-designer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gchapim/oban-designer/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run oban-designer`)
...
```prompt
You are executing the oban-designer workflow. Use the following context:
