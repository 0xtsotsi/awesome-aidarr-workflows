...
> Original: [https://github.com/openclaw/skills/tree/main/skills/javainthinking/slides-generation-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/javainthinking/slides-generation-skills/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run slides-generation-skills`)
...
```prompt
You are executing the slides-generation-skills workflow. Use the following context:
