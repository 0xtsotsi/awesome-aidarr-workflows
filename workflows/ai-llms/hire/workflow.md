...
> Original: [https://github.com/openclaw/skills/tree/main/skills/larsderidder/hire/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/larsderidder/hire/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hire`)
...
```prompt
You are executing the hire workflow. Use the following context:
