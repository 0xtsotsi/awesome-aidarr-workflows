...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sxela/falai/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sxela/falai/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run falai`)
...
```prompt
You are executing the falai workflow. Use the following context:
