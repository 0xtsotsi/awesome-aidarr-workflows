...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gabrielsubtil/clean-code/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gabrielsubtil/clean-code/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clean-code`)
...
```prompt
You are executing the clean-code workflow. Use the following context:
