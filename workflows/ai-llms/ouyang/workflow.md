...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ttboy/ouyang/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ttboy/ouyang/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ouyang`)
...
```prompt
You are executing the ouyang workflow. Use the following context:
