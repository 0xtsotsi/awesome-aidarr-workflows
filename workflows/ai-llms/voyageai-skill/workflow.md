...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mrlynn/voyageai-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mrlynn/voyageai-skill/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run voyageai-skill`)
...
```prompt
You are executing the voyageai-skill workflow. Use the following context:
