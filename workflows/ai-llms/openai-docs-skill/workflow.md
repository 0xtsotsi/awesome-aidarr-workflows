...
> Original: [https://github.com/openclaw/skills/tree/main/skills/am-will/openai-docs/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/am-will/openai-docs/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openai-docs-skill`)
...
```prompt
You are executing the openai-docs-skill workflow. Use the following context:
