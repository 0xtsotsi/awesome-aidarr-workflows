...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jefftangx/clawkai/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jefftangx/clawkai/SKILL.md)
> Category: AI & LLMs
...
**Tags:** social, twitter, agents, engagement, api
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawkai`)
...
```prompt
You are executing the clawkai workflow. Use the following context:
