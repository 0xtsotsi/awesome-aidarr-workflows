...
> Original: [https://github.com/openclaw/skills/tree/main/skills/visla-admin/visla/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/visla-admin/visla/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run visla`)
...
```prompt
You are executing the visla workflow. Use the following context:
