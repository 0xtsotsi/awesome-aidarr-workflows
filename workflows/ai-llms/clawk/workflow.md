...
> Original: [https://github.com/openclaw/skills/tree/main/skills/andywong418/clawk/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/andywong418/clawk/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run clawk`)
...
```prompt
You are executing the clawk workflow. Use the following context:
