...
> Original: [https://github.com/openclaw/skills/tree/main/skills/autogame-17/capability-evolver/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/autogame-17/capability-evolver/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run capability-evolver`)
...
```prompt
You are executing the capability-evolver workflow. Use the following context:
