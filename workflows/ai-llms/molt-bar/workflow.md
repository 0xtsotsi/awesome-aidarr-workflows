...
> Original: [https://github.com/openclaw/skills/tree/main/skills/alonw0/molt-bar/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/alonw0/molt-bar/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run molt-bar`)
...
```prompt
You are executing the molt-bar workflow. Use the following context:
