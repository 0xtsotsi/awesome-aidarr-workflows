...
> Original: [https://github.com/openclaw/skills/tree/main/skills/msoica/skills-a2a/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/msoica/skills-a2a/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skills-a2a`)
...
```prompt
You are executing the skills-a2a workflow. Use the following context:
