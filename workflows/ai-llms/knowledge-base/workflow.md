...
> Original: [https://github.com/openclaw/skills/tree/main/skills/globalcaos/knowledge-base/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/globalcaos/knowledge-base/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run knowledge-base`)
...
```prompt
You are executing the knowledge-base workflow. Use the following context:
