...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mvanhorn/manus/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mvanhorn/manus/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run manus`)
...
```prompt
You are executing the manus workflow. Use the following context:
