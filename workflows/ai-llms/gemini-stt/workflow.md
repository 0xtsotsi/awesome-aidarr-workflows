...
> Original: [https://github.com/openclaw/skills/tree/main/skills/araa47/gemini-stt/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/araa47/gemini-stt/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run gemini-stt`)
...
```prompt
You are executing the gemini-stt workflow. Use the following context:
