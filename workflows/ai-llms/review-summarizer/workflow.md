...
> Original: [https://github.com/openclaw/skills/tree/main/skills/michael-laffin/review-summarizer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/michael-laffin/review-summarizer/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run review-summarizer`)
...
```prompt
You are executing the review-summarizer workflow. Use the following context:
