...
> Original: [https://github.com/openclaw/skills/tree/main/skills/impkind/vta-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/impkind/vta-memory/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vta-memory`)
...
```prompt
You are executing the vta-memory workflow. Use the following context:
