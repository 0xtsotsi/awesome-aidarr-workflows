...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arein/concierge/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arein/concierge/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run concierge`)
...
```prompt
You are executing the concierge workflow. Use the following context:
