...
> Original: [https://github.com/openclaw/skills/tree/main/skills/eijiac24/moltter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/eijiac24/moltter/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run moltter`)
...
```prompt
You are executing the moltter workflow. Use the following context:
