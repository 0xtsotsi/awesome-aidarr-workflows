...
> Original: [https://github.com/openclaw/skills/tree/main/skills/byteroverinc/byterover-headless/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/byteroverinc/byterover-headless/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run byterover-headless`)
...
```prompt
You are executing the byterover-headless workflow. Use the following context:
