...
> Original: [https://github.com/openclaw/skills/tree/main/skills/matthewyin/diagram-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/matthewyin/diagram-generator/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run diagram-generator`)
...
```prompt
You are executing the diagram-generator workflow. Use the following context:
