...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pjb157/doubleword-api/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pjb157/doubleword-api/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run doubleword-api`)
...
```prompt
You are executing the doubleword-api workflow. Use the following context:
