...
> Original: [https://github.com/openclaw/skills/tree/main/skills/desperado991128/peft/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/desperado991128/peft/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run peft`)
...
```prompt
You are executing the peft workflow. Use the following context:
