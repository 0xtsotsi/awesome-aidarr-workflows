...
> Original: [https://github.com/openclaw/skills/tree/main/skills/oakencore/skillvet/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/oakencore/skillvet/SKILL.md)
> Category: AI & LLMs
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skillvet`)
...
```prompt
You are executing the skillvet workflow. Use the following context:
