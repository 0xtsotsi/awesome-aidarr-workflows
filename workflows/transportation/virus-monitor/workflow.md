...
> Original: [https://github.com/openclaw/skills/tree/main/skills/pasogott/virus-monitor/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/pasogott/virus-monitor/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run virus-monitor`)
...
```prompt
You are executing the virus-monitor workflow. Use the following context:
