...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mbjoern/swiss-geo-and-tourism-assistant/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mbjoern/swiss-geo-and-tourism-assistant/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run swiss-geo`)
...
```prompt
You are executing the swiss-geo workflow. Use the following context:
