...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hjanuschka/wienerlinien/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hjanuschka/wienerlinien/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wienerlinien`)
...
```prompt
You are executing the wienerlinien workflow. Use the following context:
