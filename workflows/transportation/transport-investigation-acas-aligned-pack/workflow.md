...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kowl64/transport-investigation-acas-aligned-pack/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kowl64/transport-investigation-acas-aligned-pack/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run transport-investigation-acas-aligned-pack`)
...
```prompt
You are executing the transport-investigation-acas-aligned-pack workflow. Use the following context:
