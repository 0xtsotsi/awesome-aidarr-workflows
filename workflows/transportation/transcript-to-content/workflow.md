...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tomstools11/transcript-to-content/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tomstools11/transcript-to-content/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run transcript-to-content`)
...
```prompt
You are executing the transcript-to-content workflow. Use the following context:
