...
> Original: [https://github.com/openclaw/skills/tree/main/skills/xenofex7/swiss-transport/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/xenofex7/swiss-transport/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run swiss-transport`)
...
```prompt
You are executing the swiss-transport workflow. Use the following context:
