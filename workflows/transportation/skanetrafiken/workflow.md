...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rezkam/skanetrafiken/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rezkam/skanetrafiken/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skanetrafiken`)
...
```prompt
You are executing the skanetrafiken workflow. Use the following context:
