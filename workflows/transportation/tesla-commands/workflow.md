...
> Original: [https://github.com/openclaw/skills/tree/main/skills/ovaris/tesla-commands/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/ovaris/tesla-commands/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run tesla-commands`)
...
```prompt
You are executing the tesla-commands workflow. Use the following context:
