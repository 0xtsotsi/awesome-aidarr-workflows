...
> Original: [https://github.com/openclaw/skills/tree/main/skills/anscg/wheels-router/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/anscg/wheels-router/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wheels-router`)
...
```prompt
You are executing the wheels-router workflow. Use the following context:
