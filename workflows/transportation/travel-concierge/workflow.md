...
> Original: [https://github.com/openclaw/skills/tree/main/skills/arein/travel-concierge/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/arein/travel-concierge/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run travel-concierge`)
...
```prompt
You are executing the travel-concierge workflow. Use the following context:
