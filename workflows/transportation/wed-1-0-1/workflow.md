...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gvillanueva84/wed-1-0-1/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gvillanueva84/wed-1-0-1/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run wed-1-0-1`)
...
```prompt
You are executing the wed-1-0-1 workflow. Use the following context:
