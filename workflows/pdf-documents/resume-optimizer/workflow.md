...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tomstools11/resume-optimizer/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tomstools11/resume-optimizer/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run resume-optimizer`)
...
```prompt
You are executing the resume-optimizer workflow. Use the following context:
