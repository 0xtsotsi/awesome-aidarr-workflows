...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tomstools11/style-guide-generator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tomstools11/style-guide-generator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run style-guide-generator`)
...
```prompt
You are executing the style-guide-generator workflow. Use the following context:
