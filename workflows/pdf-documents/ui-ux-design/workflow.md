...
> Original: [https://github.com/openclaw/skills/tree/main/skills/itsjustdri/ui-ux-design/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/itsjustdri/ui-ux-design/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ui-ux-design`)
...
```prompt
You are executing the ui-ux-design workflow. Use the following context:
