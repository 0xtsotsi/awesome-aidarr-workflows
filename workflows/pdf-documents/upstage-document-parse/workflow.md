...
> Original: [https://github.com/openclaw/skills/tree/main/skills/upstage-deployment/upstage-document-parse/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/upstage-deployment/upstage-document-parse/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run upstage-document-parse`)
...
```prompt
You are executing the upstage-document-parse workflow. Use the following context:
