...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mve/slidespeak/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mve/slidespeak/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run slidespeak`)
...
```prompt
You are executing the slidespeak workflow. Use the following context:
