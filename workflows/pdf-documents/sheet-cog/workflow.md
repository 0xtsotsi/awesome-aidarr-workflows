...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/sheet-cog/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nitishgargiitd/sheet-cog/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sheet-cog`)
...
```prompt
You are executing the sheet-cog workflow. Use the following context:
