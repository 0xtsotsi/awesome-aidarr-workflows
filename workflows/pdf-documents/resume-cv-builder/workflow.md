...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sebastian-buitrag0/resume-cv-builder/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sebastian-buitrag0/resume-cv-builder/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run resume-cv-builder`)
...
```prompt
You are executing the resume-cv-builder workflow. Use the following context:
