...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hilongjw/seede-design/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hilongjw/seede-design/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run seede-design`)
...
```prompt
You are executing the seede-design workflow. Use the following context:
