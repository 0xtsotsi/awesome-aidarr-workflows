...
> Original: [https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/sheetsmith/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/crimsondevil333333/sheetsmith/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sheetsmith`)
...
```prompt
You are executing the sheetsmith workflow. Use the following context:
