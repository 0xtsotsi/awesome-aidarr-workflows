...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gregm711/typetex/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gregm711/typetex/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run typetex`)
...
```prompt
You are executing the typetex workflow. Use the following context:
