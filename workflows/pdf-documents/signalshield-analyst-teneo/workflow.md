...
> Original: [https://github.com/openclaw/skills/tree/main/skills/firestream792/signalshield-analyst-teneo/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/firestream792/signalshield-analyst-teneo/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run signalshield-analyst-teneo`)
...
```prompt
You are executing the signalshield-analyst-teneo workflow. Use the following context:
