...
> Original: [https://github.com/openclaw/skills/tree/main/skills/leeguooooo/yapi/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/leeguooooo/yapi/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run yapi`)
...
```prompt
You are executing the yapi workflow. Use the following context:
