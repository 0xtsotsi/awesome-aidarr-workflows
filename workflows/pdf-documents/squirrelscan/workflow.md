...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nc9/squirrelscan/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nc9/squirrelscan/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run squirrelscan`)
...
```prompt
You are executing the squirrelscan workflow. Use the following context:
