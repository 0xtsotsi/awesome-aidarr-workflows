...
> Original: [https://github.com/openclaw/skills/tree/main/skills/elestirelbilinc-sketch/vap-multimedia-generation/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/elestirelbilinc-sketch/vap-multimedia-generation/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vap-multimedia-generation`)
...
```prompt
You are executing the vap-multimedia-generation workflow. Use the following context:
