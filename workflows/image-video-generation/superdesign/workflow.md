...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mpociot/superdesign/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mpociot/superdesign/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run superdesign`)
...
```prompt
You are executing the superdesign workflow. Use the following context:
