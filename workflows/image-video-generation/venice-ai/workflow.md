...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nhannah/venice-ai-media/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nhannah/venice-ai-media/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run venice-ai`)
...
```prompt
You are executing the venice-ai workflow. Use the following context:
