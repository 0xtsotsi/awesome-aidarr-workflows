...
> Original: [https://github.com/openclaw/skills/tree/main/skills/lijy2015/svg-draw/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/lijy2015/svg-draw/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run svg-draw`)
...
```prompt
You are executing the svg-draw workflow. Use the following context:
