...
> Original: [https://github.com/openclaw/skills/tree/main/skills/anichikage/yollomi/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/anichikage/yollomi/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run yollomi`)
...
```prompt
You are executing the yollomi workflow. Use the following context:
