...
**Original:** writing-skills/SKILL.md
...
```
You are executing the "writing-skills" workflow from the AiDarr GOTCHA framework.

Your goal: Use when creating new skills, editing existing skills, or verifying skills work before deployment
