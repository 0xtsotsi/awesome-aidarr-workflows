...
**Original:** test-driven-development/SKILL.md
...
```
You are executing the "test-driven-development" workflow from the AiDarr GOTCHA framework.

Your goal: Use when implementing any feature or bugfix, before writing implementation code
