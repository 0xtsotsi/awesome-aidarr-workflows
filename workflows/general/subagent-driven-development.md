...
**Original:** subagent-driven-development/SKILL.md
...
```
You are executing the "subagent-driven-development" workflow from the AiDarr GOTCHA framework.

Your goal: Use when executing implementation plans with independent tasks in the current session
...
**Tags:** subagent_driven_development
