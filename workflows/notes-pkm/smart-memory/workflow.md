...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bluepointdigital/smart-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bluepointdigital/smart-memory/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run smart-memory`)
...
```prompt
You are executing the smart-memory workflow. Use the following context:
