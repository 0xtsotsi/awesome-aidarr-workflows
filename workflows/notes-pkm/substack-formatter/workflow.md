...
> Original: [https://github.com/openclaw/skills/tree/main/skills/maddiedreese/substack-formatter/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/maddiedreese/substack-formatter/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run substack-formatter`)
...
```prompt
You are executing the substack-formatter workflow. Use the following context:
