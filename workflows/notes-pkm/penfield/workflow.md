...
> Original: [https://github.com/openclaw/skills/tree/main/skills/dial481/penfield/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/dial481/penfield/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run penfield`)
...
```prompt
You are executing the penfield workflow. Use the following context:
