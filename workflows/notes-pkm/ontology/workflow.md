...
> Original: [https://github.com/openclaw/skills/tree/main/skills/oswalpalash/ontology/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/oswalpalash/ontology/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ontology`)
...
```prompt
You are executing the ontology workflow. Use the following context:
