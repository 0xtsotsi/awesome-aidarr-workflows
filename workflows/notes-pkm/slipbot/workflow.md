...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jrswab/slipbot/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jrswab/slipbot/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run slipbot`)
...
```prompt
You are executing the slipbot workflow. Use the following context:
