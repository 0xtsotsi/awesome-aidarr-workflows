...
> Original: [https://github.com/openclaw/skills/tree/main/skills/jmz1/skillcraft/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/jmz1/skillcraft/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skillcraft`)
...
```prompt
You are executing the skillcraft workflow. Use the following context:
