...
> Original: [https://github.com/openclaw/skills/tree/main/skills/caioiscoding/omi-me/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/caioiscoding/omi-me/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run omi-me`)
...
```prompt
You are executing the omi-me workflow. Use the following context:
