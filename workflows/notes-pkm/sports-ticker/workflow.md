...
> Original: [https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/sports-ticker/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/robbyczgw-cla/sports-ticker/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sports-ticker`)
...
```prompt
You are executing the sports-ticker workflow. Use the following context:
