...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mig6671/vector-memory-hack/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mig6671/vector-memory-hack/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vector-memory-hack`)
...
```prompt
You are executing the vector-memory-hack workflow. Use the following context:
