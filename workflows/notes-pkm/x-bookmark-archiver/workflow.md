...
> Original: [https://github.com/openclaw/skills/tree/main/skills/iamadig/x-bookmark-archiver/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/iamadig/x-bookmark-archiver/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run x-bookmark-archiver`)
...
```prompt
You are executing the x-bookmark-archiver workflow. Use the following context:
