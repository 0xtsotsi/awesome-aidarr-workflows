...
> Original: [https://github.com/openclaw/skills/tree/main/skills/zfanmy/skill-from-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/zfanmy/skill-from-memory/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-from-memory`)
...
```prompt
You are executing the skill-from-memory workflow. Use the following context:
