...
> Original: [https://github.com/openclaw/skills/tree/main/skills/killerapp/para-pkm/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/killerapp/para-pkm/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run para-pkm`)
...
```prompt
You are executing the para-pkm workflow. Use the following context:
