...
> Original: [https://github.com/openclaw/skills/tree/main/skills/belkouche/vestige/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/belkouche/vestige/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vestige`)
...
```prompt
You are executing the vestige workflow. Use the following context:
