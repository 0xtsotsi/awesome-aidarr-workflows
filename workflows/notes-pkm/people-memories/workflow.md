...
> Original: [https://github.com/openclaw/skills/tree/main/skills/charbeld/people-memories/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/charbeld/people-memories/SKILL.md)
> Category: Notes & PKM
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run people-memories`)
...
```prompt
You are executing the people-memories workflow. Use the following context:
