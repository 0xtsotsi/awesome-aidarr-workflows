...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gizmogremlin/openclaw-skill-voice-ai-voices/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gizmogremlin/openclaw-skill-voice-ai-voices/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaw-skill-voice-ai-voices`)
...
```prompt
You are executing the openclaw-skill-voice-ai-voices workflow. Use the following context:
...
```yaml
name: openclaw-skill-voice-ai-voices
category: Clawdbot Tools
version: 1.0.0
user_invocable: True
homepage: 
