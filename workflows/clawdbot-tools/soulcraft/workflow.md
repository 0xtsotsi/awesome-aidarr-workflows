...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kesslerio/soulcraft/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kesslerio/soulcraft/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run soulcraft`)
...
```prompt
You are executing the soulcraft workflow. Use the following context:
