...
> Original: [https://github.com/openclaw/skills/tree/main/skills/regalstreak/swiggy/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/regalstreak/swiggy/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run swiggy`)
...
```prompt
You are executing the swiggy workflow. Use the following context:
