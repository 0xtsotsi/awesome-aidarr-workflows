...
> Original: [https://github.com/openclaw/skills/tree/main/skills/sedation6612/project-management-skills/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/sedation6612/project-management-skills/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run project-management-skills`)
...
```prompt
You are executing the project-management-skills workflow. Use the following context:
