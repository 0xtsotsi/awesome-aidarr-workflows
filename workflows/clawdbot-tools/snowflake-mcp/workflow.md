...
> Original: [https://github.com/openclaw/skills/tree/main/skills/vikrambalaaj/snowflake-mcp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/vikrambalaaj/snowflake-mcp/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run snowflake-mcp`)
...
```prompt
You are executing the snowflake-mcp workflow. Use the following context:
