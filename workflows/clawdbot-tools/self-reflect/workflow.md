...
> Original: [https://github.com/openclaw/skills/tree/main/skills/stevengonsalvez/self-reflect/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/stevengonsalvez/self-reflect/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run self-reflect`)
...
```prompt
You are executing the self-reflect workflow. Use the following context:
