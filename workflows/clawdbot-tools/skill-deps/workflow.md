...
> Original: [https://github.com/openclaw/skills/tree/main/skills/myrodar/skill-deps/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/myrodar/skill-deps/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-deps`)
...
```prompt
You are executing the skill-deps workflow. Use the following context:
