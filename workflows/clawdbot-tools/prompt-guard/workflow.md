...
> Original: [https://github.com/openclaw/skills/tree/main/skills/seojoonkim/prompt-guard/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/seojoonkim/prompt-guard/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run prompt-guard`)
...
```prompt
You are executing the prompt-guard workflow. Use the following context:
