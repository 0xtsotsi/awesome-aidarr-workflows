...
> Original: [https://github.com/openclaw/skills/tree/main/skills/nesdeq/openclaw-feeds/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/nesdeq/openclaw-feeds/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaw-feeds`)
...
```prompt
You are executing the openclaw-feeds workflow. Use the following context:
