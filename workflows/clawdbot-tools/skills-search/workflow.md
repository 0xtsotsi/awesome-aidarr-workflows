...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thesethrose/skills-search/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thesethrose/skills-search/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skills-search`)
...
```prompt
You are executing the skills-search workflow. Use the following context:
