...
> Original: [https://github.com/openclaw/skills/tree/main/skills/boyangwang/lark-integration/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/boyangwang/lark-integration/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run lark-integration`)
...
```prompt
You are executing the lark-integration workflow. Use the following context:
