...
> Original: [https://github.com/openclaw/skills/tree/main/skills/tmchow/hzl/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/tmchow/hzl/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run hzl`)
...
```prompt
You are executing the hzl workflow. Use the following context:
