...
> Original: [https://github.com/openclaw/skills/tree/main/skills/paolorollo/openclaw-sec/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/paolorollo/openclaw-sec/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaw-sec`)
...
```prompt
You are executing the openclaw-sec workflow. Use the following context:
