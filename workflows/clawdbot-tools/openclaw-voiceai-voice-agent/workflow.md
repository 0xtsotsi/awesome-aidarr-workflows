...
> Original: [https://github.com/openclaw/skills/tree/main/skills/gizmogremlin/openclaw-voiceai-voice-agent/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/gizmogremlin/openclaw-voiceai-voice-agent/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run openclaw-voiceai-voice-agent`)
...
```prompt
You are executing the openclaw-voiceai-voice-agent workflow. Use the following context:
...
```yaml
name: openclaw-voiceai-voice-agent
category: Clawdbot Tools
version: 1.0.0
user_invocable: True
homepage: 
