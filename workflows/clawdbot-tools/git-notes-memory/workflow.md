...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mourad-ghafiri/git-notes-memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mourad-ghafiri/git-notes-memory/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run git-notes-memory`)
...
```prompt
You are executing the git-notes-memory workflow. Use the following context:
