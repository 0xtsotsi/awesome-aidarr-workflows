...
> Original: [https://github.com/openclaw/skills/tree/main/skills/aditya4206360-prog/sr1/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/aditya4206360-prog/sr1/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run sr1`)
...
```prompt
You are executing the sr1 workflow. Use the following context:
