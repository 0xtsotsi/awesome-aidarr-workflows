...
> Original: [https://github.com/openclaw/skills/tree/main/skills/morozred/skill-audit/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/morozred/skill-audit/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skills-audit`)
...
```prompt
You are executing the skills-audit workflow. Use the following context:
