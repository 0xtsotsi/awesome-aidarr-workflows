...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kesslerio/google-messages-openclaw-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kesslerio/google-messages-openclaw-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run google-messages-openclaw-skill`)
...
```prompt
You are executing the google-messages-openclaw-skill workflow. Use the following context:
