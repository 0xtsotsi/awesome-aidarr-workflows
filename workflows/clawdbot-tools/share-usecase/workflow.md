...
> Original: [https://github.com/openclaw/skills/tree/main/skills/josephl37/share-usecase/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/josephl37/share-usecase/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run share-usecase`)
...
```prompt
You are executing the share-usecase workflow. Use the following context:
