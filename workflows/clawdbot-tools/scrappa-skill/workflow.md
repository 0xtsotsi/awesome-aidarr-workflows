...
> Original: [https://github.com/openclaw/skills/tree/main/skills/userlip/scrappa-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/userlip/scrappa-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run scrappa-skill`)
...
```prompt
You are executing the scrappa-skill workflow. Use the following context:
