...
> Original: [https://github.com/openclaw/skills/tree/main/skills/duartemartins/microsoft-ads-mcp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/duartemartins/microsoft-ads-mcp/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run microsoft-ads-mcp`)
...
```prompt
You are executing the microsoft-ads-mcp workflow. Use the following context:
