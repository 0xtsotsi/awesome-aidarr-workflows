...
> Original: [https://github.com/openclaw/skills/tree/main/skills/kesslerio/lobster-jobs/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/kesslerio/lobster-jobs/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run lobster-jobs`)
...
```prompt
You are executing the lobster-jobs workflow. Use the following context:
