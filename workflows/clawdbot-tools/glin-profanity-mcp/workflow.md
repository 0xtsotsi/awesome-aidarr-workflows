...
> Original: [https://github.com/openclaw/skills/tree/main/skills/thegdsks/glin-profanity-mcp/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/thegdsks/glin-profanity-mcp/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run glin-profanity-mcp`)
...
```prompt
You are executing the glin-profanity-mcp workflow. Use the following context:
