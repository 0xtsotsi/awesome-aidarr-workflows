...
> Original: [https://github.com/openclaw/skills/tree/main/skills/bobot-agent/usage-export/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/bobot-agent/usage-export/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run usage-export`)
...
```prompt
You are executing the usage-export workflow. Use the following context:
