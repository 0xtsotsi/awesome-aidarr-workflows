...
> Original: [https://github.com/openclaw/skills/tree/main/skills/edwardirby/ydc-openai-agent-sdk-integration/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/edwardirby/ydc-openai-agent-sdk-integration/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ydc-openai-agent-sdk-integration`)
...
```prompt
You are executing the ydc-openai-agent-sdk-integration workflow. Use the following context:
