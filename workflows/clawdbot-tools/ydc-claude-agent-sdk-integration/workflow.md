...
> Original: [https://github.com/openclaw/skills/tree/main/skills/edwardirby/ydc-claude-agent-sdk-integration/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/edwardirby/ydc-claude-agent-sdk-integration/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run ydc-claude-agent-sdk-integration`)
...
```prompt
You are executing the ydc-claude-agent-sdk-integration workflow. Use the following context:
