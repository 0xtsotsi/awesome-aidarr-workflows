...
> Original: [https://github.com/openclaw/skills/tree/main/skills/mariovallereyes/luma-event-manager/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/mariovallereyes/luma-event-manager/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run luma-event-manager`)
...
```prompt
You are executing the luma-event-manager workflow. Use the following context:
