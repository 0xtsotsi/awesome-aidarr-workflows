...
> Original: [https://github.com/openclaw/skills/tree/main/skills/echo-of-machines/taskr/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/echo-of-machines/taskr/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run taskr`)
...
```prompt
You are executing the taskr workflow. Use the following context:
