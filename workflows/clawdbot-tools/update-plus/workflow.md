...
> Original: [https://github.com/openclaw/skills/tree/main/skills/hopyky/update-plus/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/hopyky/update-plus/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run update-plus`)
...
```prompt
You are executing the update-plus workflow. Use the following context:
