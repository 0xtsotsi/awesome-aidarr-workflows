...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rosepuppy/memory/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rosepuppy/memory/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run memory`)
...
```prompt
You are executing the memory workflow. Use the following context:
