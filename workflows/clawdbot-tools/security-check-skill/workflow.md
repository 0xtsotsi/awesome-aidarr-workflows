...
> Original: [https://github.com/openclaw/skills/tree/main/skills/wolffan/security-check-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/wolffan/security-check-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run security-check-skill`)
...
```prompt
You are executing the security-check-skill workflow. Use the following context:
