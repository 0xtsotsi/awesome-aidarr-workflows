...
> Original: [https://github.com/openclaw/skills/tree/main/skills/koba42corp/vinculum/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/koba42corp/vinculum/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run vinculum`)
...
```prompt
You are executing the vinculum workflow. Use the following context:
