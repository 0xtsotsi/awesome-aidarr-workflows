...
> Original: [https://github.com/openclaw/skills/tree/main/skills/prairie2cloud/treelisty-openclaw-skill/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/prairie2cloud/treelisty-openclaw-skill/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run treelisty-openclaw-skill`)
...
```prompt
You are executing the treelisty-openclaw-skill workflow. Use the following context:
