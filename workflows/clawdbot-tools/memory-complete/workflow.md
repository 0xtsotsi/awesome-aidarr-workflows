...
> Original: [https://github.com/openclaw/skills/tree/main/skills/rosepuppy/memory-complete/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/rosepuppy/memory-complete/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run memory-complete`)
...
```prompt
You are executing the memory-complete workflow. Use the following context:
