...
> Original: [https://github.com/openclaw/skills/tree/main/skills/terwox/skill-evaluator/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/terwox/skill-evaluator/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run skill-evaluator`)
...
```prompt
You are executing the skill-evaluator workflow. Use the following context:
