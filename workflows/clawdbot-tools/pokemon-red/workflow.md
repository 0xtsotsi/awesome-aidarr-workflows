...
> Original: [https://github.com/openclaw/skills/tree/main/skills/drbarq/pokemon-red/SKILL.md](https://github.com/openclaw/skills/tree/main/skills/drbarq/pokemon-red/SKILL.md)
...
### O - Orchestration
**Trigger:** User-invocable (via `aidarr run pokemon-red`)
...
```prompt
You are executing the pokemon-red workflow. Use the following context:
